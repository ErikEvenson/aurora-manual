...
- Shift+Drag: Measure distance between two points on the tactical map *(unverified — #714 -- exact display unit not confirmed; see [Section 3.2.6 Distance Measuring](3.2-system-map.md) for details)*
