...
Aurora C# supports comprehensive keyboard shortcuts for opening game windows, introduced in v1.10.0. These hotkeys provide quick access to 18 different game windows.
...
1. Aurora Forums, "Hot Keys" (aurora2.pentarch.org/index.php?topic=11306.msg131788) -- Complete F2-F12 and Ctrl+F2-F12 keyboard shortcuts for C# v1.10.0
2. Aurora Forums, "1.12.0 Changes List" (aurora2.pentarch.org/index.php?topic=11593.0) -- Alt+F11/Alt+F12 map location cycling added in v1.12.0
3. AuroraWiki, "System Map" (aurorawiki.pentarch.org/index.php?title=System_Map) -- Shift+drag distance measuring
