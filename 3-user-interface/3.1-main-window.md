...
**Ship Operations:**
- **Ship Design**: Create and modify ship classes (see [Section 8 Ship Design](../8-ship-design/)) (the blueprint, not individual ships)
- **Fleet Window / Naval Organization**: Manage fleets, assign ships, give movement orders (see [Section 9 Fleet Management](../9-fleet-management/))
...
**Military:**
- **Ground Forces**: Design, train, and manage army units (see [Section 13 Ground Forces](../13-ground-forces/))
...
- **Diplomacy**: Interact with known races (see [Section 15 Diplomacy](../15-diplomacy/))
...
- [Section 8 Ship Design](../8-ship-design/) -- Ship design interface
- [Section 9 Fleet Management](../9-fleet-management/) -- Fleet window and naval organization
- [Section 13 Ground Forces](../13-ground-forces/) -- Ground forces management
- [Section 14 Logistics](../14-logistics/) -- Fleet logistics and supply reports
- [Section 15 Diplomacy](../15-diplomacy/) -- Diplomatic interface
