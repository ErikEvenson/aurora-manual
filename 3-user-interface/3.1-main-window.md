...
![](../images/art/section-art/3.1.png)
...
> **Note:** Community sources ([Section 3.4.4 Event-Driven Gameplay](3.4-event-log.md#344-event-driven-gameplay)) also list combat-related interrupts (hostile contact detected, ship under fire, ship destroyed). These are not yet confirmed in the database's PlayerInterrupt field and are marked as unverified in that section.
...
> **Tip:** Most players leave sub-pulse length on Auto. If time advancement behaves unexpectedly after changing this setting, check the Event Log (Ctrl+F2) -- the issue may be task group orders triggering frequent interrupts rather than the sub-pulse setting itself.
