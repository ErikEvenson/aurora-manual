...
**Filter Controls:**
The Event Log window provides filtering controls for event categories *(unverified -- the specific filter categories and their UI presentation have not been confirmed against Aurora's actual Event Log interface; the categories listed below are editorial groupings)*:

- Combat events *(unverified)*
- Exploration events *(unverified)*
- Research events *(unverified)*
- Economic events *(unverified)*
- Colony events *(unverified)*
- Commander events *(unverified)*
- Diplomatic events *(unverified)*
- Miscellaneous/system events *(unverified)*
...
The mechanism for configuring which events trigger interrupts is not fully documented in available sources *(unverified -- the specific UI location and controls for interrupt configuration have not been confirmed)*. The following is general guidance:
