...
![](../images/art/section-art/3.4.png)
...
![Figure 3.4.1: Event Type Categories Visual Glossary](../images/diagrams/3-user-interface/3.4-event-glossary.png)
...
![Figure 3.4.3: Event Filtering Strategy Guide](../images/diagrams/3-user-interface/3.4-event-filtering.png)
...
- Hostile contact detected *(unverified -- #1257 -- sourced from Fandom Wiki; not confirmed in the DIM_EventType PlayerInterrupt column)*
- Ship under fire *(unverified -- #1257 -- sourced from Fandom Wiki; not confirmed in the DIM_EventType PlayerInterrupt column)*
- Ship destroyed *(unverified -- #1257 -- sourced from Fandom Wiki; not confirmed in the DIM_EventType PlayerInterrupt column)*
- Research completions
- Shipyard task completions
- Industry build completions
- Unassigned research labs (safeguard against wasted capacity)

> **Note:** The database-verified interrupt events (Research Completed, Ship Construction, Production, and Inactive Lab) are documented with EventTypeID references in [Section 3.1.12 Status Bar](3.1-main-window.md#3112-status-bar). The combat-related interrupts listed above (hostile contact, ship under fire, ship destroyed) are sourced from community documentation and have not been confirmed against the game database's PlayerInterrupt field.
...
The mechanism for configuring which events trigger interrupts is not fully documented in available sources *(unverified — [#717](https://github.com/ErikEvenson/aurora-manual/issues/717) -- the specific UI location and controls for interrupt configuration have not been confirmed)*. The following is general guidance:
