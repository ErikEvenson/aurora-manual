...
Survey locations are arranged in concentric rings around the system center, representing waypoints where ships conduct gravitational surveys to discover jump points:

- **Inner ring**: Approximately survey locations 1-6
- **Middle ring**: Approximately survey locations 7-18
- **Outer ring**: Approximately survey locations 19-30
...
The tactical map includes a distance measuring tool that allows players to calculate distances between arbitrary points during gameplay. Distances are displayed in billions of kilometers, matching the scale used in ship design range calculations.
...
- The Sol system is roughly 20 billion km across (approximately 10-12 billion km from the center to the outermost planets)
- Comets can extend to 100 billion km or more from the system center
...
1. AuroraWiki, "System Map" (aurorawiki.pentarch.org/index.php?title=System_Map) -- Navigation controls, sidebar tabs, display toggles
2. Aurora Fandom Wiki, "Basics of the System Map" (aurora4x.fandom.com/wiki/Basics_of_the_System_Map) -- Body Info, Minerals, Sensors, Contacts tabs
3. Aurora Forums, "1.12.0 Changes List" (aurora2.pentarch.org/index.php?topic=11593.0) -- Alt+F11/Alt+F12 location history cycling
4. Aurora Forums, "how do i create a measurement line" (aurora2.pentarch.org/index.php?topic=10075.0) -- Shift+drag distance measuring
5. AuroraWiki, "Survey" (aurorawiki.pentarch.org/index.php?title=Survey) -- Geological survey indicator (white circle)
