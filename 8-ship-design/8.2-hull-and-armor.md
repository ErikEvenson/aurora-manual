...
|---|---|---|
| Conventional Steel \hyperlink{ref-8.2-1}{[1]} | 1 | Starting (Pre-TN) |
| Conventional Composite \hyperlink{ref-8.2-1}{[1]} | 2 | Starting (Pre-TN) |
| Conventional Advanced Composite \hyperlink{ref-8.2-1}{[1]} | 3 | Starting (Pre-TN) |
| Duranium \hyperlink{ref-8.2-1}{[1]} | 4 | Defensive Systems (TN) |
| High Density Duranium \hyperlink{ref-8.2-1}{[1]} | 6 | Defensive Systems |
| Composite \hyperlink{ref-8.2-1}{[1]} | 8 | Defensive Systems |
| Ceramic Composite \hyperlink{ref-8.2-1}{[1]} | 10 | Defensive Systems |
| Laminate Composite \hyperlink{ref-8.2-1}{[1]} | 12 | Defensive Systems |
| Compressed Carbon \hyperlink{ref-8.2-1}{[1]} | 15 | Defensive Systems |
| Biphase Carbide \hyperlink{ref-8.2-1}{[1]} | 18 | Defensive Systems |
| Crystalline Composite \hyperlink{ref-8.2-1}{[1]} | 21 | Defensive Systems |
| Superdense \hyperlink{ref-8.2-1}{[1]} | 25 | Defensive Systems |
| Bonded Superdense \hyperlink{ref-8.2-1}{[1]} | 30 | Defensive Systems |
| Coherent Superdense \hyperlink{ref-8.2-1}{[1]} | 36 | Defensive Systems |
| Collapsium \hyperlink{ref-8.2-1}{[1]} | 45 | Defensive Systems |
...
- Cost: 1 per unit (approximately 5% of the cost of normal armour in terms of strength)
- Strength: 20 per unit
...
Shield generators provide an energy barrier that absorbs incoming damage before it reaches armor. In C# Aurora, shields were substantially redesigned to create more strategic depth and differentiation between ship sizes.

**Shield strength formula:**

Shield generators use the same square root scaling as engines and power plants:

```
Shield Strength Modifier = SQRT(HS / 10)
```

This means shield strength scales non-linearly with size:

| Size (HS) | Relative Strength | Practical Effect |
|---|---|---|
| 1 | ~32% | Very inefficient; minimal protection |
| 5 | ~71% | Below standard efficiency |
| 10 | 100% | Reference strength (standard) |
| 20 | ~141% | Good strength-to-size ratio |
| 30 | ~173% | Strong defensive advantage |
| 50 | ~224% | Maximum practical efficiency |

This non-linear scaling grants larger vessels significantly enhanced defensive capabilities, rewarding investment in larger shield generators.

**Maximum shield generator size technology:**

A dedicated research line governs the maximum size of shield generators:

| Max Shield Size (HS) | Research Cost (RP) |
|---|---|
| 10 \hyperlink{ref-8.2-2}{[2]} | 1,000 |
| 12 \hyperlink{ref-8.2-2}{[2]} | 2,000 |
| 15 \hyperlink{ref-8.2-2}{[2]} | 4,000 |
| 20 \hyperlink{ref-8.2-2}{[2]} | 8,000 |
| 25 \hyperlink{ref-8.2-2}{[2]} | 15,000 |
| 32 \hyperlink{ref-8.2-2}{[2]} | 30,000 |
| 40 \hyperlink{ref-8.2-2}{[2]} | 60,000 |
| 50 \hyperlink{ref-8.2-2}{[2]} | 120,000 |

**Power and fuel:**

Shields in C# Aurora no longer require fuel to operate. This is a significant change from VB6, removing the logistical burden of keeping shields powered during long deployments.

**Recharge rate:**

Shield recharge rates remain unchanged from VB6 Aurora. Larger generators recharge proportionally slower relative to their strength. A 50 HS generator with ~224% strength takes approximately 2.24 times as long to fully recharge as a 10 HS standard generator. This creates a meaningful trade-off: large shields absorb more total damage but recover more slowly after being depleted. As of v1.12.0, shields will not recharge if the ship has lost all fuel tanks (destroyed in combat), reflecting the inability to power shield generators without fuel reserves.

**Shield HTK:**

Shield generator durability follows the same square root formula as other components:

```
Shield Generator HTK = SQRT(Shield Generator Size in HS)
```

A single 50 HS shield generator is easier to destroy than five 10 HS generators (HTK ~7 vs. 5 x ~3 = 15 total). This creates a vulnerability trade-off — one large generator is more space-efficient but represents a single point of failure.

**Cost and materials:**

- Building costs have been doubled compared to VB6 Aurora
- Shield generators exclusively require Corbomite for construction

**Shield design considerations:**

- **One large generator:** Most space-efficient due to square root scaling, but vulnerable to single hits and slow to recharge
- **Multiple smaller generators:** Less efficient per-HS, but better redundancy and faster individual recharge cycles
- **Mixed approach:** One large primary shield backed by a smaller secondary for redundancy

**Tip:** For capital ships, invest in maximum shield generator size research early. A single 50 HS shield provides 224% of the protection of a 10 HS unit while only taking 5x the space — that is a 44% space efficiency bonus. However, pair it with at least one backup generator so that losing a single component does not strip all shielding. The starting maximum of 10 HS requires only 1,000 RP to unlock, but advancing to 50 HS requires 120,000 RP \hyperlink{ref-8.2-2}{[2]}. For small combatants limited to 10 HS shields, consider whether the tonnage might be better spent on armor, which cannot be knocked out by a single lucky hit.
