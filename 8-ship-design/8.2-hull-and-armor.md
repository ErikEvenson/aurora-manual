...
- [7.4 Tech Categories](../7-research/7.4-tech-categories.md) -- Armor and shield technology research (Defensive Systems category)
- [8.3 Engines](8.3-engines.md) -- Speed versus armor weight trade-offs
- [12.1 Combat Mechanics](../12-combat/12.1-combat-mechanics.md) -- How armor and shields interact with incoming damage
- [9.1 Shipyards](../9-fleet-management/9.1-shipyards.md) -- Shipyard capacity constraints on hull size
