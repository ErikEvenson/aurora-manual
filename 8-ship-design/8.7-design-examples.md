...
![](../images/art/section-art/8.7.png)
...
| Component | Size ([HS](../appendices/B-glossary.md#hs)) | Qty | Notes |
|---|---|---|---|
...
- **2 [MFC](../appendices/B-glossary.md#mfc)s with 6 links each:** Can guide 12 missiles simultaneously (though with 6 launchers, 6 are in flight per salvo unless reloads are very fast). The second MFC provides redundancy and allows engaging a second target.
...
| 5 | Small Maintenance Storage | 1 | 100 [MSP](../appendices/B-glossary.md#msp) vs. ~50 max repair needed |
...
- Low annual failure rate (target ~0.08 [AFR](../appendices/B-glossary.md#afr))
