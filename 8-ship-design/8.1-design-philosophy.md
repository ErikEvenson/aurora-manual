...
![](../images/art/section-art/8.1.png)

![Figure 8.1: Class Design Window](../images/screenshots/8-ship-design/8.1-class-design.png)
...
![Ship Role Specialization Matrix](../images/diagrams/8-ship-design/8.1-ship-role-matrix.png)
...
> **v2.8.0+:** The surface interaction limit has been raised from 500 tons to 1,000 tons. All Light Naval vessels (1,000 tons or less) can now load and unload directly at planetary surfaces without cargo shuttle bays. See [Section 9.6.1.2 Surface Interaction Limit](../9-fleet-management/9.6-light-naval-operations.md).
...
- Enemy relies on missiles? Build AMM-heavy escorts with [CIWS](../appendices/B-glossary.md#ciws) and [ECM](../appendices/B-glossary.md#ecm).
...
- [Missile Design Window Layout](../images/missile-design-window.md) — [MSP](../appendices/B-glossary.md#msp) allocation and ordnance configuration interface
