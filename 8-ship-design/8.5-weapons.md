...
Plasma carronades are designed for high damage output at close range. They are more compact than equivalent lasers *(exact size ratio varies by focal size and technology level)*. They also benefit from a damage gradient of 1, meaning full damage at any range within their envelope (no falloff).
