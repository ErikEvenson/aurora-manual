...
Standard caliber progression: 10cm, 12cm, 15cm, 20cm, 25cm, 30cm, 35cm, 40cm, 50cm, 60cm, 70cm, 80cm \hyperlink{ref-db-laser-focal}{[1]}
...
The laser wavelength technologies determine maximum beam range. Each wavelength technology provides a specific range in kilometers \hyperlink{ref-db-wavelength}{[2]}:
...
**Size reduction at high recharge rates:** Lasers benefit from physical size reductions at higher recharge multipliers \hyperlink{ref-db-reduced-laser}{[3]}:
...
Railgun velocity technology determines maximum range. Available velocities range from 10,000 km to 90,000 km \hyperlink{ref-db-railgun-velocity}{[7]}. Higher velocity = longer effective range.
...
Example -- a 20cm railgun with capacitor tech 4 \hyperlink{ref-db-railgun-example}{[12]}:
...
- **Rate of fire (ROF):** Determined by technology. Measured in shots per 5-second fire control cycle. ROF ranges from 1 (base) up to 8 at the highest tech level \hyperlink{ref-db-gauss-rof}{[9]}. Higher Gauss Cannon ROF tech = more shots per cycle.
- **Velocity = Range:** The velocity technology determines the maximum engagement range (10,000 km to 60,000 km) \hyperlink{ref-db-gauss-velocity}{[10]}, analogous to railgun velocity.
- **Accuracy:** Determines the physical size of the gauss cannon. The base accuracy of 100% corresponds to a size of 6 HS (300 tons) \hyperlink{ref-db-gauss-accuracy}{[6]}. Size scales with accuracy: 50% accuracy = 3 HS, 33% accuracy = 2 HS, down to 8% accuracy = 0.5 HS. Lower accuracy makes the weapon smaller and cheaper but less effective per shot.
...
**Reduced-Size Launcher Options** \hyperlink{ref-db-reduced-launcher}{[4]}:
...
| 0.15x | 100x reload time | Box launcher (no internal reload) |
...
If a box launcher containing a missile is hit by enemy fire, the missile will explode. A technology line reduces the explosion probability \hyperlink{ref-db-box-explosion}{[5]}:
...
**Development Costs** \hyperlink{ref-db-carronade-cost}{[13]}:
...
Plasma carronades are designed for high damage output at close range. They occupy approximately half the hull space of an equivalent laser *(Needs verification -- the 2x damage claim from earlier versions may not apply to current C# Aurora)*. They also benefit from a damage gradient of 1, meaning full damage at any range within their envelope (no falloff).
...
- **Design parameters:** Focal size (determines damage) and Meson Focusing technology (determines range from 10,000 km to 120,000 km) \hyperlink{ref-db-meson-focusing}{[11]}
...
A technology line called Meson Armor Retardation provides armor with a chance to stop meson fire. Each layer of armor has an independent probability of stopping (retarding) the meson based on the defender's retardation technology. The penetration reduction per armor layer ranges from 50% at the first tech level down to 7% at the highest *(Needs verification)*:
...
- Deals 3 damage vs shields (triple base damage of 1) *(Needs verification)*
- After shields down, targets electronic systems only
- Does not bypass armor -- requires shields depleted first
- Range determined by Microwave Focusing technology (10,000 km to 120,000 km) \hyperlink{ref-db-microwave-focus}{[14]}
...
- Range determined by Particle Beam Range technology (60,000 km to 1,200,000 km) \hyperlink{ref-db-particle-range}{[15]}
- Strength determined by Particle Beam Strength technology (2 to 50) \hyperlink{ref-db-particle-strength}{[16]}
...
*Research Requirements* \hyperlink{ref-db-particle-lance}{[8]}:
...
\hypertarget{ref-db-laser-focal}{1}. AuroraDB.db FCT_TechSystem: Laser Focal Size (TechTypeID 15) -- 10cm through 80cm calibers

\hypertarget{ref-db-wavelength}{2}. AuroraDB.db FCT_TechSystem: Laser Wavelength (TechTypeID 3) -- Infrared (10,000 km) through Far Gamma Ray (120,000 km)

\hypertarget{ref-db-reduced-laser}{3}. AuroraDB.db FCT_TechSystem: Reduced Size Lasers (TechTypeID 140) -- 0.75x/4x and 0.5x/20x size/recharge options

\hypertarget{ref-db-reduced-launcher}{4}. AuroraDB.db FCT_TechSystem: Reduced Size Launchers (TechTypeID 129) -- Size multipliers and reload penalties

\hypertarget{ref-db-box-explosion}{5}. AuroraDB.db FCT_TechSystem: Box Launcher Explosion Chance (TechTypeID 216) -- 100% at 500 RP through 5% at 120,000 RP

\hypertarget{ref-db-gauss-accuracy}{6}. AuroraDB.db FCT_TechSystem: Gauss Cannon Size vs Accuracy (TechTypeID 143) -- 0.5 HS/8% through 6 HS/100%

\hypertarget{ref-db-railgun-velocity}{7}. AuroraDB.db FCT_TechSystem: Railgun Velocity (TechTypeID 77) -- 10,000 km through 90,000 km

\hypertarget{ref-db-particle-lance}{8}. AuroraDB.db FCT_TechSystem: Particle Lance (TechTypeID 208) -- Prerequisites: Particle Beam Range 200,000 km + Strength 6; Cost: 30,000 RP

\hypertarget{ref-db-gauss-rof}{9}. AuroraDB.db FCT_TechSystem: Gauss Cannon Rate of Fire (TechTypeID 141) -- ROF 1 (base) through ROF 8

\hypertarget{ref-db-gauss-velocity}{10}. AuroraDB.db FCT_TechSystem: Gauss Cannon Velocity (TechTypeID 144) -- 10,000 km through 60,000 km

\hypertarget{ref-db-meson-focusing}{11}. AuroraDB.db FCT_TechSystem: Meson Focusing Technology (TechTypeID 73) -- 10,000 km through 120,000 km

\hypertarget{ref-db-railgun-example}{12}. AuroraDB.db FCT_ShipDesignComponents: 20cm Railgun V40/C4 verified at Size 7.0, Power 12, Cost 55.4

\hypertarget{ref-db-carronade-cost}{13}. AuroraDB.db FCT_TechSystem: Carronade Calibre (TechTypeID 78) -- 15cm at 2,000 RP, 30cm at 16,000 RP

\hypertarget{ref-db-microwave-focus}{14}. AuroraDB.db FCT_TechSystem: Microwave Focusing Technology (TechTypeID 137) -- 10,000 km through 120,000 km

\hypertarget{ref-db-particle-range}{15}. AuroraDB.db FCT_TechSystem: Particle Beam Range (TechTypeID 61) -- 60,000 km through 1,200,000 km

\hypertarget{ref-db-particle-strength}{16}. AuroraDB.db FCT_TechSystem: Particle Beam Strength (TechTypeID 60) -- Strength 2 through 50
