...
- [7.4 Tech Categories](../7-research/7.4-tech-categories.md) -- Energy Weapons, Kinetic Weapons, and Missiles research
- [8.4 Sensors](8.4-sensors.md) -- Fire controls that direct weapon fire
- [12.1 Combat Mechanics](../12-combat/12.1-combat-mechanics.md) -- How weapons interact with armor, shields, and targets
- [8.7 Design Examples](8.7-design-examples.md) -- Worked ship designs showing weapon loadouts
