...
Launcher size determines the maximum missile size (in [MSP](../appendices/B-glossary.md) -- Missile Size Points) that can be fired. Launchers can now be designed in fractional sizes:
