...
- **Build Rate:** Shipyard output is measured in BP/year, similar to construction factories. The base rate is 400 BP per slipway per year (modifiable by technology) *(unverified — #760 -- requires live testing; no base entry in FCT_TechSystem, first tech level is 560 BP)* \hyperlink{ref-6.3-12}{[12]}.
...
- Begin with a baseline capacity of 10,000 tons *(unverified — #760 -- requires live testing; no repair yards in DB to confirm default capacity)*
