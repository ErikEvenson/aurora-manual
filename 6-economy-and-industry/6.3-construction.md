...
Researching new ship components (see [Section 8.1 Design Philosophy](../8-ship-design/8.1-design-philosophy.md)) requires Research Points (RP), with the cost determined by the component's Build Point (BP) cost. In version 1.13.0, the development cost formulas were restructured to address inconsistencies between component types and reduce prohibitive research costs for large components.
...
- [6.1 Minerals](6.1-minerals.md) -- Raw materials consumed during construction
- [6.2 Mining](6.2-mining.md) -- Producing the minerals needed for construction
- [9.1 Shipyards](../9-fleet-management/9.1-shipyards.md) -- Detailed shipyard capacity and management mechanics
- [9.2 Construction and Refit](../9-fleet-management/9.2-construction-and-refit.md) -- Building and refitting ships in shipyards
- [7.4 Tech Categories](../7-research/7.4-tech-categories.md) -- Construction Rate and Shipyard Operations research
- [13.1 Ground Unit Design](../13-ground-forces/13.1-ground-unit-design.md) -- Ground forces built by construction factories
