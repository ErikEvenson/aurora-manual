...
At game start, empires begin with conventional industry representing pre-TN (trans-newtonian) manufacturing capability. After researching Trans-Newtonian Technology, the Industry tab shows conversion options for all major TN installation types, not just a single type.
