...
- **Build Rate:** Shipyard output is measured in BP/year, similar to construction factories. The base rate is 400 BP per slipway per year (modifiable by technology) *(unverified — #760 -- 400 BP/slipway/year not directly confirmed in DB; first upgrade in tech tree is Shipbuilding Rate 560 BP)* \hyperlink{ref-6.3-12}{[12]}.
...
- Begin with a baseline capacity of 10,000 tons *(unverified — #760 -- no repair yards in DB to confirm default capacity)*
