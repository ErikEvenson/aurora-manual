...
- Base: 10 tons/year
- Maximum: 70 tons/year at the highest technology level
- Each tech level increases output progressively (e.g., 10, 20, 40, 70 tons/year per mine)
...
- [6.1 Minerals](6.1-minerals.md) -- The eleven TN mineral types and their uses
- [6.3 Construction](6.3-construction.md) -- Building mines and mining-related installations
- [14.2 Cargo Transport](../14-logistics/14.2-cargo-transport.md) -- Moving minerals between colonies via freighters
- [5.1 Establishing Colonies](../5-colonies/5.1-establishing-colonies.md) -- Setting up remote mining colonies
- [7.4 Tech Categories](../7-research/7.4-tech-categories.md) -- Mining technology research
