...
Mineral packets are physical objects moving through space, not instantaneous transfers. After launch, packets travel at approximately 10,000 km/s toward their destination. This means transit times depend heavily on distance:
...
Mass driver packets are launched at regular intervals (approximately every 30 days). On the system map, multiple packets may appear at different points along the trajectory, representing successive launches rather than a single slow-moving packet.
