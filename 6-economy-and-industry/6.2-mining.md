...
![](../images/art/section-art/6.2.png)

> **[Screenshot Pending — #1075]** Mass Driver Interface showing cargo transfer options
...
Mining is the process of extracting [trans-newtonian (TN)](../appendices/B-glossary.md#tn) minerals from planetary bodies and asteroids. Aurora C# provides several methods of mineral extraction, each suited to different situations and stages of development.
...
Total Annual Mining Output = Base mining rate x Accessibility x Number of mines x (1 + Governor Bonus)
...
- Build Cost: 120 [BP](../appendices/B-glossary.md#bp) (Build Points) \hyperlink{ref-6.2-3}{[3]}
...
- Size: 100 [HS](../appendices/B-glossary.md#hs) (Hull Space) (5,000 tons) \hyperlink{ref-6.2-7}{[7]}
...
### 6.2.6.3 CMC Tab (v2.8.0)

*Added: v2.8.0*

The Economics window includes a dedicated **CMC tab** (Civilian Mining Complex tab) for tracking civilian mining operations across your empire.

**Tab Features:**

- **Location Tracking:** Lists all current civilian mining complex locations in your empire
- **Potential Sites:** Shows potential mining sites being evaluated by the civilian sector
- **Production Data:** Displays mineral production from civilian mining operations

This tab consolidates civilian mining information that was previously scattered across multiple windows, making it easier to understand civilian mining contributions to your economy without navigating to individual colony screens.

> **Tip:** Use the CMC tab to identify which systems have attracted civilian mining investment. High-accessibility deposits that you have not yet exploited with government mines may already have civilian complexes generating mineral income.
