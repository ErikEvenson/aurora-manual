...
- The base speed of a maximum-size mineral packet is 1,000 km/s *(unverified -- sourced from Aurora Forums; no database field stores this constant, and it may have changed between VB6 and C#)* \hyperlink{ref-6.2-9}{[9]}
