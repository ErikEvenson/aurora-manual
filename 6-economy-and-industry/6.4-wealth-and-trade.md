...
- Conventional Factories can be converted to full Financial Centres at a cost of 20 Build Points, requiring 20 Corbomite
...
**Production Penalty from Wealth Deficit:**

When an empire's wealth balance goes negative, a production penalty is applied proportionally across all colonies. Industrial output from Construction Factories, Ordnance Factories, Fighter Factories, and Research Labs is reduced based on the severity of the deficit relative to annual wealth income. The deeper the deficit, the greater the penalty -- effectively throttling your empire's entire industrial capacity until the shortfall is resolved. This mechanic uses the same proportional reduction pattern as unrest penalties (see [Appendix A: Formulas, Section A.5](../appendices/A-formulas.md) for the general production modifier structure).

Maintaining positive wealth is therefore not merely a convenience but a structural requirement for full industrial output. Players should ensure wealth income exceeds expenditure through a combination of TN worker employment, Financial Centres, trade good revenue, and prudent fleet sizing. If a deficit occurs, the fastest remedies are mothballing excess ships to reduce maintenance costs, increasing the tax rate, or expanding TN industry to boost wealth generation.
...
> **Warning:** Before embarking on a major shipbuilding programme, check your projected maintenance costs. A fleet of 50 destroyers might win battles, but if you cannot afford to maintain them, they will become liabilities rather than assets. Balance fleet size against your economic capacity.
...
| 5M | Civilian Transport, Chemicals, Pharmaceuticals, Plastics |
| 10M | Ancient Artifacts, Consumer Electronics, Precious Metals |
| 10M (cont.) | Recreational Drugs, Entertainment Products, Furs |
| 10M (cont.) | Luxury Food, Spices, Wines |
