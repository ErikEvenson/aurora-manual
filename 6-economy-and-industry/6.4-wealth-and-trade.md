...
Each 1 million workers in [Trans-Newtonian (TN)](../appendices/B-glossary.md#tn) installations produces a baseline of **100 wealth per annum** \hyperlink{ref-6.4-1}{[1]}, regardless of whether their assigned installation is actively building or producing. Workers generate wealth simply by being employed at TN installations.
...
- Conventional Industry can be converted to Financial Centres at a cost of 20 [BP](../appendices/B-glossary.md#bp) (Build Points), requiring 20 Corbomite \hyperlink{ref-6.4-4}{[4]}
...
- **Shipbuilding:** Each ship and [PDC](../appendices/B-glossary.md#pdc) (Planetary Defence Centre) costs wealth equal to its BP value during construction
...
- **Maintenance Supply Production:** Producing [MSP](../appendices/B-glossary.md#msp) (Maintenance Supply Points) costs 1 wealth per 4 MSP (plus 0.5 Duranium, 0.25 Uridium, 0.25 Gallicite per 4 MSP)
...
Civilian ships are unarmed and vulnerable to hostile action. If alien races or hostile [NPR](../appendices/B-glossary.md#npr) (Non-Player Race) ships destroy civilian traders:
