...
*(unverified — #707 -- income rates from v2.6.0/v2.7.0 changelog, not directly confirmed in DB)*
...
**NPR Shipping Lines (v2.7.0):** NPR shipping lines are reduced to one freighter and one colony ship per 200 million population (down from 100 million). Harvesters are removed for NPRs. NPR payment modifier is 0.5x. *(unverified — #707 -- NPR shipping rules from changelog)*
...
Civilian ships will only travel a maximum of **four systems** from their origin for deliveries. *(unverified — #707 -- range cap from changelog)* This hard range cap affects all civilian logistics -- colonist transport, freight, trade goods, and infrastructure delivery.
...
- Each click of the Subsidize button adds **1,000 wealth** to the selected shipping line's coffers *(unverified — #707 -- 1,000 wealth per click from changelog)*
...
- Civilian ships use commercial engines (larger but cheaper than military engines; see [Section 8.3 Engines](../8-ship-design/8.3-engines.md)) and do not carry weapons *(unverified — #707)*
- Civilian ships cannot build jump-capable ships; inter-system civilian shipping requires a Jump Gate network (see [Section 4.4 Jump Points](../4-systems-and-bodies/4.4-jump-points.md)) *(unverified — #707)*
...
- Ships are selected for retirement based on being the oldest ship of the same type, with a minimum age of 10 years *(unverified — #707 -- 10-year minimum from changelog)*
- All civilian ships are scrapped when they reach 15 years old, regardless of condition *(unverified — #707 -- 15-year retirement age from changelog)*
...
- **Refuelling Cost:** Military ships refuelling from civilian harvesters pay 1 wealth per 10,000 litres of fuel *(unverified — #707 -- refuelling cost from changelog)*
- **Tax Revenue:** Excess fuel produced by civilian harvesters generates tax revenue at 20% of the fuel price *(unverified — #707 -- tax rate from changelog)*
...
- **Minimum Duranium:** At least 10,000 tons of Duranium present *(unverified — #707 -- threshold from changelog)*
- **Minimum Accessibility:** At least 0.7 accessibility rating *(unverified — #707 -- threshold from changelog)*
- **System Population:** Located in a system with a population of 10 million or more *(unverified — #707 -- threshold from changelog)*
- **Distance from Star:** Less than 80 AU from the parent star *(unverified — #707 -- distance cap from changelog)*
- **Multi-Star Systems:** If orbiting a non-primary star, that star must be within 80 AU of the primary or connected via Lagrange Points *(unverified — #707)*
