...
![](../images/art/section-art/6.5.png)

> **[Screenshot Pending — #1091]** CMC Management Tab showing civilian mining

> **[Screenshot Pending — #1086]** Civilian Shipping Lines Window
...
![Civilian Location Scoring Algorithm](../images/diagrams/6-economy-and-industry/6.5-civilian-scoring.png)
...
**[NPR](../appendices/B-glossary.md#npr) Shipping Lines (v2.7.0):** NPR shipping lines are reduced to one freighter and one colony ship per 200 million population (down from 100 million). Harvesters are removed for NPRs. NPR payment modifier is 0.5x. \hyperlink{ref-6.5-6}{[6]}
...
- Ship build cost equals the ship's [BP](../appendices/B-glossary.md#bp) (Build Points) in wealth, so a 5,000 BP freighter costs 5,000 wealth to construct *(unverified — [#707](https://github.com/ErikEvenson/aurora-manual/issues/707) -- wealth-based build cost from changelog)*
...
> **Note:** CMC spawn distance from the star is calculated using the body's aphelion (farthest orbital distance), not its current orbital position. \hyperlink{ref-6.5-13}{[13]}
...
| Threshold | Effect |
|-----------|--------|
| 10,000 | Infrastructure trade goods become available |
| 3 million | Basic trade goods unlock (Textiles, Machinery, Construction Materials) |
| 5 million | Additional trade goods unlock (Precious Metals, Consumer Electronics, Pharmaceuticals, etc.) |
| 10 million | Colony becomes eligible as civilian destination; remaining trade goods unlock (Spices, Luxury Food, Wines, etc.) |
| 25 million | Trade goods production becomes viable for sustained commercial routes *(unverified -- #1257)* |

Trade goods begin unlocking as early as 10,000 population, with most basic goods available at 3-5 million and all standard goods available at 10 million (see [Section 5.2.4.2 Population Milestones](../5-colonies/5.2-population.md#5242-population-milestones) for the full verified breakdown). At 25 million, the colony produces enough trade goods volume that civilian freighters consistently service it, generating meaningful wealth for shipping lines.
...
- **Subsidies:** You can subsidize shipping lines via the Subsidize button (1,000 wealth per click) to accelerate fleet growth. See [Subsidizing Shipping Lines](#65110-subsidizing-shipping-lines) above for details.
...
\hypertarget{ref-6.5-13}{[13]} Aurora Forums — Steve Walmsley (developer), September 2025 — CMC spawn distance check uses aphelion distance, not current orbital position.
