...
- Civilian ships cannot build jump-capable ships or use Jump Tenders independently; inter-system civilian shipping requires a Jump Gate network (see [Section 10.3 Jump Points](../10-navigation/10.3-jump-points.md))
...
- Maintaining sensor coverage (see [Section 11.1 Sensor Types](../11-sensors-and-detection/11.1-sensor-types.md)) to detect threats before they reach trade lanes.
...
- [6.4 Wealth and Trade](6.4-wealth-and-trade.md) -- Trade goods, revenue, and wealth mechanics
- [6.2 Mining](6.2-mining.md) -- Government mining compared to civilian mining complexes
- [9.1 Shipyards](../9-fleet-management/9.1-shipyards.md) -- Commercial shipyards used by civilian shipping lines
- [10.3 Jump Points](../10-navigation/10.3-jump-points.md) -- Jump gate networks required for inter-system civilian trade
- [14.2 Cargo Transport](../14-logistics/14.2-cargo-transport.md) -- Government freight operations supplementing civilian transport
- [5.1 Establishing Colonies](../5-colonies/5.1-establishing-colonies.md) -- Creating new civilian trade and mining destinations
