...
- **Deep Space Abandonment:** When civilian ships become stranded in deep space without movement capability, the shipping line abandons them. These vessels are transferred to the parent player race, which gains two options:
