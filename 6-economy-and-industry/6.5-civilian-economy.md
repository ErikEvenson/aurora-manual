...
**[NPR](../appendices/B-glossary.md) Shipping Lines (v2.7.0):** NPR shipping lines are reduced to one freighter and one colony ship per 200 million population (down from 100 million). Harvesters are removed for NPRs. NPR payment modifier is 0.5x. \hyperlink{ref-6.5-6}{[6]}
