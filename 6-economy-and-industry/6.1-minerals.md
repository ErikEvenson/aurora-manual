...
**Boronide** - Used in power generation components, reactors, and power plants. Also required for fuel refinery construction (fuel refineries consume Duranium and Boronide) and energy weapon components. \hyperlink{ref-6.1-4}{[4]} *(v2.7.1)* Every ship with an engine needs reactor power, making Boronide essential for fleet expansion.
