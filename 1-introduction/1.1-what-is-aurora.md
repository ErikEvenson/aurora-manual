...
- Enhanced AI for computer-controlled races *(unverified)*
- Improved ground combat and diplomatic systems \hyperlink{ref-1.1-9}{[9]}
- Better stability and reduced database corruption issues *(unverified)*
...
\hypertarget{ref-1.1-8}{[8]} Aurora Forums, "C# Meta compared to VB6" — Community comparison of VB6 and C# versions covering performance, interface, and feature changes. [aurora2.pentarch.org](http://aurora2.pentarch.org/index.php?topic=12418.0)
