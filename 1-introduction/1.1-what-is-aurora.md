...
> **Important Notice**: This manual was initially generated using AI assistance (Claude) and is undergoing verification against authoritative sources. Not all content has been verified.

**Verification Levels**:

- **Verified**: Content confirmed against authoritative sources with numbered references (e.g., \hyperlink{verified-example}{[1]})
- **Unverified**: Content not yet checked against sources — may contain errors or AI-generated assumptions
...
- Section 2.2 Race Creation (from screenshot)
- Section 2.3.1 Multi-star systems (from AuroraWiki, Steve Walmsley forum)

All other sections should be considered **unverified** until marked otherwise.
