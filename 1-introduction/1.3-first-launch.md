...
4. **Design a Ship**: Once you have some basic tech, open the Ship Design window (see [Section 8 Ship Design](../8-ship-design/)) and try creating a simple vessel — perhaps a fuel harvester or a second survey ship.
...
- [Section 8 Ship Design](../8-ship-design/) -- Creating your first ship designs
- [Section 9 Fleet Management](../9-fleet-management/) -- Organizing and commanding fleets
- [Section 17 Exploration](../17-exploration/) -- Survey operations and exploration
