...
- You must manually save using the **Save** button (disk icon) on the main toolbar \hyperlink{ref-launch-1}{[1]}
- The game will NOT remind you to save, and it does NOT autosave \hyperlink{ref-launch-2}{[2]}
- "C# does NOT save as you go. Nothing gets saved to the database until you click save" \hyperlink{ref-launch-3}{[3]}
...
> **Warning:** Save frequently. Aurora does not autosave \hyperlink{ref-launch-2}{[2]}. If the game crashes or you exit without saving, all progress since your last manual save is lost.
...
3. **Accept Defaults**: For your first game, the default settings are reasonable:
   - Use a Trans-Newtonian start (you begin with Trans-Newtonian technology, which "breaks the laws of Newton, giving you access to a wider technological tree") \hyperlink{ref-launch-4}{[4]}
...
> **Tip:** Do not worry about optimizing your first game. Aurora has enormous depth, and your first game is for learning, not winning. Use SpaceMaster mode (toggle with Ctrl+S to enable, Ctrl+O to disable, or use the lightbulb icon) \hyperlink{ref-launch-5}{[5]} to peek at things if you are confused about what is happening — you can toggle it on to see the full picture, then toggle it off to resume normal play. SpaceMaster "offers access to many world-building functions within the game itself" and lets you alter planets, teleport ships, and manipulate game state for learning purposes. The game will generate events (in the Event Log) when important things happen. Pay attention to these — they are how Aurora communicates with you. Time increments matter: use short increments (5 seconds to 30 seconds) during combat, longer increments (days to months) during peacetime development. If nothing seems to be happening, you probably need to advance time further. Early game development takes in-game years.
...
- [Section 9.1 Shipyards](../9-fleet-management/9.1-shipyards.md) -- Organizing and commanding fleets
- [Section 17.1 Geological Survey](../17-exploration/17.1-geological-survey.md) -- Survey operations and exploration

## References

\hypertarget{ref-launch-1}{[1]} Aurora Forums Full Installation Thread, "DON'T FORGET TO SAVE!! (Use the disk icon)." [aurora2.pentarch.org](https://aurora2.pentarch.org/index.php?topic=10635.0)

\hypertarget{ref-launch-2}{[2]} AuroraWiki Tips for Beginners, "Currently there is no autosave function." [aurorawiki.pentarch.org](http://aurorawiki.pentarch.org/index.php?title=Tips_for_beginners)

\hypertarget{ref-launch-3}{[3]} Aurora Forums Autosave Discussion, Moderator response. [aurora2.pentarch.org](https://aurora2.pentarch.org/index.php?topic=12239.0)

\hypertarget{ref-launch-4}{[4]} AuroraWiki on Trans-Newtonian Start. [aurorawiki.pentarch.org](https://aurorawiki.pentarch.org/index.php?title=One_Newbie's_Guide_to_a_Conventional_Start)

\hypertarget{ref-launch-5}{[5]} AuroraWiki C-SM Mode, "SM mode can be activated by selecting 'Spacemaster on' Ctrl+S (or 'Spacemaster off' Ctrl+O) from the main menu bar, or by the lightbulb on the upper right of the main screen." [aurorawiki.pentarch.org](https://aurorawiki.pentarch.org/index.php?title=C-SM_Mode)
