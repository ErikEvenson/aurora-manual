...
- You must manually save using the **Save** button on the main toolbar
- The game will NOT remind you to save, and it does NOT autosave
- When you exit, Aurora will warn you that it does not save automatically -- this is your reminder to save first
- Each save creates a backup copy (`AuroraDBSaveBackup.db`) of the previous state, providing one level of undo
- To maintain multiple save points, you can also manually copy the database file

> **Warning:** Save frequently. Aurora does not autosave. If the game crashes or you exit without saving, all progress since your last manual save is lost. *(v2.x.x)*
