...
> **Tip:** Do not worry about optimizing your first game. Aurora has enormous depth, and your first game is for learning, not winning. Use SpaceMaster mode (toggle with Ctrl+S to enable, Ctrl+O to disable, or use the lightbulb icon) \hyperlink{ref-1.3-launch-5}{[5]} to peek at things if you are confused about what is happening — you can toggle it on to see the full picture, then toggle it off to resume normal play. SpaceMaster "offers access to many world-building functions within the game itself" and lets you alter planets, teleport ships, and manipulate game state for learning purposes. The game will generate events (in the Event Log) when important things happen. Pay attention to these — they are how Aurora communicates with you. Time increments matter: use short increments (5 seconds to 30 seconds) during combat, longer increments (days to months) during peacetime development \hyperlink{ref-1.3-launch-6}{[6]}. If nothing seems to be happening, you probably need to advance time further. Early game development takes in-game years.
...
\hypertarget{ref-1.3-launch-2}{[2]} AuroraWiki Tips for Beginners, "Currently there is no autosave function." [aurorawiki.pentarch.org](http://aurorawiki.pentarch.org/index.php?title=Tips_for_beginners)
...
\hypertarget{ref-1.3-launch-4}{[4]} AuroraWiki on Trans-Newtonian Start. [aurorawiki.pentarch.org](https://aurorawiki.pentarch.org/index.php?title=One_Newbie's_Guide_to_a_Conventional_Start)

\hypertarget{ref-1.3-launch-5}{[5]} AuroraWiki C-SM Mode, "SM mode can be activated by selecting 'Spacemaster on' Ctrl+S (or 'Spacemaster off' Ctrl+O) from the main menu bar, or by the lightbulb on the upper right of the main screen." [aurorawiki.pentarch.org](https://aurorawiki.pentarch.org/index.php?title=C-SM_Mode)
