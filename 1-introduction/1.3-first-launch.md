...
> **Tip:** Do not worry about optimizing your first game. Aurora has enormous depth, and your first game is for learning, not winning. Use SpaceMaster mode to peek at things if you are confused about what is happening — you can toggle it on to see the full picture, then toggle it off to resume normal play. The game will generate events (in the Event Log) when important things happen. Pay attention to these — they are how Aurora communicates with you. Time increments matter: use short increments (5 seconds to 30 seconds) during combat, longer increments (days to months) during peacetime development. If nothing seems to be happening, you probably need to advance time further. Early game development takes in-game years.
