...
## 1.4.12 The /coach Skill (Claude Code)

*Updated: v2026.01.31*

If you're using Claude Code with this manual repository, a specialized `/coach` skill provides automated, spoiler-free coaching based on your actual game state.

### 1.4.12.1 What /coach Does
...
### 1.4.12.3 Game Phase Detection

The coach automatically determines your game phase by checking:
...
This makes the coach safe to use even in games where discovery is part of the experience.

### 1.4.12.5 Response Format
...
> **Current Situation:** Year 2028, conventional start. You have 450 construction factories, 180 mines, and just completed Trans-Newtonian Technology research.
>
> **Immediate Priority:** Convert Conventional Industry to TN installations. Start with Construction Factories (10 Duranium + 10 Neutronium each) to accelerate all future production.
>
> **Next Steps:**
> 1. Research propulsion technology — you need engines before useful ships
> 2. Convert some CI to Fuel Refineries — future ships will need fuel
> 3. Build Maintenance Facilities — MSP production prevents fleet deterioration
>
> **Learn More:**
> - [Section 2.5: Starting Conditions](https://erikevenson.github.io/aurora-manual/2-game-setup/2.5-starting-conditions.html) — CI conversion mechanics
> - [Section 7.4: Propulsion Technology](https://erikevenson.github.io/aurora-manual/7-research/7.4-propulsion-technology.html) — Engine research progression

### 1.4.12.6 When to Use /coach

The coach is most helpful when:
