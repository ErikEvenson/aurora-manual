...
- **CPU**: Any modern processor; faster single-thread performance helps with turn processing *(unverified -- no official CPU requirements published)*
- **RAM**: 4 GB minimum; 8 GB recommended for large games with many NPRs *(unverified -- no official RAM requirements published)*
