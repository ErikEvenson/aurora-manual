...
The following installation types may be recovered from ruins: *(unverified — #730 -- requires live testing; specific recoverable types not documented in forum/wiki)*
...
- **No Repair Required**: Recovered installations are assumed to be operational. Unlike shipwrecks, there is no salvage or repair phase. *(unverified — #730 -- requires live testing; forum sources suggest immediate availability but mechanics not confirmed)*
...
- **Cannot Be Duplicated**: Recovered installations are unique artifacts. You cannot build copies unless you have independently researched the underlying technology. *(unverified — #730 -- requires live testing; duplication mechanics not documented)*
...
- **Prerequisite Bypass**: Recovered technologies bypass normal prerequisite chains. *(unverified — #730 -- requires live testing; database shows techs have prerequisites but bypass behavior undocumented)* If you recover an advanced sensor, you can use it immediately even without having researched intermediate sensor technologies.
...
- **Prerequisite Bypass**: Recovered technology can bypass normal research prerequisites. *(unverified — #730 -- requires live testing; see Section 17.3.3.1.1)* You might obtain an advanced sensor without having researched intermediate sensor technologies.
...
The survey site list is accessible as a dedicated tab on the Tactical Map window. *(unverified — #730 -- requires live testing; interface location not documented in forum/wiki)* This placement integrates site management with ground operations planning.
