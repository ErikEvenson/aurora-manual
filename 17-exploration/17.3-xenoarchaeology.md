...
- **Prerequisite Bypass**: Recovered technologies bypass normal prerequisite chains. *(unverified)* If you recover an advanced sensor, you can use it immediately even without having researched intermediate sensor technologies.
