...
- **Tech Level Variation**: Ruins represent civilizations of varying technological advancement (rated by "Ruin Race Level" from 1 to 6; TL6 was added in v2.8.0). Some contain only marginally useful artifacts, while others hold technologies far beyond your current capabilities.
...
1. Aurora Wiki, "Ruins" - Ruin eligibility: terrestrial bodies with gravity greater than 0.4G, temperature 200K-360K.
2. AuroraDB.db FCT_Game - NewRuinCreationChance default value is 20 (20% base chance).
3. Aurora Wiki, "C-System Bodies" - Sol ruin probabilities: Mars ~5%, Mercury ~3%, Titan/Ganymede ~1%.
4. Aurora Forum, C# Changes - Xenoarchaeology annual probability equals total xeno points; scaled by construction phase length.
5. AuroraDB.db DIM_GroundComponentType - Xenoarchaeology Equipment: 100 tons, 0.5 points.
6. Aurora Forum, "Tech Level with Ruins" - Maximum tech cost formula: 2^(TL+1) x 1000 RP. TL6 added in v2.8.0.
