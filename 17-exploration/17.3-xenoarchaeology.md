...
- **Integration**: The component is mounted on ground combat vehicles or support vehicles (see [Section 13 Ground Forces](../13-ground-forces/13.1-ground-unit-design.md)), making xenoarchaeology part of your ground force structure
...
5. **Artifact Recovery**: When a recovery is successful, you receive a notification indicating what was found (see Section 17.3.3).
...
- **Habitable Bodies**: If the ruins are on a habitable world (see [Section 5 Colonies](../5-colonies/5.1-colonization.md)), simply land colonists and xeno teams together. The colony supports the excavation naturally.
...
Each technology component recovered grants you the knowledge of that specific technology as if you had researched it yourself (see [Section 7 Research](../7-research/7.1-technology-tree.md)). This can save years of research time, particularly if the technology is far ahead of your current level.
...
## 17.3.4 Alien Artifacts

Alien artifacts are a trade commodity generated through the exploitation of ruins, adding an economic dimension to xenoarchaeological operations.

### Discovery and Generation

Artifacts are recovered from ruins using a dedicated recovery type that operates alongside technology and installation recovery:

- **Recovery Mechanism**: Artifact recovery uses the same success rates as standard mined installations from ruins
- **Yield Per Recovery**: Each successful artifact recovery yields between 4 and 200 artifacts (calculated as 4 x D50, meaning four fifty-sided dice rolls combined)
- **Ruin Size**: The average number of ruin installations has been increased to account for the additional artifact recovery type, ensuring overall discovery rates remain balanced

### Trade Economics

Once recovered, alien artifacts function as standard trade commodities within the civilian economy:

- **Supply**: Generated exclusively through ruin exploitation activities
- **Demand**: Annual demand equals the population size in millions multiplied by any wealth modifiers. Only populations exceeding 5 million demonstrate artifact demand
- **Distribution**: Artifacts are handled by civilian shipping networks, circulating between population centers automatically once supply and demand exist
- **Economic Value**: Artifacts create a viable trade enterprise from archaeological operations, providing ongoing income rather than one-time technology gains

### Strategic Implications

Alien artifacts transform xenoarchaeology from a purely technology-focused activity into a sustainable economic endeavor. Bodies with large ruins near high-population centers become valuable trade hubs, generating continuous wealth through artifact circulation.
...
- [Section 5 Colonies](../5-colonies/5.1-colonization.md) -- Establishing excavation colonies on ruin sites
- [Section 7 Research](../7-research/7.1-technology-tree.md) -- How recovered technologies integrate with the research system
- [Section 13 Ground Forces](../13-ground-forces/13.1-ground-unit-design.md) -- Designing xenoarchaeology ground units
- [Section 14 Logistics](../14-logistics/14.1-supply-chains.md) -- Transporting xenoarchaeology formations to distant sites
