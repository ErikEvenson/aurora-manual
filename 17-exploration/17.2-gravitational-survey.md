...
- **Stellar Lagrange Points**: Points defined by the primary star's interaction with the galactic center of mass. These are the most common jump point locations. *(unverified — #837 -- requires live testing; Lagrange point mechanics not documented in database)*
- **Planetary Lagrange Points**: Points created by large planets' gravitational influence. Less common but possible. *(unverified — #837 -- requires live testing; Lagrange point mechanics not documented in database)*
- **Binary Star Points**: In binary or multiple star systems, the interaction between stellar components creates additional potential jump point locations. *(unverified — #837 -- requires live testing; Lagrange point mechanics not documented in database)*
...
- System star types (certain star types are more likely to have habitable worlds). *(unverified — #837 -- requires live testing; star type habitability correlation not documented in database)*
