...
Jump points are gravitational anomalies in space where the fabric of spacetime is thin enough to allow transit between star systems. Each jump point connects exactly two systems, creating a network of interstellar pathways.\hyperlink{ref-17.2-3}{[3]} Key properties:
