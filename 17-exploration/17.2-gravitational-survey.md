...
- **Bidirectional**: A jump point always has a corresponding exit point in the destination system. Transiting in either direction is possible.
...
You can assign gravitational survey orders through the Task Group Orders window:
...
- **Jump Drive**: Almost essential for gravitational survey ships, as their primary purpose is finding and transiting jump points. A grav survey ship without a jump drive is limited to systems with jump gates.
...
- **Scout Carefully**: Enter new systems cautiously. A passive-sensor-only approach (no active sensors) reduces your chances of being detected.
...
For full details on Ancient Construct mechanics, research bonuses, and their role in countering Aether Rifts, see Section 18.3.5.
