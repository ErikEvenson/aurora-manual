...
![](../images/art/section-art/17.2.png)
...
You can assign gravitational survey orders through the Task Group Orders window (see [Section 9.5 Orders](../9-fleet-management/9.5-orders.md)). There are two approaches: manual orders and standing orders.\hyperlink{ref-17.2-7}{[7]}

**Manual Survey Orders:**

To survey specific locations manually:

1. In the Task Group Orders window, check **"Survey Locations"** above the orders list
2. A list of available survey locations appears
3. Select specific locations to survey
4. The ship will travel to and survey those locations

This approach gives precise control over which locations to investigate first.

**Standing Orders:**

- **MV: Gravsurvey System**: The ship automatically moves between and surveys all unsurveyed locations in the system. This is the most common order for exploration ships.
- **SV: Survey Location**: Survey a single specified location, then stop. Useful for targeted investigation of specific survey points.

> **Warning:** Standing orders have a **10 billion kilometer distance threshold** — ships will not pursue survey targets beyond this range.\hyperlink{ref-17.2-7}{[7]} In very large systems, some outer survey locations may require manual orders or repositioning the fleet closer before the standing order will engage.

> **Note:** If the **MV: Gravsurvey System** standing order reports "unable to carry out standing orders," this may indicate the system is already fully surveyed, or remaining survey locations are beyond the 10 billion km threshold. Try using manual survey orders via the "Survey Locations" checkbox, or reposition your fleet closer to unsurveyed locations.
...
To display survey locations on the system map:\hyperlink{ref-17.2-7}{[7]}

1. Open the **System Map (F3)**
2. Go to the **Display tab**
3. Enable **"Show JP Survey Locations"**

Survey locations appear as markers with different states:

- **Unsurveyed**: Empty white circles indicating locations not yet investigated
- **Surveyed (Empty)**: Filled circles for locations surveyed but containing no jump point
- **Jump Point Found**: Discovered jump points appear with their own icon (labeled JP1, JP2, etc.) and show the destination system name once transited

> **Tip:** Always enable "Show JP Survey Locations" when beginning gravitational surveys in a new system. This reveals all 30 potential survey points and helps you track progress.
...
\hypertarget{ref-17.2-7}{[7]}. Aurora Forums — https://aurora2.pentarch.org/index.php?topic=12310.0 and https://aurora2.pentarch.org/index.php?topic=1177.0 — Gravitational survey mechanics: manual survey via "Survey Locations" checkbox, display via "Show JP Survey Locations" on Display tab, 10 billion km standing order threshold confirmed.
