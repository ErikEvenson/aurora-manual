...
- Gravitational survey sensors aboard your survey ships generate these points over time. The base sensor generates 1 survey point per hour, with higher-tech versions generating more: Improved (2/hour), Advanced (3/hour), Phased (5/hour).
...
Each system has a fixed number of gravitational survey locations, determined at system generation. Each system typically has approximately 30 survey locations.

Not every location will contain a jump point. Many (often the majority) will be empty. A typical system has 2-6 jump points, though extremes in either direction are possible.
...
### Gravitational vs. Geological Survey Priority
...
#### When to prioritize jump points
...
Gravitational surveys can also discover anomalies at survey locations. In v1.10.0+, these anomalies may contain Ancient Constructs -- structures left behind by a precursor civilization that provide research bonuses and serve as defenses against Aether Rifts.
...
1. Aurora Wiki, "Gravitational Survey Sensors" - Base sensor provides 1 survey point per hour.
2. AuroraDB.db FCT_TechSystem - Gravitational sensor progression: Base (1), Improved (2), Advanced (3), Phased (5) points per hour.
3. Aurora Wiki, "Survey" - Each system has approximately 30 survey locations with typically 2-6 jump points.
