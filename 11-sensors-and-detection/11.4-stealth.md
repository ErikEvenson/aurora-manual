...
In v2.0, important changes were made to how cloaking interacts with a ship's cross-section for detection and combat purposes:
...
- **Damaged Cloak Behavior (v2.0):** In v2.0+, the current state of the cloak is taken into account. If the cloak is damaged, the cross-section reverts to normal for both detection and combat purposes. This differs from v1.13 where a damaged cloak still provided the full cloaked cross-section.
