...
**Jump Point Sensor Mechanics:** When a fleet transits a jump point, it arrives in the destination system subject to jump shock. During jump shock, a fleet's sensor effectiveness is temporarily degraded, making it vulnerable to ambush. The standard jump point uses a stabilized jump gate; standard (non-squadron) transits through stabilized jump points do not incur jump shock for individual ships, but squadron transits do cause jump shock for all ships in the transiting squadron. Jump shock reduces crew training grade and sensor effectiveness for a period after transit. See [Section 10.2 Jump Transit](../10-navigation/10.2-jump-transit.md) for full jump shock mechanics. *(unverified — #725 -- jump shock sensor degradation specifics are documented in community sources but not directly in the database)*
