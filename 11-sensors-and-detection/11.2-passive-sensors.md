...
![](../images/art/section-art/11.2.png)
...
![Figure 11.2.1: Passive Sensor Detection Range vs Target Signature](../images/charts/11-sensors-and-detection/11.2.1-passive-sensor-detection.png)
...
- **Sensor Size ([HS](../appendices/B-glossary.md#hs)):** Larger sensors have better range but take more hull space. Sizes range from 0.1 HS to 50 HS. \hyperlink{ref-11.2-4}{[4]}
...
- Multiple thermal sensors on one ship do not stack; only the best detection result counts for each contact *(unverified — [#1283](https://github.com/ErikEvenson/aurora-manual/issues/1283))*
- Thermal sensors on different ships in a task group share their detections with the entire group *(unverified — [#1283](https://github.com/ErikEvenson/aurora-manual/issues/1283))*
...
![ELINT Intelligence Accumulation Thresholds](../images/charts/11-sensors-and-detection/11.2.4-elint-thresholds.png)
