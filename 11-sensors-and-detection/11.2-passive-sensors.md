...
> **Note:** This simplified linear formula approximates the component design window display. The actual detection calculation uses the area-based SQRT/PI formula shown in [Section 11.2.1 Thermal Detection](#1121-thermal-detection) above. The linear formula is useful for quick estimation, while the area-based formula governs actual in-game detection ranges.
