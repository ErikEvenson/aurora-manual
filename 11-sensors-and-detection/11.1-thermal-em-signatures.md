...
Active shields generate EM signature equal to three times their total shield strength. This means a heavily shielded ship that raises its shields is broadcasting its position to any EM sensor in range at considerable distance. Many commanders keep shields down during approach and only raise them when combat is imminent.
