...
**Example:** A destroyer with 4,000 EP (engine power) and standard engines has a max thermal signature of 4,000. At 50% speed, it produces a thermal signature of 2,000. With engines off (no movement orders), it produces an idle signature of its HS * 0.05 (e.g., a 6,000-ton / 120 HS destroyer produces an idle signature of 6). The same ship redesigned with Thermal Reduction x0.50 engines has a max thermal signature of 2,000 but burns three times the fuel per hour of operation.
