...
![](../images/art/section-art/11.1.png)
...
![Figure 11.1.1: Thermal Reduction Technology Progression](../images/charts/11-sensors-and-detection/11.1.1-thermal-reduction-tech.png)
...
```
Idle Thermal Signature = 5% of ship size in [HS](../appendices/B-glossary.md#hs) (or equivalently, 0.1% of size in tons)
```
...
| [ECM](../appendices/B-glossary.md#ecm) (while active) | Contributes to EM signature *(exact value unverified -- sensor jammers and missile jammers are electronic systems but their EM output formula is not stored in the database)* \hyperlink{ref-11.1-10}{[10]} |
