...
- **Shields** generate thermal signature when active (the EM component is typically more significant -- see EM Signatures below) *(unverified -- shield thermal contribution is not confirmed in the database; shield EM contribution is confirmed)*
