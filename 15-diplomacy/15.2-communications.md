...
- **Xenology**: The base technology (see [Section 7 Research](../7-research/7.1-technology-tree.md)) that enables construction of xenology labs. Higher levels improve lab efficiency.
...
2. **Physical Presence and Detection**: Both factions require ships and/or populations in the same system, and both sides must be able to detect the other. The detection requirements are:
   ...
   - **Ships**: Detected via active sensors (see [Section 11 Sensors and Detection](../11-sensors-and-detection/11.1-sensor-types.md))
...
- **Size**: 30 HS (Hull Spaces) (see [Section 8 Ship Design](../8-ship-design/8.1-design-overview.md))
...
- [Section 8 Ship Design](../8-ship-design/8.1-design-overview.md) -- Designing diplomatic ships with Diplomacy Modules
- [Section 11 Sensors and Detection](../11-sensors-and-detection/11.1-sensor-types.md) -- Detection requirements for communication attempts
- [Section 16 Commanders](../16-commanders/16.2-skills-and-bonuses.md) -- Officer Diplomacy skill affecting communication rates
- [Section 9 Fleet Management](../9-fleet-management/9.1-fleet-organization.md) -- Organizing diplomatic fleets and standing orders
