...
Diplomatic ships receive a favorable adjustment in the territory intrusion calculation (see Section 15.1.4):
...
- **Set Protection Status**: Establish territorial protection levels for your systems (see Section 15.1.4).
...
- **Warning**: The NPR is unhappy about something -- often your ships in their space. The severity corresponds to the threat level calculated from your presence (see Section 15.1.4).
...
The likelihood of an NPR complying with demands depends on the Claim Acceptance Formula (see Section 15.1.4):
