...
As of v2.2, Aurora uses an expanded design philosophy system for NPR ship generation rather than randomly selecting from fixed design themes. Individual aspects of NPR design are selected independently, producing significantly more varied opponents.
...
Minor Races are a reduced-capability NPC faction type introduced in v2.4. They represent small civilizations that lack the ambition or capability for interstellar expansion.
