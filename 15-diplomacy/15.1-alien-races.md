...
- **Government Type**: May affect diplomatic tendencies and internal policies *(unverified -- government types were removed from player race creation in C#; whether NPRs still use them internally is unclear)*.
