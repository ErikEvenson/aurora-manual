...
When starting a new game, you can configure the galaxy to include NPRs from the start (see [Section 2 Game Setup](../2-game-setup/2.1-new-game.md)). The game settings allow you to specify:
...
- **Fleet Building**: NPRs continuously design and construct warships (see [Section 8 Ship Design](../8-ship-design/8.1-design-overview.md)). Their designs evolve over time as they research new technologies.
...
- They detect your ships using their own active and passive sensors (see [Section 11 Sensors and Detection](../11-sensors-and-detection/11.1-sensor-types.md)).
...
- **Sensor Detection**: Your passive or active sensors (see [Section 11 Sensors and Detection](../11-sensors-and-detection/11.1-sensor-types.md)) pick up emissions from alien ships or installations.
...
- [Section 2 Game Setup](../2-game-setup/2.1-new-game.md) -- Configuring NPR generation and game options at game start
- [Section 11 Sensors and Detection](../11-sensors-and-detection/11.1-sensor-types.md) -- How NPR ships and populations are detected
- [Section 12 Combat](../12-combat/12.1-combat-overview.md) -- Combat mechanics relevant to NPR engagements and diplomatic penalties
- [Section 17 Exploration](../17-exploration/17.1-geological-survey.md) -- Survey ships that trigger first contact encounters
