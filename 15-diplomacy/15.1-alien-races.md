...
![](../images/art/section-art/15.1.png)

> **[Screenshot Pending — #1070]** Race Intelligence Window displaying known race information
...
[NPR](../appendices/B-glossary.md#npr)s (Non-Player Races) are the AI-controlled alien civilizations that populate the galaxy. Aurora C# generates these races through several mechanisms, each producing different types of encounters.
...
![NPR Attribute Impact Matrix](../images/diagrams/15-diplomacy/15.1-npr-attribute-matrix.png)

Each NPR is generated with a complete set of attributes that govern its behavior:

- **Government Type**: Affects diplomatic tendencies, starting installations, and ground force composition. Government type is selected during race creation for player races and randomly assigned for NPRs. See [Section 2.2.7 Government Type](../2-game-setup/2.2-race-creation.md#227-government-type) for the complete list and their effects.
...
![NPR Behavior Decision Tree](../images/diagrams/15-diplomacy/15.1-npr-behavior-tree.svg)
...
- NPRs build and deploy their own ships equipped with Diplomacy Modules *(unverified — [#701](https://github.com/ErikEvenson/aurora-manual/issues/701) -- NPR diplomatic ship construction not directly confirmed in DB)*
...
- NPRs will set their communication status to "Attempting Communication" based on their Diplomacy and Xenophobia attributes *(unverified — [#701](https://github.com/ErikEvenson/aurora-manual/issues/701))*
...
- NPR transponder behavior is not explicitly documented, but NPRs appear to operate with transponders off by default *(unverified — [#701](https://github.com/ErikEvenson/aurora-manual/issues/701))*
- Player detection of NPR ships relies on sensor capabilities rather than transponder broadcasts
- NPR civilian shipping may broadcast transponders to friendly races, similar to player civilian ships *(unverified — [#701](https://github.com/ErikEvenson/aurora-manual/issues/701))*
...
- **Diplomacy Ships**: Equip ships with Diplomacy Modules (30 [HS](../appendices/B-glossary.md#hs), 300 [BP](../appendices/B-glossary.md#bp), 50 crew) \hyperlink{ref-15.1-1}{[1]} to enable effective communication and maximize diplomatic point generation during contact.
...
- If the NPR ship is military, their response depends on their disposition -- aggressive NPRs may attack, while diplomatic ones may withdraw and send proper diplomatic vessels later *(unverified — [#701](https://github.com/ErikEvenson/aurora-manual/issues/701))*
...
![Territory Intrusion and Threat Calculation](../images/diagrams/15-diplomacy/15.1-intrusion-threat.svg)
...
![Territory Intrusion Penalty Calculation](../images/charts/15-diplomacy/15.1.4-territory-intrusion-penalty.png)
...
- Diplomatic ships (those with Diplomacy Modules) receive a 10,000-ton deduction per system *(unverified -- #1257 -- [Section 15.4.4.3](15.4-diplomacy.md#15443-tonnage-considerations) states "per ship per system"; whether the deduction applies per ship or per system is unconfirmed)*
...
![Claim Acceptance Formula](../images/diagrams/15-diplomacy/15.1-claim-acceptance.svg)
...
![Diplomatic Points Flow System](../images/diagrams/15-diplomacy/15.1-diplomatic-points-flow.svg)
...
### 15.1.7.2 Species Determination
...
The game setting "Minor Race % of New NPRs" (range 0-100%, default 25%) determines the probability that newly-generated [Trans-Newtonian (TN)](../appendices/B-glossary.md#tn) NPRs will be Minor Races rather than full-scale powers.

### 15.1.8.2 Key Characteristics
...
### 15.1.8.3 Expansion Constraints
