...
- **Shared Intelligence**: Allied races share sensor contacts (see [Section 11 Sensors and Detection](../11-sensors-and-detection/11.1-sensor-types.md)), giving you visibility into areas you otherwise could not observe.
...
- Complete galactic map with all existing labels (see [Section 4 Systems and Bodies](../4-systems-and-bodies/4.1-star-systems.md))
- All geological and gravitational survey data (see [Section 17 Exploration](../17-exploration/17.1-geological-survey.md))
...
- [Section 6 Economy and Industry](../6-economy-and-industry/6.1-minerals.md) -- Trade agreements and mineral exchange mechanics
- [Section 7 Research](../7-research/7.1-technology-tree.md) -- Research treaties and technology sharing
- [Section 14 Logistics](../14-logistics/14.1-supply-chains.md) -- Trade infrastructure and freight route management
- [Section 17 Exploration](../17-exploration/17.1-geological-survey.md) -- Survey data shared through geological and gravitational survey treaties
