...
![](../images/art/section-art/15.3.png)

> **[Screenshot Pending — #1094]** Treaty Proposal Interface
...
![Treaty Types and Benefits Matrix](../images/diagrams/15-diplomacy/15.3-treaty-matrix.png)

Treaties in Aurora C# formalize diplomatic agreements between your empire and alien races. \hyperlink{ref-15.3-1}{[1]} Each treaty type provides specific mechanical benefits and obligations. Treaties require a minimum communication level to propose (typically 40% or higher) and the other party must agree to the terms. \hyperlink{ref-15.3-2}{[2]} [NPR](../appendices/B-glossary.md#npr)s evaluate treaty proposals based on their diplomatic attributes. The specific communication level thresholds listed below for each treaty type are forum-sourced and have not been verified against the game database *(unverified -- #1257)*.
...
- **Requirements**: Communication level of at least 30% *(unverified — #1259)*. Relationship must be neutral or better.
...
- **Requirements**: Communication level of at least 50% *(unverified — #1259)*. Relationship must be friendly or better.
- **Effect**: Enables trade of minerals (see [Section 6.1 Minerals](../6-economy-and-industry/6.1-minerals.md)) between your colonies and the alien race's colonies. Trade generates wealth for both parties and can help address mineral shortages. Both sides must have appropriate trade infrastructure (trading stations or assigned freighters).
...
- **Effect**: Both parties share geological survey data (see [Section 17.1 Geological Survey](../17-exploration/17.1-geological-survey.md)) for systems they have surveyed. This can dramatically reduce the time needed to identify mineral-rich bodies in explored space.
- **Diplomatic Points**: Generates 100 base points per year, modified by `(1 - Xenophobia / 100)`.
...
- **Requirements**: Communication level sufficient for diplomatic proposals. Relationship must be neutral or better.
- **Effect**: Both parties share gravitational survey data (see [Section 17.2 Gravitational Survey](../17-exploration/17.2-gravitational-survey.md)), revealing jump point locations in surveyed systems. This can open up new expansion routes without needing to send your own survey ships.
- **Diplomatic Points**: Generates 100 base points per year, modified by `(1 - Xenophobia / 100)`.
- **Duration**: Indefinite until dissolved by either party.
...
- **Requirements**: Communication level of at least 70% *(unverified — #1259)*. Relationship must be friendly or better.
...
- **Requirements**: Communication level of at least 60% *(unverified — #1259)*. Relationship must be friendly or better.
...
- **Requirements**: Communication level of at least 80% *(unverified — #1259)*. Relationship must be strongly friendly (75+).
...
- **Requirements**: Communication level of at least 40% *(unverified — #1259)*. Relationship must be neutral or better.
- **Effect**: Your ships can move through the alien race's systems without triggering hostile responses. Without transit rights, the presence of your ships in their space will generate intrusion penalties scaled by tonnage, system value, and xenophobia (see [Section 15.1 Alien Races](15.1-alien-races.md)).
...
- **Shared Intelligence**: Allied races share sensor contacts (see [Section 11.1 Thermal and EM Signatures](../11-sensors-and-detection/11.1-thermal-em-signatures.md)), giving you visibility into areas you otherwise could not observe.
...
![Independence Process Flow](../images/diagrams/15-diplomacy/15.3-independence-flow.png)
...
- Complete galactic map with all existing labels (see [Section 4.1 Star Systems](../4-systems-and-bodies/4.1-star-systems.md))
- All geological and gravitational survey data (see [Section 17.1 Geological Survey](../17-exploration/17.1-geological-survey.md))
...
For the comprehensive diplomatic point reference including all positive sources, negative penalties, decay rates, and relationship thresholds, see [Section 15.1.5 Diplomatic Points System](15.1-alien-races.md#1515-diplomatic-points-system).
...
- [Diplomacy Window Layout](../images/diplomacy-window.md) — treaty proposal and status display

## Related Sections

- [Section 6.1 Minerals](../6-economy-and-industry/6.1-minerals.md) -- Trade agreements and mineral exchange mechanics
- [Section 7.1 Technology Tree](../7-research/7.1-technology-tree.md) -- Research treaties and technology sharing
- [Section 14.1 Fuel](../14-logistics/14.1-fuel.md) -- Trade infrastructure and freight route management
- [Section 17.1 Geological Survey](../17-exploration/17.1-geological-survey.md) -- Survey data shared through geological and gravitational survey treaties
- [Appendix A: Formulas](../appendices/A-formulas.md) -- Treaty point generation formulas
