...
ELINT modules follow a strength progression similar to EM Sensors. Each module requires the corresponding EM Sensor strength technology as a prerequisite. The cost formula is 20 x Strength.

### Secondary Sensor Function
...
- **Naval Officers Only**: Ground force commanders cannot gain Intelligence bonuses in C# Aurora.
