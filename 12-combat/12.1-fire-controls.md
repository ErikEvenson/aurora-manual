...
**Single Weapon Fire Controls (C# Aurora v1.13+):**
...
- **CIWS:** ECCM costs 5% of the CIWS fire control component per level, with no size penalty. As of v2.8.0, CIWS components research under the Direct Fire category (previously categorized under Missiles).
...
Because fire delay operates at the ship level, all fire controls are normally affected equally. This created a problem where larger ships with multiple fire controls would experience reduced point defence effectiveness when offensive systems changed targets. The v1.13 change allows automated point defence to function consistently without being compromised by offensive targeting changes.
