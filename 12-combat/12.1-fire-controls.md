...
- **Range:** The maximum distance at which the fire control can engage targets. Determined by the Beam Fire Control Range technology. Ranges start at 20,000 km and increase with research.[^fc-range]

[^fc-range]: Fire Control Range technology progression verified against AuroraDB.db (TechTypeID=4).
