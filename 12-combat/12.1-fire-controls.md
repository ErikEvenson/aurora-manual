...
- **Size:** BFC size is fixed at 1 HS (50 tons) for standard beam fire controls. Smaller versions (0.5 HS) are available at reduced range and tracking speed for use on fighters and FACs. *(unverified — #728)*
...
- Ships with 100% Fleet Training (500 points) experience zero fire delay *(unverified — #728)*
...
Any beam fire control with a tracking speed at least 2x the racial base speed is automatically classified as a point defence fire control by the game's weapon assignment system. *(unverified — #728)*
