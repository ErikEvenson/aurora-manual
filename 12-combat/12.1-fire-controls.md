...
- **Size:** The base BFC size is 1 HS, with components scalable up to size 4 for increased range.\hyperlink{ref-12.1-7}{[7]} Single-weapon (SW) variants provide 30-50% reduced size and cost for fighter and FAC applications, with exact values varying based on range and tracking speed selections.\hyperlink{ref-12.1-8}{[8]}
