...
Note: The above table shows approximate base values at starting technology. Exact size, damage, and range depend on Laser Focal Size, Laser Wavelength, and Capacitor Recharge Rate technologies researched.\hyperlink{ref-12.2-1}{[1]} Higher wavelength tech increases range; higher capacitor tech increases size and power requirements. See [Section 12.2.7 Beam Weapon Reference Tables](#1227-beam-weapon-reference-tables) for ground-truth reference examples at specific tech levels (e.g., 10cm C3 UV = 3 HS, 120,000 km range; 20cm C5 UV = 6 HS, 400,000 km range).
