...
- Must be built into the ship design from the start (cannot be refitted) *(unverified)*
- The ship can only fire the spinal mount at targets within its forward arc *(unverified)*
