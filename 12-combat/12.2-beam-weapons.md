...
Lasers are the primary weapon type affected by damage falloff. For weapons with no falloff, the weapon deals its full base damage at any range within its maximum envelope. Note: damage falloff (whether damage decreases with range) and damage gradient (how damage spreads across armor columns, see [Section 12.2.2.3](#1223-damage-gradient-armor-column-spread)) are independent properties.
...
\hypertarget{ref-12.2-13}{[13]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_ShipDesignComponents ComponentTypeID=44: "R15/C3 High Power Microwave" verified: DamageOutput=1, Size=3.0, MaxWeaponRange=150000, NumberOfShots=1, Cost=18.9. The R20/C5 example in the table is a higher-tech variant; all HPM variants share DamageOutput=1 as their base. The 3x shield damage multiplier is a combat-resolution mechanic, not a stored component property.
