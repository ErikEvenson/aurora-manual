...
![](../images/art/section-art/12.4.png)

Point defense is the art of destroying incoming missiles and hostile small craft before they can damage your ships. Aurora provides two primary point defense mechanisms: Close-In Weapon Systems ([CIWS](../appendices/B-glossary.md#ciws)) using beam weapons, and Anti-Missile Missiles (AMMs) using dedicated interceptor missiles. Effective defense requires layering both systems and understanding their individual strengths.
...
- **[ECCM](../appendices/B-glossary.md#eccm):** CIWS fire controls can integrate ECCM at 5% of fire control cost per level (no size penalty)

Gauss cannon configurations:

| Type | Shots per Burst | Size ([HS](../appendices/B-glossary.md#hs)) |
|------|----------------|-----------|
...
**CIWS Reference Example:**

The following is a representative CIWS installation combining gauss cannons with an integrated fire control and tracking system:\hyperlink{ref-12.4-6}{[6]}

| Stat | CIWS-160 |
|------|----------|
| Rate of Fire | 4 shots/5 sec |
| Range | 10,000 km max |
| Size | 11.9 HS |
| HTK | 3 |
| Tracking Speed | 16,000 km/s |
| ECCM Level | 2 |
| Base Hit Chance | 50% |
| Cost | 66.2 BP |
| Crew | 12 |
| Materials | 32 Duranium, 13.2 Corbomite, 10 Vendarite, 11 Uridium |
| Dev Cost | 575 RP |

Note: CIWS installations are self-contained systems with integrated fire controls and built-in ECCM. They do not require separate beam fire controls or reactor power. The ECCM level is determined at design time and counters missile-mounted jammers.
...
![CIWS Effectiveness vs Missile Speed](../images/charts/12-combat/12.4.1-ciws-effectiveness-vs-missile-speed.png)
...
The [ECM](../appendices/B-glossary.md#ecm)/ECCM modifier applies when incoming missiles have Fire Control Jammers (see [Section 12.5.3 Fire Control Jammers](12.5-electronic-warfare.md#fire-control-jammers) for detailed mechanics):\hyperlink{ref-12.4-4}{[4]}
```
...
- Each weapon has a 2% failure chance per shot -- high rate of fire means more [MSP](../appendices/B-glossary.md#msp) consumption

## 12.4.2 PD Fire Controls

*Updated: v2026.02.15*

![Point Defense Engagement Sequence](../images/diagrams/12-combat/12.4-pd-engagement-sequence.png)
...
- **ECCM integration:** Include ECCM to counter missile-mounted Fire Control Jammers (5% cost per level for CIWS, 10% for standard [BFC](../appendices/B-glossary.md#bfc))
...
AMM guidance requires missile fire controls ([MFC](../appendices/B-glossary.md#mfc)s, active sensors) with resolution 1. See [Section 12.3 Missiles](12.3-missiles.md) for details on AMM fire control configuration. Note that AMM fire controls are separate from beam PD fire controls -- you need both types for a layered defense.
...
![Point Defense Layering](../images/diagrams/12-combat/12.4-point-defense-layers.svg)
...
**Decoy Probability Formulas (Defender Perspective):** *(unverified — [#865](https://github.com/ErikEvenson/aurora-manual/issues/865))*
...
**Ranged Defensive Fire vs. Laser Warheads:** *(unverified — [#865](https://github.com/ErikEvenson/aurora-manual/issues/865))*
...
- Against [NPR](../appendices/B-glossary.md#npr) (Non-Player Races): Start with moderate PD, scale up after observing their salvos
...
\hypertarget{ref-12.4-6}{[6]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT_ShipDesignComponents (SDComponentID=153718, ComponentTypeID=51): CIWS-160. Size=11.9 HS, Cost=66.2 BP, HTK=3, Crew=12, TrackingSpeed=16000 km/s, ECCM=2, NumberOfShots=4, WeaponToHitModifier=0.5, Materials: Duranium=32, Corbomite=13.2, Vendarite=10, Uridium=11. FCT_TechSystem (TechSystemID=153718): DevelopCost=575 RP.
