...
The number of base shots is determined by the Gauss Cannon Rate of Fire technology, which can provide up to 6 shots per turret per burst (8 shots at maximum research). See [Section 12.2 Beam Weapons](12.2-beam-weapons.md) for the full gauss cannon research progression table.
...
- **Weapon failure risk:** 1% chance per shot -- relevant for sustained PD
...
- Each weapon has a 1% failure chance per shot -- high rate of fire means more MSP consumption
