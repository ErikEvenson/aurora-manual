...
The number of base shots is determined by the Gauss Cannon Rate of Fire technology, which can provide up to 6 shots per turret per burst (8 shots at maximum research, costing 750,000 RP).\hyperlink{ref-12.4-1}{[1]} See [Section 12.2 Beam Weapons](12.2-beam-weapons.md) for the full gauss cannon research progression table.
...
The ECM/ECCM modifier applies when incoming missiles have Fire Control Jammers (see [Section 12.5.3 Fire Control Jammers](12.5-electronic-warfare.md) for detailed mechanics):\hyperlink{ref-12.4-4}{[4]}
```
...
\hypertarget{ref-12.4-4}{[4]}. Aurora Wiki (ECM, ECCM articles) -- ECM penalty formula: 20% hit chance reduction per point of Fire Control Jammer advantage over ECCM. At 5+ advantage, hit chance drops to zero.
