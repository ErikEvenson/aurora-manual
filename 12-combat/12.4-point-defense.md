...
- **Damage per shot:** 1 point (sufficient to destroy any standard missile in one hit; fractional warhead rules apply to small AMMs -- see Section 12.3.1)
...
The number of base shots is determined by the Gauss Cannon Rate of Fire technology, which can provide up to 6 shots per turret per burst (8 shots at maximum research). See Section 12.2.6 for the full gauss cannon research progression table.
...
AMM fire controls support a **minimum engagement range** setting (see Section 12.1.2) to prevent AMMs from launching at targets already within beam PD range.
