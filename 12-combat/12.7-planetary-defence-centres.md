...
PDC fire controls benefit from a 25% range bonus versus ship-mounted equivalents when engaging orbital targets, reflecting their dedicated targeting infrastructure. *(unverified -- specific bonus percentage)*
...
- Factor in fortification levels: a PDC at fortification 6 has approximately 0.56% per-shot hit chance from energy weapons *(unverified -- specific percentage)*
