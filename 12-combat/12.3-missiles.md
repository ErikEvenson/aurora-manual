...
- **Terminal guidance does not apply** to laser warheads — they use focus range/detonation range mechanics instead of hit chance calculations \hyperlink{ref-12.3-11}{[11]}
...
\hypertarget{ref-12.3-11}{[11]}. AuroraWiki — Laser warheads (http://aurorawiki.pentarch.org/index.php?title=Laser_warheads) — Laser warhead damage is calculated using focus range mechanics: full damage within focus range, damage × (focus range / distance) beyond. Detonation range does not affect hit chance. Terminal guidance (a hit chance modifier) therefore does not apply to laser warheads, which use range-based damage falloff instead of hit/miss calculations.
