...
Missile hit chance is determined by the ratio of missile speed to target speed:[^hit-formula]
...
[^hit-formula]: Hit chance formula verified via Aurora Wiki (C-Missiles, C-Ship-Combat) and Naval Gazing Aurora 2.2+ Missile Warfare guide.
...
**Active Terminal Guidance** (0.25 MSP component, costs Uridium) improves hit chance beyond the base speed ratio. The terminal guidance bonus ranges from +15% to +60% based on technology level, applied as a multiplier to the base hit chance.[^terminal-guidance] See the Active Terminal Guidance subsection below for technology progression details.

[^terminal-guidance]: Terminal guidance technology progression verified against AuroraDB.db (TechSystemID 33-39): +15% (1,000 RP), +20% (2,000 RP), +25% (4,000 RP), +32% (8,000 RP), +40% (16,000 RP), +50% (32,000 RP), +60% (64,000 RP).
...
- [Section 12.5 Electronic Warfare](12.5-electronic-warfare.md) -- Ship EW systems; see especially [Section 12.5.3 Fire Control Jammers](12.5-electronic-warfare.md) for missile ECM interactions with point defense
