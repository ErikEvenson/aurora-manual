...
\hypertarget{ref-12.3-11}{[11]}. *(Unverified — #851)* — Active Terminal Guidance (added v2.2.0) is a hit chance modifier. Laser warheads use detonation range/damage falloff mechanics. Whether ATG applies to laser warheads is undocumented; requires in-game testing or Steve Walmsley confirmation.
