...
Missile hit chance is determined by the ratio of missile speed to target speed:
...
**Active Terminal Guidance** (0.25 MSP component, costs Uridium) improves hit chance beyond the base speed ratio. The terminal guidance bonus ranges from 0.25 (25%) to 0.90 (90%) based on technology level, applied as a multiplier to the base hit chance. See the Active Terminal Guidance subsection above for technology progression details.
...
- If hit while containing a missile, the missile will explode (reducible by technology from base chance to 5%)

> *[v2.7.1]: Box launcher explosion chance needs verification -- community sources report 70% base chance.*
