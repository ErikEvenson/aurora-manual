...
![](../images/art/section-art/12.3.png)
...
Missiles are measured in Missile Size Points ([MSP](../appendices/B-glossary.md#msp)), where each MSP equals 2.5 tons. Missiles can be up to 200 MSP (500 tons) total. The missile's size determines what launcher can fire it and how many can be stored in a magazine:
...
![Missile Hit Probability vs Speed Ratio](../images/charts/12-combat/12.3.1-missile-speed-vs-hit-probability.png)
...
Missiles can mount [ECM](../appendices/B-glossary.md#ecm) systems with a fixed cost of 0.25 MSP \hyperlink{ref-12.3-9}{[9]}:
...
![Missile Engagement Sequence](../images/diagrams/12-combat/12.3-missile-engagement.svg)
...
- **Ordnance Transfer Points:** Spaceports, Ordnance Transfer Stations, or Ordnance Transfer Hubs -- reloading is 10x slower than hangar operations *(unverified — #1230)*
...
Missiles require continuous guidance from the launching ship's missile fire control ([MFC](../appendices/B-glossary.md#mfc)) during flight. The MFC must maintain sensor lock on the target for guidance updates:
...
- **Whether ATG applies to laser warheads is unknown** — requires in-game testing or developer confirmation *(unverified — [#851](https://github.com/ErikEvenson/aurora-manual/issues/851))* \hyperlink{ref-12.3-11}{[11]}
...
Additionally, the Galactic Map window received a new sidebar panel that displays missile salvos present in the currently selected system (see [Section 3.5 Galactic Map](../3-user-interface/3.5-galactic-map.md)). This provides at-a-glance awareness of active missile combat across your empire without needing to open the dedicated Missile Salvos window.
...
- [Section 12.5 Electronic Warfare](12.5-electronic-warfare.md) -- Ship EW systems; see especially [Section 12.5.3 Fire Control Jammers](12.5-electronic-warfare.md#1253-fire-control-jammers) for missile ECM interactions with point defense
