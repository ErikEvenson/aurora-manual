...
- **Terminal guidance likely does not apply** to laser warheads — they use detonation range mechanics instead of hit chance calculations *(inferred from mechanics — #851)* \hyperlink{ref-12.3-11}{[11]}
...
\hypertarget{ref-12.3-11}{[11]}. Aurora Forums — "Laser Warheads for Missiles, what do they currently do?" (https://aurora2.pentarch.org/index.php?topic=7670.0) and "An analysis of 2.2+ Missile Warfare" (https://aurora2.pentarch.org/index.php?topic=13521.0) — Laser warheads detonate at range and use damage falloff mechanics rather than hit/miss calculations. Terminal guidance (a hit chance modifier for standard warheads) is not discussed in context of laser warheads, which fire from outside point defense range. *(Inferred from mechanics — explicit confirmation needed)*
