...
**Active Terminal Guidance** (0.25 MSP component, costs Uridium) improves hit chance beyond the base speed ratio. The terminal guidance bonus ranges from 0.25 (25%) to 0.90 (90%) based on technology level, applied as a multiplier to the base hit chance. See the Active Terminal Guidance subsection below for technology progression details.
