...
- Technology progression from 20% bonus (1,000 RP) to 90% bonus (128,000 RP)
...
This means larger missiles take proportionally longer to reload due to square root scaling, and reduced-size launchers multiply the reload time by their penalty factor. Reload Rate technology directly reduces the time between salvos.
