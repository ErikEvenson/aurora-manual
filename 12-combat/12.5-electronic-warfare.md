...
> **Note:** Fire Control Jammer Level 3 has an anomalous cost of 60 BP, whereas the corresponding Sensor Jammer 3 and Missile Jammer 3 both cost 30 BP. The FC Jammer cost progression is 10, 20, **60**, 40, 60, 80, 100, 125, 160, 200 BP for levels 1--10. The level 3 value breaks the otherwise smooth scaling and may be a game database error.
...
\hypertarget{ref-12.5-3}{[3]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_ShipDesignComponents: All three jammer types (Sensor, Fire Control, Missile) share identical size (3.0 HS), crew (5), and Corbomite material requirements per level. Missile Jammer (ComponentTypeID=20) cost scales: 10/20/30/40/60 BP for levels 1-5. However, BP costs are NOT identical across types: Fire Control Jammer Level 3 costs 60 BP vs 30 BP for Sensor Jammer 3 and Missile Jammer 3. FC Jammer full cost progression: 10/20/60/40/60/80/100/125/160/200 BP (levels 1-10). The level 3 anomaly may be a game database error.
