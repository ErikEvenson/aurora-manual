...
| Fire Control Jammers | Beam fire controls, [CIWS](../appendices/B-glossary.md#ciws), STO weapons | Degrades tracking accuracy |
...
- If jamming reduces the enemy [MFC](../appendices/B-glossary.md#mfc) effective range below actual engagement distance, lock is lost
...
Fire Control Jammers degrade the accuracy of enemy beam fire controls, CIWS, and STO weapons targeting the jammer-equipped ship. All three jammer types share the same size (3.0 [HS](../appendices/B-glossary.md#hs)), crew requirement (5), and Corbomite material cost per level, but their [BP](../appendices/B-glossary.md#bp) (Build Points) costs are not identical. \hyperlink{ref-12.5-3}{[3]}

**Complete Jammer Cost Table (All 10 Levels):**

| Level | Sensor Jammer (BP) | Fire Control Jammer (BP) | Missile Jammer (BP) | Size (HS) | Crew | Corbomite |
|-------|-------------------|-------------------------|--------------------:|----------:|-----:|----------:|
| 1 | 10 | 10 | 10 | 3.0 | 5 | 10 |
| 2 | 20 | 20 | 20 | 3.0 | 5 | 20 |
| 3 | 30 | **60** | 30 | 3.0 | 5 | 30 |
...
| 5 | 60 | 60 | 60 | 3.0 | 5 | 60 |
| 6 | 80 | 80 | 80 | 3.0 | 5 | 80 |
| 7 | 100 | 100 | 100 | 3.0 | 5 | 100 |
| 8 | 125 | 125 | 125 | 3.0 | 5 | 125 |
| 9 | 160 | 160 | 160 | 3.0 | 5 | 160 |
| 10 | 200 | 200 | 200 | 3.0 | 5 | 200 |

> **Note:** Fire Control Jammer Level 3 has an anomalous cost of 60 BP, whereas the corresponding Sensor Jammer 3 and Missile Jammer 3 both cost 30 BP. The level 3 value breaks the otherwise smooth scaling and may be a game database error. All other levels have identical costs across the three jammer types.
...
Missile Jammers disrupt the guidance of enemy missiles during their terminal approach phase. All Missile Jammer components are 3 HS in size, with cost scaling from 10 BP (level 1) to 200 BP (level 10). See the complete cost table in [Section 12.5.3](#1253-fire-control-jammers) above. \hyperlink{ref-12.5-3}{[3]}
...
\hypertarget{ref-12.5-3}{[3]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_ShipDesignComponents (ComponentTypeID=20): All three jammer types share identical size (3.0 HS), crew (5), and Corbomite material costs matching BP cost per level. Full BP cost progression for Sensor and Missile Jammers: 10/20/30/40/60/80/100/125/160/200 (levels 1-10). Fire Control Jammer cost progression: 10/20/60/40/60/80/100/125/160/200 (levels 1-10). The FC Jammer level 3 anomaly (60 BP vs 30 BP for the other two types) may be a database error. All other levels are identical across all three jammer types.
