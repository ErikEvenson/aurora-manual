...
Fire Control Jammers degrade the accuracy of enemy beam fire controls, CIWS, and STO weapons targeting the jammer-equipped ship. All three jammer types share the same size (3.0 HS), crew requirement (5), and Corbomite material cost per level, but their [BP](../appendices/B-glossary.md#bp) (Build Points) costs are not identical. \hyperlink{ref-12.5-3}{[3]}
