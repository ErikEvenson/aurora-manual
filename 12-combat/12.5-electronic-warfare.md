...
Each system has 10 technology levels with research costs ranging from 2,500 RP (level 1) to 1,200,000 RP (level 10).[^ew-costs] Note: as of v2.4.0, the development cost for Sensor Jammer 8 was corrected from 30,000 RP to 300,000 RP to match the intended progression curve.

[^ew-costs]: Electronic warfare technology costs verified against AuroraDB.db: Sensor Jammer (TechSystemID 12017-12026), Fire Control Jammer (12037-12046), Missile Jammer (55-64). All three jammer types follow identical cost progression: 2,500/5,000/10,000/20,000/40,000/80,000/150,000/300,000/600,000/1,200,000 RP.
...
This represents a 20% hit chance reduction per point of jammer advantage. At 5+ advantage, the hit chance drops to zero -- the target cannot be hit by beam weapons.[^ecm-formula]

[^ecm-formula]: ECM/ECCM 20% per level formula verified via Aurora Wiki (ECM, ECCM articles) and Naval Gazing tutorials.
