...
This represents a 20% hit chance reduction per point of jammer advantage. At 5+ advantage, the hit chance drops to zero -- the target cannot be hit by beam weapons.\hyperlink{ref-12.5-2}{[2]}
...
\hypertarget{ref-12.5-2}{[2]}. Aurora Wiki (ECM, ECCM articles) and Naval Gazing tutorials -- ECM/ECCM formula: 20% effect reduction per point of jammer advantage over ECCM. At 5+ advantage, complete denial (zero hit chance or zero detection range). Applied identically to all three jammer types.
