...
- **Ordnance Transfer System:** Colliers must be equipped with an Ordnance Transfer System (10 [HS](../appendices/B-glossary.md#hs) / 500-ton ship component, 20-200 [BP](../appendices/B-glossary.md#bp) depending on tech level) \hyperlink{ref-14.3-1}{[1]} to transfer ordnance to other ships in space. Without this system, transfers can only occur at stationary facilities (see Ordnance Transfer Infrastructure below). Only one Ordnance Transfer System can be added per ship.
- **Transfer Rate:** The rate is governed by the Ordnance Transfer System technology level, ranging from 40 [MSP](../appendices/B-glossary.md#msp) per hour (baseline) to 400 MSP per hour (tech level 11), across 11 tech levels \hyperlink{ref-14.3-2}{[2]}. Ship-mounted systems can only service one vessel at a time
...
All stationary facilities (Spaceports, Transfer Stations) use the highest available tech level and can service unlimited ships simultaneously *(unverified — #1231)*, provided those ships remain stationary.
...
- **Recreational Locations**: Ships with recreational modules, or populations of at least 50,000 people \hyperlink{ref-14.3-7}{[7]}. Recreational modules appear to benefit only the ship carrying the module, not other ships in the same fleet or location *(unverified — [#1369](https://github.com/ErikEvenson/aurora-manual/issues/1369))*
