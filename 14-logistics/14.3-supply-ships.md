...
- **Ordnance Transfer System:** Colliers must be equipped with an Ordnance Transfer System (500-ton ship component) to transfer ordnance to other ships in space. Without this system, transfers can only occur at stationary facilities (see Section 14.3.3)
