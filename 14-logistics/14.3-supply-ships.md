...
- **Parasites in Hangars**: Clock reduction = Time Passed x 10 x (1 - Mothership Deployment Modifier) *(unverified — #837, requires live testing -- formula from AuroraWiki)*
- **Mothership Modifier** = Mothership Deployment Clock / Mothership Class Intended Deployment Time *(unverified — #837, requires live testing -- formula from AuroraWiki)*
...
- Failure chance per construction phase = Overcrowding Modifier x 100 x (Increment Length / Year Length) *(unverified — #837, requires live testing -- formula from AuroraWiki)*
