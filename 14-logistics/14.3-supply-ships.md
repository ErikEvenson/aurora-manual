...
- **Parasites in Hangars**: Clock reduction = Time Passed x 10 x (1 - Mothership Deployment Modifier) *(unverified — #755, requires live testing)*
- **Mothership Modifier** = Mothership Deployment Clock / Mothership Class Intended Deployment Time *(unverified — #755, requires live testing)*
...
- Failure chance per construction phase = Overcrowding Modifier x 100 x (Increment Length / Year Length) *(unverified — #755, requires live testing)*
