...
### 14.3.4.1 Cargo Handling Modifier
...
Combination orders allow resupply to occur simultaneously with other logistics actions (see [Section 9.5.3.3 Combination Orders](../9-fleet-management/9.5-orders.md#9533-combination-orders)), such as "Refuel, Resupply, Load Ordnance from Colony" which performs all three in parallel.
