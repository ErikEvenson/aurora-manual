...
- **Conversion Rate:** Each refinery converts a fixed amount of Sorium into fuel per year. The base rate is 40,000 litres of fuel per refinery per year at the starting technology level \hyperlink{ref-1}{[1]}
- **Technology Improvement:** Researching fuel production technology increases the output per refinery across 11 tech levels, from 48,000 up to 280,000 litres/year \hyperlink{ref-1}{[1]}
...
- **Base Harvesting Rate:** Each harvester module produces fuel based on a base mining rate of 10, which corresponds to approximately 20,000 litres of fuel per year at the starting technology level *(exact conversion needs verification)*. Higher technology levels increase this rate proportionally
...
- **Refueling System Component:** A harvester ship must be equipped with a Refueling System component (2,000-ton / 40 HS ship component) to transfer fuel to other vessels \hyperlink{ref-1}{[1]}. Without this component, the harvester can accumulate fuel but cannot distribute it
...
**Fuel Storage Module Costs:** \hyperlink{ref-1}{[1]}

| Module Size | Capacity | Cost (BP) |
|-------------|----------|-----------|
| Tiny | 5,000 litres | 0.3 |
| Small | 10,000 litres | 0.5 |
...
\hypertarget{ref-1}{1}. Aurora C# game database (AuroraDB.db v2.7.1) — FCT_TechSystem, FCT_ShipDesignComponents, DIM_PlanetaryInstallation tables
