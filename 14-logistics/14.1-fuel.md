...
- **Matching Speed:** Ships with higher maximum speed consume less fuel when traveling at a slower ship's pace, since they are operating below their maximum *(unverified — [#1214](https://github.com/ErikEvenson/aurora-manual/issues/1214) -- contradicts Appendix A formula which shows no speed dependence)*
...
- Range is calculated at maximum speed; traveling slower extends effective range *(unverified — [#1214](https://github.com/ErikEvenson/aurora-manual/issues/1214))*
