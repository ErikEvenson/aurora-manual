...
![](../images/art/section-art/14.1.png)
...
All ship fuel in Aurora is refined from Sorium, one of the eleven [trans-newtonian (TN)](../appendices/B-glossary.md#tn) minerals. Converting raw Sorium into usable fuel requires dedicated refinery installations on your colonies.
...
- **Build Cost:** Refineries cost 120 [BP](../appendices/B-glossary.md#bp) (Build Points) and require 120 Boronide per installation \hyperlink{ref-14.1-2}{[2]}
...
- **Refueling System Component:** A harvester ship must be equipped with a Refueling System component (2,000-ton / 40 [HS](../appendices/B-glossary.md#hs) ship component) to transfer fuel to other vessels \hyperlink{ref-14.1-1}{[1]}. Without this component, the harvester can accumulate fuel but cannot distribute it
...
![Sorium Harvester Automation Cycle](../images/diagrams/14-logistics/14.1-harvester-automation-cycle.png)
...
Fuel consumption in Aurora C# is determined by the engine design:
...
- **Speed Relationship:** Fuel consumption increases with the square of speed *(unverified — [#1214](https://github.com/ErikEvenson/aurora-manual/issues/1214), #1257 -- the Appendix A formula has no speed variable; this may describe the design-time power modifier relationship rather than a runtime speed-dependent mechanic)*. A ship traveling at twice its cruise speed burns four times as much fuel (see [Appendix A: Formulas -- Fuel Consumption Rate](../appendices/A-formulas.md))
...
- **Matching Speed:** Ships with higher maximum speed consume less fuel when traveling at a slower ship's pace, since they are operating below their maximum *(unverified — [#1214](https://github.com/ErikEvenson/aurora-manual/issues/1214), #1257 -- contradicts Appendix A formula which shows no speed dependence)*
...
- Range is calculated at maximum speed; traveling slower extends effective range *(unverified — [#1214](https://github.com/ErikEvenson/aurora-manual/issues/1214), #1257)*
...
- The fastest possible engine is rarely the most practical choice for most ships due to the exponential fuel cost of higher power modifiers at design time (see [Section 8.3.5 Fuel Consumption](../8-ship-design/8.3-engines.md))
