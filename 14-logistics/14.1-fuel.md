...
Sorium is found through geological surveys on planets, moons, asteroids, and comets:
...
- **Conversion Rate:** Each refinery converts a fixed amount of Sorium into fuel per year. The base rate is 5,000 litres of fuel per refinery per year at the starting technology level
- **Technology Improvement:** Researching fuel production technology increases the output per refinery, with each tech level doubling the previous output
...
Research in engine technology affects fuel efficiency:
...
- **Design Trade-offs:** A ship designer must balance speed, fuel efficiency, and engine size. Maximum speed engines burn fuel rapidly; high-efficiency engines are slower but can operate for longer
