...
- **Normal Maintenance**: Ships require MSP equal to Class Cost / 4, adjusted by EMR percentage *(unverified — #751, requires live testing -- hardcoded game logic)*
- **Overhaul**: Ships require MSP equal to Class Cost, adjusted by EMR percentage *(unverified — #751, requires live testing -- hardcoded game logic)*
...
MSP production consumes three minerals *(unverified — #751, requires live testing -- hardcoded game logic, not present in database)*:
