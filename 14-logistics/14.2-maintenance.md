...
- **MSP Production Rates**: Base production of 20 MSP/year per facility (starting tech), upgradeable across 10 tech levels to a maximum of 100 MSP/year (research costs from 3,000 RP to 1,200,000 RP)

### Maintenance Modules

Maintenance modules are ship-mounted components that provide mobile maintenance capacity. As of v2.0.0, maintenance modules cost **100 Build Points** (reduced from 200 BP). This cost reduction makes ship-based maintenance infrastructure more accessible for forward-deployed fleet support.
...
- **Base Production Rate:** 20 MSP per facility per year at starting technology
- **Technology Progression:** MSP production rate is upgradeable across 10 tech levels, from 20 MSP/year to 100 MSP/year per facility (research costs range from 3,000 RP to 1,200,000 RP)
