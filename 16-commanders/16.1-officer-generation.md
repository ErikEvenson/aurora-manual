...
When you start a new game, your empire begins with a pool of officers already available. The initial officer corps is generated during race setup using a ratio-based promotion system before gameplay begins, distinct from the on-demand promotion system used during the game.
...
The primary mechanism for generating new officers is the Naval Academy (also called Officer Training Facility). These are ground installations that produce new officers over time. Each academy produces ten officers per year.
...
The Academy Commandant at each colony with one or more military academies is displayed in the Economics window on the Governor tab, beneath the planetary governor information. This allows players to easily identify and monitor military academy leadership across their colonies.
...
**Rank +1 Requirements:**
- Ships over 1000 tons with weapons, survey sensors, jump drives, or hangar decks
