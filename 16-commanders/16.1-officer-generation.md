...
Without a commandant influencing the academy, new officers are generated with the following type distribution \hyperlink{ref-1}{[1]}:
...
**Commandant Eligibility \hyperlink{ref-1}{[1]}:**
...
When a commandant is assigned, the academy first checks whether the new officer matches the commandant's type before applying the base distribution \hyperlink{ref-1}{[1]}:
...
When a commandant possesses percentage-based bonuses at 20% or higher, or crew/ground training ratings of 150+, newly graduated commanders receive two rolls for each qualifying bonus and use the superior result \hyperlink{ref-1}{[1]}. This allows specializing academies across different colonies to cultivate tailored officer corps for specific military roles.

When a scientist serves as commandant, there is a 25% chance any scientist generated from that academy will have the same research specialization as the commandant \hyperlink{ref-1}{[1]}.
...
**Rank +1 Requirements \hyperlink{ref-2}{[2]}:**

- Ships with geological/gravitational survey sensors, auxiliary control, science department, or jump drive

**Rank +2 Requirements \hyperlink{ref-2}{[2]}:**

- Ships with weapons, military hangar bays, main engineering, CIC, or flag bridge

**Exception:** Ships of 1000 tons or less default to the lowest rank requirement unless they contain control station components (Auxiliary Control, Science Department, Main Engineering, CIC) \hyperlink{ref-2}{[2]}.
...
Ships can carry multiple officers in addition to the commander, with tiered rank requirements \hyperlink{ref-2}{[2]}:
...
In addition to real-world cultural naming themes, the following science-fiction themed commander name options are available (primarily useful for NPRs) \hyperlink{ref-3}{[3]}:
...
v2.4.0 also includes 80+ naming themes for ships, systems, and other entities across diverse categories:
...
Eight additional rank structures are available for NPR customization, themed around science-fiction species \hyperlink{ref-3}{[3]}:
...
**Minimum Retirement Times by Career \hyperlink{ref-4}{[4]}:**
...
For example, if Lieutenant Commander is the lowest naval rank, minimum retirement would be 10 years after career start for a Lieutenant Commander, 15 years for a Commander, 20 years for a Captain, and so on \hyperlink{ref-4}{[4]}.

**Retirement Probability \hyperlink{ref-4}{[4]}:**
...
A commander can be flagged as a "Story Character," which provides special protections \hyperlink{ref-3}{[3]}:
...
\hypertarget{ref-1}{[1]} Steve Walmsley, "C# Aurora Changes List v1.00," Aurora 4x Forums, [aurora2.pentarch.org](https://aurora2.pentarch.org/index.php?topic=8495.45) (Academy commandants, officer type distribution, quality bonuses)

\hypertarget{ref-2}{[2]} Steve Walmsley, "C# Aurora Changes List v1.00," Aurora 4x Forums, [aurora2.pentarch.org](https://aurora2.pentarch.org/index.php?topic=8495.30) (Ship commander rank requirements, officer positions)

\hypertarget{ref-3}{[3]} Aurora C# Game Database (AuroraDB.db), Tables: DIM_CommanderNameTheme, DIM_RankThemeTypes, FCT_Commander (Commander name themes, rank structures, story character flags)

\hypertarget{ref-4}{[4]} "Scientists & Officers," Aurora 4x Forums, [aurora2.pentarch.org](https://aurora2.pentarch.org/index.php?topic=11358.0) (Retirement mechanics, minimum service times)
