...
The primary mechanism for generating new officers is the Naval Academy (also called Officer Training Facility). These are ground installations (see [Section 6 Economy and Industry](../6-economy-and-industry/6.2-installations.md)) that produce new officers over time. Each academy produces ten officers per year.
...
The Academy Commandant at each colony (see [Section 5 Colonies](../5-colonies/5.1-colonization.md)) with one or more military academies is displayed in the Economics window on the Governor tab, beneath the planetary governor information. This allows players to easily identify and monitor military academy leadership across their colonies.
...
**Rank +1 Requirements:**
- Ships over 1000 tons with weapons, survey sensors, jump drives, or hangar decks (see [Section 8 Ship Design](../8-ship-design/8.1-design-overview.md))
...
- **Combat**: Officers aboard ships that are destroyed in battle (see [Section 12 Combat](../12-combat/12.1-combat-overview.md)) may be killed. The chance of death depends on the severity of the damage and whether the crew managed to evacuate. Ship commanders face the highest risk.
...
- **Ground Combat**: Officers commanding ground forces (see [Section 13 Ground Forces](../13-ground-forces/13.1-ground-unit-design.md)) that are overrun may be killed or captured.
...
- [Section 5 Colonies](../5-colonies/5.1-colonization.md) -- Colony governors and academy placement on populated worlds
- [Section 8 Ship Design](../8-ship-design/8.1-design-overview.md) -- Ship rank requirements and command module components
- [Section 9 Fleet Management](../9-fleet-management/9.1-fleet-organization.md) -- Fleet command hierarchy and officer assignments
- [Section 12 Combat](../12-combat/12.1-combat-overview.md) -- Officer death risks during combat operations
- [Section 13 Ground Forces](../13-ground-forces/13.1-ground-unit-design.md) -- Ground force officer assignments and combat risks
