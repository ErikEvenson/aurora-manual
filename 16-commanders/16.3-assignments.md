...
Seven command and control modules (see [Section 8.1 Design Philosophy](../8-ship-design/8.1-design-philosophy.md)) establish a ship's Control Rating (each module adds +1 to the rating):
...
When multiple ships operate together in a task group (see [Section 9.1 Shipyards](../9-fleet-management/9.1-shipyards.md)), a Task Group Commander provides fleet-level coordination. The task group commander is automatically the senior officer among all ship commanders in the group, or can be specifically assigned as a flag officer aboard a designated flagship.
...
### Admin Command Auto-Assignment and Required Bonuses
...
A subordinate command's officer can never hold the same rank or higher than the parent command's officer. The sole exception is Fleet Admirals, who can report to other Fleet Admirals. When promotions create rank violations, the command structure displays red highlighting to alert the player that the hierarchy needs restructuring.
...
- **Fuel Consumption:** Ships consume fuel as if running engines at 10% power during training exercises. Extended training periods can deplete fuel reserves significantly -- ensure adequate fuel stockpiles or refueling capability.
...
- **Accelerated Maintenance:** The maintenance clock increases at 2x the normal rate during training. Ships in training wear out faster and require more frequent maintenance facility visits. Factor this into your maintenance scheduling.
...
### Automated Governor Assignment

The Governor & Miscellaneous tab on the Economics window provides an automated assignment system that handles governor selection and replacement without manual intervention. *(Added in v2.0.0)*
...
- [Section 9.1 Shipyards](../9-fleet-management/9.1-shipyards.md) -- Task group and fleet commander hierarchy
