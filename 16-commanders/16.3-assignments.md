...
Every ship should have a commanding officer assigned. Ship commanders provide:

- Their personal skill bonuses to all operations aboard their vessel.
- Crew training improvements based on their Crew Training skill.
- Combat bonuses from their weapon and tactics skills.
- Morale effects on the crew based on their leadership qualities.

To assign a ship commander, open the Commanders window, select an unassigned officer of appropriate rank, and assign them to an available ship command. The ship class determines the minimum rank required:

- **Fighters/FACs**: Lieutenant or higher.
- **Frigates/Corvettes**: Commander or higher.
- **Destroyers/Light Cruisers**: Commander or Captain.
- **Heavy Cruisers/Battlecruisers**: Captain or higher.
- **Battleships/Carriers**: Captain or Commodore.
- **Super-capital Ships**: Commodore or higher.
