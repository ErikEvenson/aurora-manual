...
### On-Demand Promotion System (v2.0.0)

v2.0.0 replaces the older ratio-based promotion system with an on-demand promotion system that operates during automated assignment phases rather than as a separate process.
...
> **Warning:** The game does not auto-promote officers unless the automated assignment checkbox is enabled for the relevant position. Promotion is entirely manual by default. Officers without promotions will stagnate and eventually retire.
...
Promotion score accumulates from three primary sources:
...
2. **Active Assignments**: Being assigned to command a ship, fleet, admin command, or ground formation generates promotion score points over time. Officers in active assignments accumulate points steadily each increment. The rate of accumulation means that even officers without combat medals can build competitive scores through sustained service.

3. **Research Completions** (scientists only): Scientists earn promotion score points when they complete research projects. Longer or more expensive projects typically contribute more points upon completion.

**Typical Score Ranges by Rank:**

| Rank | Typical Score Range |
|------|-------------------|
| Lieutenant Commander | 300 -- 400 |
| Commander | 700 -- 900 |
| Captain | ~1,000 |
| Rear Admiral | 1,300 -- 1,800 |
| Vice Admiral | ~2,100 |
| Fleet Admiral | ~3,200+ |

These ranges are approximate and vary based on campaign length, combat frequency, and medal configurations.

**Practical Implications:**

- **Assignment Matters Most**: A Lieutenant Commander who receives their first ship assignment accumulates points rapidly and can quickly surpass a Commander who has remained unassigned. Active service is the most reliable path to a competitive promotion score.
- **Stagnation Risk**: Officers without assignments gain no promotion score from service and may retire before accumulating enough points to be competitive candidates. Assign officers early and often.
