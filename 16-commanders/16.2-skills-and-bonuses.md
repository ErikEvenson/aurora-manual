...
v2.0 replaces the older ratio-based promotion system with an on-demand promotion system that operates during automated assignment phases rather than as a separate process.
