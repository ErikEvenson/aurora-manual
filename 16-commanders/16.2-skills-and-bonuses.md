...
> **v2.8.0+:** Commander bonuses for Light Naval vessels (1,000 tons or less) were restructured. The **Fighter Combat** bonus has been removed and replaced by **Light Tactical**. The standard **Tactical** bonus no longer affects Light Naval units. Ships over 1,000 tons receive only half the bonus for: Crew Training, Survey, Engineering, Tactical, Carrier Operations, and Ground Support. See [Section 9.6.5 Commander Bonuses](../9-fleet-management/9.6-light-naval-operations.md) for full details.
...
- **Electronic Warfare**: Improves [ECM](../appendices/B-glossary.md#ecm) effectiveness and reduces the impact of enemy ECM on ships under this commander.
...
When commanders are generated, their bonuses are determined randomly according to probability bands. The following chart and table show the chance each bonus type is generated for new officers *(unverified — #1259)*:

![Skill Bonus Generation Probability](../images/charts/16-commanders/16.2.2-skill-bonus-generation.png)

> **v2.8.0+:** Light Tactical replaces the Fighter Combat bonus. Tactical no longer affects Light Naval units.

| Bonus Type | Abbrev | Branch | Generation Chance | Notes |
|-----------|--------|--------|-------------------|-------|
| Crew Training | CTR | Naval | 80% | Concentrated in 5% and 10% bands |
| Survey | SRV | Naval/Ground | 40% | Available to both branches |
| Carrier Operations | CVOP | Naval | 20% | Critical for carrier/fighter wing commanders |
| Reaction | REAC | Naval | 20% | Affects initiative in combat |
| Tactical | TAC | Naval | 20% | All bands increased equally; does NOT affect Light Naval units (v2.8.0+) |
| Light Tactical (v2.8.0+) | -- | Naval | 40% | Same chance as Survey; affects only <=1,000t ships; replaces Fighter Combat |
| Engineering | ENG | Naval | 20% | All bands increased equally |
| Fleet Training | FTR | Naval | 20% | Affects fleet-wide crew training from admin commands \hyperlink{ref-16.2-3}{[3]} |
| Ground Support | GSP | Naval | 20% | Affects orbital bombardment accuracy via FFD \hyperlink{ref-16.2-3}{[3]} |
| Communications | COMM | Naval | 20% | Affects alien communication development rate \hyperlink{ref-16.2-3}{[3]} |
| Intelligence | INT | Naval | 20% | Multiplies ELINT intelligence gathering rate \hyperlink{ref-16.2-3}{[3]} |
| Diplomacy | DIP | Naval | 20% | Affects diplomatic interaction speed \hyperlink{ref-16.2-3}{[3]} |
| Logistics (Naval/Civilian) | LOG | Naval/Civilian | 50% | All bands increased proportionally |
| Production/Mining/Terraforming | PROD/MINE/TERA | Naval/Civilian | 20% | Concentrated in lower bands |
| Ground Combat (Offence/Defence) | GCO/GCD | Ground | 50% | Increases limited to 5% and 10% bands |
| Ground Combat (Manoeuvre/Artillery/AA) | GCM/GCA/GCAA | Ground | 20% | Specialized ground combat roles \hyperlink{ref-16.2-3}{[3]} |
| Ground Combat Logistics | GCL | Ground | 20% | Reduces formation supply consumption \hyperlink{ref-16.2-3}{[3]} |
| Ground Combat Occupation | OCC | Ground | 20% | Reduces required garrison strength \hyperlink{ref-16.2-3}{[3]} |
| Decontamination | DEC | Ground | 20% | Affects radiation/contamination cleanup operations \hyperlink{ref-16.2-3}{[3]} |
| Xenoarchaeology | XEN | Ground | 20% | Exclusive to ground officers; affects ruin excavation \hyperlink{ref-16.2-3}{[3]} |
| Political | POL | All | Variable | Chance of exceeding 10% significantly reduced |
...
> Morale Modifier = (Current Crew / Class Crew) x 2 *(unverified — #1259)*
...
- Recreational locations include ships with recreational modules or populations exceeding 50,000 \hyperlink{ref-16.2-5}{[5]}. Note: recreational modules appear to benefit only the ship carrying the module, not other ships in the same fleet *(unverified — [#1369](https://github.com/ErikEvenson/aurora-manual/issues/1369))*
