...
- **Bonus Range:** 10% to 100% bonus in a single research area *(unverified)*
- **Population Requirement:** The colony hosting the construct must have at least 1 million population *(unverified)*
- **Local Bonus:** The full construct bonus applies to labs at the colony where the construct is located *(unverified)*
- **Empire-Wide Bonus:** 10% of the construct's bonus applies to all labs empire-wide researching in that field *(unverified)*
