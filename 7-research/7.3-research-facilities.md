...
- They require 1,200 Duranium and 1,200 Mercassium to construct.
...
Research projects can be flagged with "Assign New" to automatically receive newly constructed research facilities. When new labs are built at a colony, they are distributed to flagged projects in priority order. This eliminates the micromanagement of manually reassigning labs each time new facilities come online, particularly useful during periods of rapid infrastructure expansion.
...
- **Bonus Range:** 10% to 100% bonus in a single research area
- **Population Requirement:** The colony hosting the construct must have at least 1 million population
- **Local Bonus:** The full construct bonus applies to labs at the colony where the construct is located
- **Empire-Wide Bonus:** 10% of the construct's bonus applies to all labs empire-wide researching in that field

This makes colonies with ancient constructs high-priority sites for research lab construction in the relevant field.

### Ruins and Excavation
...
- Each disassembled ship component yields 1% to 5% of the RP needed to advance to the next technology level in the relevant field
...
### Current Automatic Research Technologies

This feature currently applies to three types of bay technologies. When the standard version is researched, alternative size variants become available automatically:

| Standard Technology | Automatic Variants |
|---|---|
| Troop Transport Bay | Large, Small, and Very Small Troop Transport Bays |
| Drop Bay | Large, Small, and Very Small Drop Bays |
| Boarding Bay | Large, Small, and Very Small Boarding Bays |
...
- [7.2 Scientists](7.2-scientists.md) -- Scientists who direct research in facilities
- [7.1 Technology Tree](7.1-technology-tree.md) -- Technologies researched in these facilities
- [6.3 Construction](../6-economy-and-industry/6.3-construction.md) -- Building research labs via construction factories
- [5.2 Colony Management](../5-colonies/5.2-colony-management.md) -- Managing population and installations on colonies
