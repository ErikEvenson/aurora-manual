...
Each research lab generates **100 RP per lab per year** at the starting technology level. This output is improved through the "Research Rate" technology in the **Construction and Production** research category.

**Technology Improvements -- Research Rate:**

The "Research Rate" technology line in the Construction and Production category increases the RP output of each lab. This should be one of the FIRST technologies researched after Trans-Newtonian Technology itself, because it provides compound benefits to all subsequent research.

Research Rate progression: *(v2.6.0)*

| Tech Level | RP per Lab per Year | Cumulative Benefit |
|-----------|--------------------|--------------------|
| Base | 100 | -- |
| Level 1 | 120 | +20% |
| Level 2 | 144 | +44% |
...
- Each level in this technology raises the per-lab RP output by approximately 20%.
...
| Titanium | Missiles and ordnance |
