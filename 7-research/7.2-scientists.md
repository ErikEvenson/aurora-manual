...
When a scientist researches a technology in their specialty field, their research bonus is **quadrupled**.[^1] This is not merely a preference -- it represents a substantial productivity difference.

[^1]: Quadruple bonus mechanic verified via Aurora Wiki (aurorawiki.pentarch.org) and community sources.

- **Primary field:** Bonus is quadrupled (e.g., a 20% bonus becomes effectively 80%, giving a 1.8x multiplier)
- **Secondary field (if the scientist has one):** Standard bonus applies (1.2x for a 20% bonus scientist)
...
[^2]: Example calculation verified against Aurora Wiki research mechanics documentation.
