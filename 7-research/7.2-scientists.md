...
> **Note:** Naval academies also produce officers and crew (not scientists). For academy training quality settings and crew output rates, see [Section 16.1 Officer Generation](../16-commanders/16.1-officer-generation.md).
