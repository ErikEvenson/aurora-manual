...
The administration rating determines the **maximum number of labs** a scientist can be assigned. This is a hard cap enforced by the game UI — you cannot assign more labs than the scientist's admin rating (displayed as "Max Labs" in the research window). \hyperlink{ref-7.2-6}{[6]}

- Labs 1 through Admin Rating: Full RP output
- Labs beyond Admin Rating: Not possible (the game prevents overallocation)
...
\hypertarget{ref-7.2-6}{[6]} In-game testing (Aurora C# v2.7.1) — Admin rating is a hard cap on lab assignment. The game UI displays "Max Labs" and prevents assigning more labs than this value. Confirmed February 2026.
