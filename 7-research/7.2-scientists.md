...
The bonus only applies when the scientist is researching a technology in their specialty field. Assigning a Power and Propulsion specialist to an Energy Weapons project provides no bonus from their specialization.

- Primary field: Full bonus applies (the on-specialization bonus is effectively quadrupled compared to the off-specialization rate)
- Secondary field (if the scientist has one): Reduced bonus applies
- Unrelated field: No specialization bonus (base output only)
