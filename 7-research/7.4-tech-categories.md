...
**Terraforming Rate:**
Increases the rate at which terraforming installations modify a planet's atmosphere. Higher levels mean faster terraforming, which is critical for making hostile worlds habitable. Each level roughly doubles the rate of atmospheric change.
...
Improves ground force effectiveness:
...
Unlocks the ability to build jump drives for ships:
...
Like missiles, sensors in Aurora are custom-designed:
