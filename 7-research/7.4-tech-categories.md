...
Jump Point Theory is the gateway technology for all jump drive capability. It must be researched before any jump engine can be designed, and it unlocks three sub-technologies that ALL must be completed before a jump drive becomes available in the Ship Designer:

| Technology | Effect | Starting Value |
|-----------|--------|---------------|
| Base Jump Drive Efficiency | Determines maximum ship tonnage that can jump; higher levels permit larger ships | Smallest ships only |
| Max Jump Squadron Size | Number of ships that can transit together (jump ship + N others) | 2 (jump ship + 2 others) |
| Jump Squadron Radius | How spread out ships arrive at the destination jump point | 25,000 km base; first research doubles to 50,000 km |
