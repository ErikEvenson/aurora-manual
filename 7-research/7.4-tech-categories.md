...
**Terraforming Rate:**
Increases the rate at which terraforming installations (see [Section 5.3 Terraforming](../5-colonies/5.3-terraforming.md)) modify a planet's atmosphere. Higher levels mean faster terraforming, which is critical for making hostile worlds habitable. Each level roughly doubles the rate of atmospheric change.
...
Improves ground force effectiveness (see [Section 13.1 Ground Unit Design](../13-ground-forces/13.1-ground-unit-design.md)):
...
Unlocks the ability to build jump drives for ships (see [Section 10.3 Jump Points](../10-navigation/10.3-jump-points.md)):
...
Like missiles, sensors in Aurora are custom-designed (see [Section 8.4 Sensors](../8-ship-design/8.4-sensors.md) and [Section 11.1 Sensor Types](../11-sensors-and-detection/11.1-sensor-types.md)):
...
- [7.1 Technology Tree](7.1-technology-tree.md) -- Prerequisite chains and cost scaling
- [8.5 Weapons](../8-ship-design/8.5-weapons.md) -- Ship components unlocked by weapon research
- [8.3 Engines](../8-ship-design/8.3-engines.md) -- Engine components unlocked by Power and Propulsion research
- [8.4 Sensors](../8-ship-design/8.4-sensors.md) -- Sensor components unlocked by Sensors and Fire Control research
- [12.1 Combat Mechanics](../12-combat/12.1-combat-mechanics.md) -- How weapon and defensive technologies interact in combat
- [13.1 Ground Unit Design](../13-ground-forces/13.1-ground-unit-design.md) -- Ground combat technology applications
