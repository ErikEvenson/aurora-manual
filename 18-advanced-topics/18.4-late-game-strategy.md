...
Formal alliances (diplomatic points above +75; see [Section 15.1.5 Diplomatic Points](../15-diplomacy/15.1-alien-races.md)) provide significant benefits but carry obligations:

- **Allied status** generates 200 diplomatic points per year passively
...
- **Naval Commands** provide 25% of the commander's Crew Training, Reaction, Engineering, and Tactical bonuses to subordinate fleets
...
- **Conventional mines** produce more per unit but require population to operate (one mine per 10,000 workers assigned to mining duty)
...
NPR technology scales with game time using the formula: Tech Years = Game Years + 20, Research Points = Labs x Tech Years x 300 (see [Section 15.1.2 NPR Behavior](../15-diplomacy/15.1-alien-races.md)). This means:
