...
NPR technology scales with game time using the formula: Tech Years = Game Years + 20, Research Points = Labs x Tech Years x 300 *(unverified — #745 -- NPR generation formulas are internal code behavior)* (see [Section 15.1.2 NPR Behavior](../15-diplomacy/15.1-alien-races.md)). This means:
