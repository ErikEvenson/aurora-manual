...
![](../images/art/section-art/18.4.png)
...
| Missile Speed | Top 3 tiers | Critical for late-game anti-ship effectiveness (note: Missile Agility was removed in v2.2.0; hit chance is now based on speed ratio — see [Section 18.1.3.3](../18-advanced-topics/18.1-game-mechanics.md#18133-missile-hit-resolution)) |
...
NPR technology scales with game time using the formula: Tech Years = Game Years + 20, Research Points = Labs x Tech Years x 300 *(unverified — [#837](https://github.com/ErikEvenson/aurora-manual/issues/837) -- requires live testing)* (see [Section 15.1.2 NPR Behavior](../15-diplomacy/15.1-alien-races.md)). This means:
...
- Delete stray missile salvos via the Missile Salvos tab (see [Section 9.4.13 Missile Salvos Tab](../9-fleet-management/9.4-fleet-organization.md))
