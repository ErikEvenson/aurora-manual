...
\hypertarget{ref-18.2-1}{[1]}. Aurora C# standard 5-second combat sub-pulse -- AuroraWiki, "Combat Overview" (aurorawiki.pentarch.org)

\hypertarget{ref-18.2-2}{[2]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_Game: OneSecondSubPulse field (default=1, enabled) confirms 1-second sub-pulse support. Version attribution to v2.0.0 is *(unverified -- changelog not publicly accessible)*.
