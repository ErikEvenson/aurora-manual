...
\hypertarget{ref-18.2-2}{[2]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_Game: OneSecondSubPulse field (INTEGER, default=1, enabled) confirms 1-second sub-pulse support. Version attribution to v2.0.0 is *(unverified — #738 -- requires live testing to confirm version attribution)*.
