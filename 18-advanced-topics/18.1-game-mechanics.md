...
- The code makes 20 attempts to find a new system before accepting a link to an existing system *(unverified — #734 -- internal code behavior not publicly documented)*
- Any newly generated system created via the final unlinked jump point must contain a minimum of two jump points *(unverified — #734 -- internal code behavior not publicly documented)*
...
- Hit chance is reduced to 33% of normal *(unverified — #734)*
...
- Hit chance is 50% of normal (higher than Search and Destroy since targets are pre-identified) *(unverified — #734)*
