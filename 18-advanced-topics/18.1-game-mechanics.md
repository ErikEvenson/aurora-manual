...
- At maximum range, roughly 50% of shots hit for most beam weapons *(unverified -- #1257 -- this contradicts the Base_Hit_Chance formula in [Section 18.1.3.2](#18132-beam-weapon-to-hit-calculation), which gives 0% at max range: (Max_Range - Max_Range) / Max_Range = 0)* \hyperlink{ref-18.1-1}{[1]}
