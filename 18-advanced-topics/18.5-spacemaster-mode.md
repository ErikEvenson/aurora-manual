...
New systems are generated automatically when ships transit unexplored jump points. SpaceMaster mode provides visibility into all systems regardless of exploration status, but C# Aurora does not include tools for manually creating new star systems. *(This differs from VB6 Aurora, which had "Create System" functionality.)*
