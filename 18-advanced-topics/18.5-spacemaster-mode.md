...
**SpaceMaster Empire Start:**

SpaceMaster mode is also used for an alternative game start called "SpaceMaster Empire." Instead of beginning in Sol, you select SpaceMaster Empire from the Starting Race dropdown during game creation. The game starts with no pre-built empire, and you use SM tools to generate a random system and create your civilization from scratch. See [Section 2.5.3.2 SpaceMaster Empire Start](../2-game-setup/2.5-starting-conditions.md#2532-spacemaster-empire-start-random-system) for setup instructions.

> **Note:** SpaceMaster Empire generates random procedural systems — you cannot select a specific real star (like Alpha Centauri) as your starting location.
...
| Custom Start | Create a non-Sol starting system via SpaceMaster Empire |
...
- Systems are always randomly generated — you cannot select a specific real star (like Alpha Centauri) from the Known Stars database
