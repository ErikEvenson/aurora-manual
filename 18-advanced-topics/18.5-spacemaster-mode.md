...
- The Instant Organisation feature for ground forces consumes build points when used in SM mode as of v2.3.1 *(unverified — #749 -- requires live testing)* (see [Section 13.1 Unit Types](../13-ground-forces/13.1-unit-types.md))
...
- Restore deceased or retired officers to active duty (SM Mode Only; see [Section 16.1 Officer Generation](../16-commanders/16.1-officer-generation.md)) *(unverified — #749 -- requires live testing)*
