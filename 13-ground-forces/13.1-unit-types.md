...
- **Boarding Combat:** Required for ship boarding operations; provides two distinct bonuses: (1) doubles the transfer success probability during the boarding attempt phase, and (2) doubles the to-hit chance during internal combat rounds once aboard the target vessel
...
### Building a Battalion Hierarchy (Worked Example)
...
### Security Company Garrison Workflow
...
### How Garrison Forces Reduce Unrest
...
- **Element Occupation Strength:** (Square Root of Size x Units x Morale) / 10,000 per element
- When total occupation strength exceeds the population's required threshold, the surplus acts as **police strength**
- Police strength above the threshold actively **reduces unrest over time** at a rate of 100 x Police Modifier points per year
- The Police Modifier = Police Strength / Effective Population Size
...
### Required Garrison Strength Formula
...
- **Forum screenshots:**
  - [Ground Forces Interface](http://www.pentarch.org/steve/Screenshots/Ground010.PNG)
  - [Ground Rules](http://www.pentarch.org/steve/Screenshots/GroundRules004.PNG)
  - [Elements](http://www.pentarch.org/steve/Screenshots/Elements001.PNG)
  - [Dominant Terrain](http://www.pentarch.org/steve/Screenshots/DominantTerrain.PNG)
...
- [Section 15.5 Espionage](../15-diplomacy/15.5-espionage.md) -- Intelligence agents drawn from ground force officers; counter-intelligence role
