...
- **Maximum Fortification:** Highest defensive level achievable with construction support. Divides incoming accuracy by this value. *(unverified — #1229 -- exact interaction between THM and fortification level requires verification)*
...
- **[CIWS](../appendices/B-glossary.md#ciws) Capability:** Designates Close-In Weapon System components for planetary missile defense
...
- **Forward Fire Direction (FFD):** Enables coordination of support unit fire and orbital bombardment *(v2.8.0+: ground support fighters removed)*
...
| Armor Tier | Research Cost (RP) | Prereq 1: Armor Chain (v2.4.0+) | Prereq 2: Vehicle Base (v2.4.0+) |
|-----------|-------------------|----------------------------------|-----------------------------------|
| Heavy Armor | 2,500 | Medium Vehicle Armour | Heavy Vehicle type |
| Super-Heavy Armor | 5,000 | Heavy Vehicle Armour | Super-Heavy Vehicle type |
| Ultra-Heavy Armor | 10,000 | Super-Heavy Vehicle Armour | Ultra-Heavy Vehicle type |

\hyperlink{ref-13.1-8}{[8]}

As of v2.4.0, each vehicle armor tier has two prerequisites: the previous armor in the chain and the corresponding vehicle base type. For example, Heavy Vehicle Armour requires both Medium Vehicle Armour and the Heavy Vehicle base type. You must have researched both prerequisites before you can research the next armor tier.
...
- Construction cost in [Build Points (BP)](../appendices/B-glossary.md#bp) incorporates size, armor selection, component choices, and selected capabilities.
...
- Each FFD component enables 1 orbital bombardment support ship \hyperlink{ref-13.1-17}{[17]}
- Without FFD, formations cannot receive orbital fire support
- If a formation loses FFD capability during combat, assigned support ships automatically seek alternative formations

> **v2.8.0+:** Ground support fighters have been removed from the game. FFD components previously also permitted support from up to 6 ground support fighters per component; this functionality is no longer available.

### 13.1.4.3 Artillery / Bombardment Elements

Artillery provides indirect fire support from the Support field position:

- Fires simultaneously with orbital bombardment
...
> **v2.8.0+:** Ground support fighters have been removed. Prior versions had artillery firing simultaneously with both ground support fighters and orbital bombardment.
...
> **v2.8.0+:** Ground support fighters have been removed from the game. AA elements no longer have an anti-aircraft role in ground combat; they function only as ground combat units with their standard combat values.

AA elements were designed to defend against ground support fighters:
...
- Tracking speed and [ECCM](../appendices/B-glossary.md#eccm) (Electronic Counter-Countermeasures) can be updated when formation templates are copied/updated
...
\hypertarget{ref-13.1-8}{[8]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT_TechSystem. Confirmed: Heavy Vehicle Armour (65783) = 2,500 RP with prerequisites Medium Vehicle Armour (65782) and Heavy Vehicle base type (65818); Super-Heavy Vehicle Armour (65784) = 5,000 RP with prerequisites Heavy Vehicle Armour (65783) and Super-Heavy Vehicle base type (65819); Ultra-Heavy Vehicle Armour (65785) = 10,000 RP with prerequisites Super-Heavy Vehicle Armour (65784) and Ultra-Heavy Vehicle base type (65820).
