...
**Important:** Ground forces will not engage enemy forces unless the owning race is set as hostile in the diplomacy settings. Without this setting, forces from different powers can coexist on the same body without fighting. Before landing troops on an enemy colony, verify the target race is marked hostile in the Diplomacy window, or your forces will simply sit alongside the enemy without combat.
...
Ships using energy weapons for NBG have one-third of the chance to hit compared to using Orbital Bombardment Support (Section 13.3.8) and cannot benefit from ground support bonuses.
...
- **Defender fortification bonus:** Defenders receive a fortification value believed to be **level 2 or 3** (exact value needs verification), representing dug-in positions in corridors, choke points, and makeshift barricades. This gives defenders a significant accuracy reduction against incoming fire without needing time to fortify.
...
- **Reparations:** The conquered colony yields wealth and resources as spoils of war, providing an immediate economic benefit to the conquering empire.
- **Captured Technology:** Research facilities on the conquered world may yield alien technology components that can be reverse-engineered, potentially unlocking tech advances your empire has not yet discovered.
- **Population Absorption:** The conquered population becomes part of your empire as a subject people. They contribute to your labor force and economy, but may suffer from elevated unrest due to the conquest. Managing conquered populations requires attention to stability and potentially garrison forces to maintain order.
...
## 13.3.15 AI Ground Offensives (v2.0.0+)
