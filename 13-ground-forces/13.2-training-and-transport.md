...
- **Combat Effectiveness Threshold:** Since combat effectiveness scales linearly with morale (Strength x Morale/100), troops at 50 morale fight at only 50% effectiveness. Morale cannot drop below 25 under normal circumstances *(unverified — #837 -- morale floor requires live testing)* (see [Section 16.2 Skills and Bonuses](../16-commanders/16.2-skills-and-bonuses.md)).
