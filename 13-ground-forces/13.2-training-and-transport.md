...
- **Morale Decay:** Troops in non-cryogenic drop modules suffer ongoing morale reduction for each day spent loaded
- **Cryogenic Combat Drop Modules:** A research-unlockable variant that places troops in suspended animation, completely eliminating morale loss during transit. Troops emerge at the same morale level they had when loaded.
