...
![](../images/art/section-art/13.2.png)
...
- **Base Build Rate:** 250 [Build Points (BP)](../appendices/B-glossary.md#bp) per year \hyperlink{ref-13.2-4}{[4]}
...
The Ground Support Bonus affects naval officers commanding ships on orbital bombardment support missions:

- **Applicable Missions:** Orbital bombardment support
...
- **Impact:** Modifies the to-hit chance for orbital bombardment support, allowing well-trained officers to significantly improve accuracy

> **v2.8.0+:** Fighter-based ground support, search and destroy, and flak suppression missions have been removed. This bonus now applies only to orbital bombardment support by ships.
...
| Bay Size | Ship Size ([HS](../appendices/B-glossary.md#hs)) | Capacity (tons) | Cost (BP) |
|----------|---------------|-----------------|-----------|
| Very Small | 2 | 100 | 3 |
| Small | 5 | 250 | 6 |
