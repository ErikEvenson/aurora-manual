...
- Consumption: 1 ton of Sorium per 2,000 litres of fuel produced *(unverified — #744 -- conversion rate not stored in database)*
...
- Capacity: 5,000 tons of minerals per year *(unverified — #744 -- mass driver capacity not stored in installation table; the MassDriverValue=1.0 is a multiplier)*
...
- Rate modified by planet size: Earth Surface Area / Planet Surface Area (smaller worlds terraform faster) *(unverified — #744 -- size modifier formula not stored in database)*
...
- Consume 100,000 population upon construction *(unverified — #744 -- gameplay mechanic)*
- Require only 5,000 population as overseers for ongoing operation \hyperlink{ref-5.4-13}{[13]}
- Cause 5 points of unrest instantly when built *(unverified — #744 -- gameplay mechanic)*
...
- **Formula:** Infrastructure produced = 2 x Population (in millions) per year *(unverified — #744 -- civilian production formula not stored in database)*
...
- A general guideline: 1 maintenance facility per 20-30 installations *(unverified — #744 -- community guideline)*
...
Space Stations in C# Aurora are a distinct class of orbital structure defined by their use of **Structural Shell** instead of standard armour. Key characteristics: *(unverified — #744 -- structural shell stats not in installation database)*
