...
- Build Cost: 240 [BP](../appendices/B-glossary.md#bp) (vs 120 BP for conventional mines) \hyperlink{ref-5.4-2}{[2]}
...
> **v2.8.0+:** Fighter Factories are now referred to as **Light Naval Factories**, reflecting the unified Fighter/FAC classification. The tonnage limit has been raised from 500 tons to 1,000 tons. See [Section 9.6 Light Naval Operations](../9-fleet-management/9.6-light-naval-operations.md) for full details.

- Build Light Naval vessels (ships of 1,000 tons or less) that can also be built in Light Naval Shipyards
- Workers: 50,000 per factory \hyperlink{ref-5.4-1}{[1]}
- Base Output: 10 BP/year/factory (upgradeable via research) \hyperlink{ref-5.4-5}{[5]}
- Can produce any Light Naval design in your database without retooling
- Important for carrier-based fleet doctrines and rapid small craft production
...
- See [Section 5.3 Environment](5.3-environment.md) for how modified tolerances affect colony costs
...
- A colony of 10 million on a [CC](../appendices/B-glossary.md#cc) 2.0 world receives approximately 20 infrastructure units per year from civilian production alone
...
**Maintenance Facilities** are also essential for population support -- see the full description under [Military and Defense](#5416-military-and-defense) above.
