...
- The low gravity threshold is the species' minimum gravity tolerance, which is **0.1g for default humans** (Gravity center 1.0g minus GravDev 0.9g) \hyperlink{ref-5.4-18}{[18]}. Bodies below 0.1g are designated as low gravity and require LG-Infrastructure. Bodies at or above 0.1g (including Mercury at 0.38g and Luna at 0.17g) use standard infrastructure.
...
\hypertarget{ref-5.4-18}{[18]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT_Species: Human (SpeciesID 748) has Gravity=1.0 and GravDev=0.9, giving a tolerance range of 0.1g to 1.9g. The species minimum gravity tolerance (0.1g) is the Low Gravity Infrastructure threshold. Cross-reference: ref-5.3-6.
