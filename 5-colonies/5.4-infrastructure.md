...
- Base Output: 20,000 litres of fuel per year (upgradeable via research)
...
- Manufacture missiles, torpedoes, and other expendable ordnance (see [Section 12 Combat](../12-combat/))
- Workers: 50,000 per factory
- Base Output: 10 BP/year/factory (upgradeable via research)
...
- Conventional Factories can be converted to full Financial Centres at a cost of 20 BP, requiring 10 Corbomite and 10 Uridium
...
- Provides ground-based sensor capability for detecting ships and contacts (see [Section 11 Sensors and Detection](../11-sensors-and-detection/))
...
- Train ground combat units (see [Section 13 Ground Forces](../13-ground-forces/)) (infantry, armor, artillery, etc.)
...
- Workers: 250,000 per installation
...
> **Note:** Workers in Forced Labour Camps do not generate wealth. See Section 5.2.4 for detailed strategic analysis of these installations.
...
- Required for bodies below the species' minimum gravity tolerance (designated "(LG)")
- Costs 4 Build Points per unit (twice the cost of standard infrastructure)
...
### Installation Transport Requirements (v2.0+)

Key installations were made more transportable as of v2.0, with cargo hold requirements halved:
...
3. Select how many installations to scrap (fractional quantities are supported as of v2.1, allowing partial installation scrapping)
...
- **Orbital Habitats:** Providing population capacity in orbit (see Section 14.4)
...
- [Section 11 Sensors and Detection](../11-sensors-and-detection/) -- Deep Space Tracking Stations
- [Section 13 Ground Forces](../13-ground-forces/) -- Ground force training facilities
- [Section 14 Logistics](../14-logistics/) -- Maintenance facilities and fleet support
