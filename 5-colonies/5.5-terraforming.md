...
- **Albedo** from surface water provides a minor temperature effect: 0.0015 x Hydro Extent %, to a maximum increase of 0.15 *(unverified -- albedo formula not stored in database)*
