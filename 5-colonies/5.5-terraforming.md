...
- **Anti-Greenhouse Factor** = 1 + (Dust Level / 20,000) + Anti-Greenhouse Gas Pressure, capped at a maximum of 3.0 *(unverified -- formula derived from community observation)*
...
Greenhouse gases (CO2, Methane, NO2, SO2, and Aestusium) increase temperature by trapping heat \hyperlink{ref-5.5-6}{[6]}. Anti-greenhouse gases (Frigusium) reduce temperature. Understanding this formula is critical for planning temperature adjustments through atmospheric manipulation.
