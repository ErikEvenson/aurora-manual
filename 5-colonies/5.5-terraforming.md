...
- Cost: 500 Build Points per module *(unverified -- space-based module is a ship component, not in installation table)*
...
- Smaller worlds terraform significantly faster using the modifier: Earth Surface Area / Planet Surface Area *(unverified -- size modifier formula not stored in database)*
- Mars terraforms approximately 3.5x faster than Earth *(unverified -- derived from surface area ratio)*
- Ganymede terraforms approximately 6x faster than Earth *(unverified)*
- Luna terraforms approximately 14x faster than Earth *(unverified)*
...
- **Greenhouse Factor** = 1 + (Atmospheric Pressure / 10) + Greenhouse Gas Pressure, capped at a maximum of 3.0 *(unverified -- formula derived from community observation)*
- **Anti-Greenhouse Factor** = 1 + Anti-Greenhouse Gas Pressure, capped at a maximum of 3.0 *(unverified)*
- **Albedo** increase from water: 0.0015 x Hydro Extent %, to a maximum increase of 0.15 *(unverified -- albedo formula not stored in database)*
...
|-----|-----------------|-------------------|
| Oxygen (O2) | Below 0.1 atm or above 0.3 atm; max 30% of atmosphere | Breathability failure \hyperlink{ref-5.5-4}{[4]} |
| Methane (CH4) | 500 ppm (0.0005 atm) | Colony Cost +2.0 \hyperlink{ref-5.5-4}{[4]} |
| Ammonia (NH3) | 50 ppm (0.00005 atm) | Colony Cost +2.0 \hyperlink{ref-5.5-4}{[4]} |
| Carbon Dioxide (CO2) | 5,000 ppm (0.005 atm) | Colony Cost +2.0 \hyperlink{ref-5.5-4}{[4]} |
| Nitrogen Oxide (NO/NO2) | 5 ppm (0.000005 atm) | Colony Cost +2.0 \hyperlink{ref-5.5-4}{[4]} |
| Chlorine (Cl2) | 1 ppm (0.000001 atm) | Colony Cost +3.0 \hyperlink{ref-5.5-4}{[4]} |
...
- Water vapor condenses at a rate of 0.1 atm per year, increasing Hydro Extent *(unverified -- condensation rate not stored in database)*
- Equilibrium water vapor pressure: Atmospheric Pressure x (Hydro Extent / 100) x 0.01 atm *(unverified -- equilibrium formula not stored in database)*
...
- Adding water vapor raises temperature and may create surface water *(unverified -- water vapor is NOT classified as a greenhouse gas in the game database; its temperature effect may come from other mechanics)*
- Water vapor condenses at a rate of 0.1 atm per year, increasing Hydro Extent (surface water coverage) *(unverified)*
- Equilibrium water vapor pressure: Atmospheric Pressure x (Hydro Extent / 100) x 0.01 atm *(unverified)*
...
- Each warhead increases the dust level by an amount equal to its warhead size (strength) *(unverified -- bombardment mechanic not stored in database)*
- Dust Level / 20,000 is added to the planet's Anti-Greenhouse Factor *(unverified -- dust formula derived from community observation)*
- 20,000 dust = 1.0 added to the Anti-Greenhouse Factor (significant cooling) *(unverified)*
