...
- Terraforming rate is a racial technology — when researched, the new rate applies immediately to all existing ground-based installations and ship-based terraforming modules without requiring any refit or rebuild *(unverified — requires live testing to confirm retroactive application to ship modules)*
