...
On very cold worlds with existing ice sheets, exploit the ice melt feedback loop for bonus warming:
...
**Example — Titan:** With 75% hydro extent and greenhouse factor of 3.0, temperatures reach (-32°C to -18°C). But once ice melts, the +0.11 albedo boost pushes temps to (-5°C to 11°C) — achieving 0.0 CC. See [Section 5.3.4.1](5.3-environment.md) for the ice melt threshold mechanics.
