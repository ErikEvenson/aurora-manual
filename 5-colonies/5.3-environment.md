...
![](../images/art/section-art/5.3.png)
...
![Temperature vs Colony Cost Factor](../images/charts/5-colonies/5.3-temperature-vs-colony-cost.png)
...
- Halogens (fluorine, chlorine, bromine): trigger at 1 ppm concentration \hyperlink{ref-5.3-3}{[3]}
...
![Colony Cost Habitability Zones](../images/diagrams/5-colonies/5.3-habitability-zones.svg)
...
![Greenhouse Effect Feedback Loop](../images/diagrams/5-colonies/5.3-greenhouse-feedback.svg)

![Greenhouse Factor Effects](../images/charts/5-colonies/5.3.4-greenhouse-effects.png)
...
When a body's surface temperature rises above approximately **-27°C (246K)**, an "Ice Sheet Melted" event occurs *(unverified — [#850](https://github.com/ErikEvenson/aurora-manual/issues/850), forum-derived)* \hyperlink{ref-5.3-17}{[17]}:
...
- Since albedo is a warming multiplier in Aurora's formula, this creates a **positive feedback loop** — the ice melt causes additional warming *(unverified — [#850](https://github.com/ErikEvenson/aurora-manual/issues/850), requires live testing)*

This feedback loop has significant terraforming implications. On very cold worlds with ice sheets, warming past -27°C triggers a temperature boost from the albedo shift. For example, Titan with 75% hydro extent gains +0.11 to its albedo factor when the ice melts, pushing temperatures from (-32°C to -18°C) up to (-5°C to 11°C) *(unverified — [#850](https://github.com/ErikEvenson/aurora-manual/issues/850), community calculation)* — the difference between a marginal colony and 0.0 [CC](../appendices/B-glossary.md#cc).
...
When Earth moves within one million kilometres of the Sun, it is destroyed due to tidal stresses. *(requires live testing — destruction threshold not confirmed)* Any remaining populations are also destroyed, leaving no survivors on the homeworld.
...
The speed option chosen determines how much time players have: at 0.03 AU/year, Earth's destruction occurs in roughly 50 years; at 0.01 AU/year, players have approximately 150 years. *(unverified -- #1257 -- these timelines may be inflated by ~50%; actual destruction timing depends on Earth's starting orbital distance and the 1 million km destruction threshold)*
