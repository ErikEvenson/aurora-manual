...
- Whether high pressure causes discrete structural failure events beyond the colony cost penalty is unconfirmed *(unverified — not confirmed in database)*
...
- Note: The exact contribution of dust to the anti-greenhouse factor is *(unverified — dust mechanics may differ from community observation)*
...
**Spiral Speed Options:** Players select from three rates of planetary degradation: *(unverified — game setup configuration, speed options not confirmed in database)*
...
When Earth moves within one million kilometres of the Sun, it is destroyed due to tidal stresses. *(unverified — destruction threshold not confirmed)* Any remaining populations are also destroyed, leaving no survivors on the homeworld.
