...
#### Water on Airless Bodies (v2.0.0)
...
The Earth Death Spiral is a disaster scenario available during game setup (see [Section 2.1 New Game Options](../2-game-setup/2.1-new-game-options.md)) that creates an existential challenge requiring players to establish off-world colonies before Earth becomes uninhabitable.
