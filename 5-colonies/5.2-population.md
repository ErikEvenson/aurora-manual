...
- **Default Growth Rate:** The base annual growth rate is set during game creation (typically 1-2% per year for a standard game). *(unverified -- game setup configuration)*
- **Calculation:** Growth is applied to the total population each year. A colony of 100 million with 2% growth adds 2 million per year. *(unverified)*
- **Compound Growth:** Like interest, population growth compounds. A 2% growth rate doubles population in approximately 35 years. *(unverified)*

### Factors Affecting Growth

**Positive Modifiers:**

- **Adequate Infrastructure:** When infrastructure meets or exceeds the colony's needs, population grows at full rate. *(unverified -- gameplay mechanic)*
- **Sector Governor Bonus:** Governors (see [Section 16.1 Officer Generation](../16-commanders/16.1-officer-generation.md)) with population growth bonuses increase the rate for their assigned colony. *(unverified -- gameplay mechanic)*
- **Low Overcrowding:** When a colony is well below its carrying capacity, growth proceeds normally. *(unverified -- gameplay mechanic)*

**Negative Modifiers:**

- **Insufficient Infrastructure:** If infrastructure is below the required level for the current population and colony cost, growth is reduced. Severe shortfalls can cause population decline (deaths from life support failure). *(unverified -- gameplay mechanic)*
- **Overcrowding:** When population exceeds the colony's comfortable capacity, growth slows. *(unverified -- gameplay mechanic)*
- **Environmental Damage:** Radiation, extreme temperatures without adequate infrastructure, or toxic atmosphere breaches slow growth. *(unverified -- gameplay mechanic)*
- **Lack of Employment:** Extreme unemployment can reduce growth rates as economic conditions deteriorate. *(unverified -- gameplay mechanic)*

### Population Decline

Population can decrease in several situations:

- **Infrastructure Failure:** If infrastructure drops below critical levels (due to maintenance failure, enemy bombardment, or transportation issues), population will die. *(unverified -- gameplay mechanic)*
- **Orbital Bombardment:** Enemy attacks on a colony directly kill population (see [Section 12.1 Fire Controls](../12-combat/12.1-fire-controls.md)). *(unverified -- gameplay mechanic)*
- **Environmental Catastrophe:** Loss of atmosphere containment on hostile worlds. *(unverified -- gameplay mechanic)*
- **Emigration:** Population may leave a colony for better opportunities elsewhere (primarily a civilian economy mechanic). *(unverified -- gameplay mechanic)*
...
Orbital population growth operates at: **5% annual rate x (Available Space / Total Capacity)** *(unverified -- gameplay mechanic from developer changelog)*

If an Ark Ship is only carrying 75% of capacity, the annual population growth will be 1.25% (5% x 25% available space). *(unverified)*
...
**Maximum Capacity = (Body Surface Area / Earth Surface Area) x 12 billion** *(unverified -- formula derived from community observation)*

This baseline assumes an Earth-sized planet can sustain approximately 12 billion inhabitants. *(unverified)*

### Growth Rate Interaction

Population grows normally up to 33% of maximum capacity. Beyond this threshold, growth declines linearly, reaching zero at maximum capacity. *(unverified -- gameplay mechanic from developer changelog)* This mirrors real-world demographic trends where population growth rates peaked at approximately 2.1% when the world population was around 4 billion (one-third of estimated carrying capacity).
...
Regardless of other calculations, any non-gas giant body with gravity at or below the species' maximum tolerance maintains a floor capacity of 50,000 inhabitants. *(unverified -- gameplay mechanic)*
...
Not all population is available for manufacturing and mining work. Approximately 60% of total population is available as workers (the remainder being children, elderly, and service sector). *(unverified -- percentage not stored in database)* Of that workforce, a portion is further allocated to agriculture and environment based on the world's colony cost.

### Agriculture & Environment Workers

**Formula:** Agriculture & Environment Workers = 5% + (5% x Colony Cost) *(unverified -- formula derived from community observation)*
...
| 25 million | Trade goods production becomes viable for sustained civilian routes *(unverified -- community observation)* |
| 100 million | Manufacturing workforce stabilizes; governor bonuses become significant *(unverified -- community observation)* |
| 300 million | Large-scale industrial colony; growth rate may exceed colonist shipment rates *(unverified -- community observation)* |
...
**Naval Shipyard Workers:** Shipyard worker requirements are calculated separately based on shipyard size (250 workers per ton of shipyard capacity for naval shipyards). *(unverified -- shipyard worker formula not stored in installation table)*

### Manufacturing Sector and Service Sector

A colony's population is divided between the manufacturing sector and the service sector. The service sector cap in C# Aurora is 70% (reduced from 75% in VB6), meaning the manufacturing sector comprises at least 30% of the population. *(unverified -- service sector percentage not stored in database)* On a homeworld operating at maximum service sector, this means 30% of population is available for manufacturing work.
...
> **Note:** The "approximately 60% available as workers" figure in [Section 5.2.4](#524-workforce-allocation) and the "30% manufacturing sector" figure here describe different partitioning models of the same population. The 60% figure accounts for non-working population (children, elderly, etc.), while the 70% service sector cap further subdivides the working population between service and manufacturing roles. The effective manufacturing workforce depends on which model the game applies in a given context. Both figures are unverified community observations and the exact interaction between them has not been confirmed in the database. *(unverified)*
...
| **Initial Population Cost** | Consumes 100,000 population upon construction *(unverified -- gameplay mechanic not stored in installation table)* |
| **Ongoing Workers** | 5,000 population needed as overseers \hyperlink{ref-5.2-6}{[6]} |
| **Unrest Penalty** | +5 points of unrest instantly when built *(unverified -- gameplay mechanic)* |
...
**Formula:** ((Determination + Militancy + Xenophobia) / 300) x Population Amount x Political Status Modifier *(unverified -- formula derived from community observation)*
...
(Square Root of Size x Units x Morale) / 10,000 *(unverified -- formula derived from community observation)*
...
4. **Unrest Reduction Rate** = 100 x Police Modifier (points per year) *(unverified)*
...
- **High unrest (40+):** Production penalties begin, with output numbers visibly declining *(unverified)*
...
- **Forum screenshots:**
  - ~~[Population Capacity](http://www.pentarch.org/steve/Screenshots/PopCapacity.PNG)~~ *(link broken -- returns 404)*
