...
See also: [Section 9.1 Fleet Organization](../9-fleet-management/9.1-fleet-organization.md) for managing system defense fleets, and [Section 13.1 Unit Types and Formation Design](../13-ground-forces/13.1-unit-types.md) for security force configuration.
