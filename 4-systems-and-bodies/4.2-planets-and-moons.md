...
- **Below species tolerance:** Any gravity below species minimum (0.1g for default humans) triggers a fixed colony cost factor of 1.0 and requires double the standard infrastructure to support colonists (since v2.6.0, LG-Infrastructure was removed as a separate installation type; standard infrastructure is used at twice the normal quantity) \hyperlink{ref-4.2-7}{[7]} \hyperlink{ref-4.2-8}{[8]}.
...
- Higher gravity requires more robust construction, increasing the effective cost of infrastructure *(unverified — #1257)*
- Launch costs for spacecraft increase with gravity (relevant for naval shipyards on planetary surfaces) *(unverified — #1257)*
- Low gravity can cause long-term health issues for colonists *(unverified — #1257)*
