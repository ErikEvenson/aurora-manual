...
As of v2.0, Aurora C# models eccentric (non-circular) orbits for stars, planets, and other bodies. This significantly affects temperature calculations and colony planning.
...
Gas Giant Effects is an optional system generation feature (v2.0+) that simulates how massive gas giants influence nearby celestial bodies during planetary formation.
