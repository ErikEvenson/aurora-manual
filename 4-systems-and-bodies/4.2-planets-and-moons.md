...
- **Resources:** Sorium (fuel) can be harvested from gas giant atmospheres using fuel harvesters
...
The greenhouse effect is critical for terraforming calculations, as adding or removing greenhouse gases is the primary mechanism for adjusting planetary temperature.
...
Each deviation from these ideals adds to the colony cost multiplier, which determines how much infrastructure is needed per unit of population.
...
- Fuel production (Sorium harvesting from the gas giant)
