...
In Known Stars games, Aurora C# uses a substantial database of real stellar data. As of v2.4.0, this database contains over 63,000 stars representing every star within 775 light-years of Sol, plus a few hundred further out.
...
Supernovae are an optional SpaceMaster-triggered catastrophic event available in Known Stars games (v2.2.0+). These events create expanding radiation waves that propagate through real space at light speed.
