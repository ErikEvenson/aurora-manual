...
- **Mineral Variety:** Asteroids can contain all eleven mineral types tracked in Aurora, though metallic asteroids tend toward Duranium, Neutronium, and Corbomite, while carbonaceous types favor Vendarite and Boronide.
...
1. **Geological Survey:** First, survey the body with a ship equipped with geological survey sensors. This reveals mineral deposits and their accessibility ratings.
...
- **Mass Driver Installation:** Launches mineral packets toward a receiving colony at high speed.
