...
- **Composition:** Varies from carbonaceous (carbon-rich, volatile-rich) to silicate (rocky) to metallic (iron-nickel). *(unverified -- #1257 -- the database does not differentiate asteroid composition subtypes; all asteroids share BodyTypeID=1 and mineral deposits are randomly assigned without confirmed affinities for specific subtypes)*
