...
- **Mineral Variety:** Asteroids can contain all eleven mineral types tracked in Aurora \hyperlink{ref-4.3-2}{[2]} (see [Appendix B: Glossary](../appendices/B-glossary.md)), though metallic asteroids tend toward Duranium, Neutronium, and Corbomite, while carbonaceous types favor Vendarite and Boronide. *(unverified -- composition affinities not confirmed in database)*
...
- **Eccentric Orbits:** Comets have orbital eccentricities much higher than planets, often 0.5-0.99. *(unverified)* This means their distance from the star varies enormously over their orbital period.
...
- **Composition:** Primarily water ice, frozen gases, and rocky/dusty material. Often referred to as "dirty snowballs." *(unverified)*
- **Size:** Generally small, ranging from a few kilometers to tens of kilometers in diameter.
- **Volatiles:** Comets are notable sources of volatile materials including water, CO2, and other frozen gases. They can sometimes contain Sorium deposits. *(unverified)*
...
- **No Infrastructure Needed:** Automated mines don't require supporting infrastructure (no need for colony cost-reducing infrastructure units). *(unverified)*
