...
For comprehensive patrol route setup including step-by-step configuration, conditional order integration, speed vs. fuel trade-offs, endurance calculations, and sensor coverage formulas, see [Section 10.1.7 Patrol Route Creation](10.1-movement-mechanics.md#1017-patrol-route-creation).
