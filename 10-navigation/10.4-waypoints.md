...
Aurora C# significantly expands the waypoint system from VB6, offering five distinct types that serve different strategic and tactical purposes. Each type has unique properties that integrate with the Standing Orders system (see Section 9.5.4).
...
Standard waypoint functionality with the additional capability of serving as targets for the **"Move to Closest Rendezvous Point"** standing or conditional order (see Section 9.5.4). This makes them ideal for fleet coordination -- set a Rendezvous Point at your desired assembly location, and any fleet with the corresponding standing order will automatically navigate there when idle.
