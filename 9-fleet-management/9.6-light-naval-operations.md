...
The 1,000-ton threshold is the single dividing line between Light Naval and standard naval vessels *(unverified — #762 -- v2.8.0 change not yet in AuroraDB v2.7.1)*. Ships at or below this tonnage receive a distinct set of mechanical treatments that affect construction, command, and tactical operations.
...
*Half-bonus skills: Crew Training, Survey, Engineering, Tactical, Carrier Ops, Ground Support *(unverified — #762 -- v2.8.0 mechanic; the bonus types exist in AuroraDB v2.7.1 \hyperlink{ref-9.6-4}{[4]} but the half-bonus behavior cannot be verified against the current database)*.
...
- Automated MSP resupply (10 MSP/hour conventional, 20 MSP/hour TN) *(unverified — #762 -- rates reported by players but not confirmed in game database)*
...
| Generation chance | 40% (same as Survey; 2x Tactical's 20%) *(unverified — #762 -- Light Tactical does not exist in AuroraDB v2.7.1; this is a v2.8.0 addition. Fighter Combat, its predecessor, exists as BonusID=26 \hyperlink{ref-9.6-4}{[4]})* |
