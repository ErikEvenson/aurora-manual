---
title: "9.6 Light Naval Operations"
...
![](../images/art/section-art/9.6.png)
...
> **v2.8.0 Summary:** This version unifies Fighters and FACs into a single Light Naval classification. Key changes: (1) Planetary interaction limit raised from 500 tons to 1,000 tons; (2) Fighter Factories renamed to Light Naval Factories; (3) Fighter Combat bonus replaced by Light Tactical; (4) Standard Tactical bonus no longer affects Light Naval units; (5) Ships >1,000 tons receive half commander bonuses for six skill types.
...
The 1,000-ton threshold is the single dividing line between Light Naval and standard naval vessels *(unverified — [#837](https://github.com/ErikEvenson/aurora-manual/issues/837) -- v2.8.0 change not in AuroraDB v2.7.1; requires live testing with v2.8.0)*. Ships at or below this tonnage receive a distinct set of mechanical treatments that affect construction, command, and tactical operations.
...
*Half-bonus skills: Crew Training, Survey, Engineering, Tactical, Carrier Ops, Ground Support *(unverified — [#837](https://github.com/ErikEvenson/aurora-manual/issues/837) -- v2.8.0 mechanic not in AuroraDB v2.7.1; requires live testing with v2.8.0)*.
...
| Build rate | Same as Naval (400 [BP](../appendices/B-glossary.md#bp)/year per slipway base) \hyperlink{ref-9.6-5}{[5]} |
...
- Automated [MSP](../appendices/B-glossary.md#msp) resupply (10 MSP/hour conventional, 20 MSP/hour [TN](../appendices/B-glossary.md#tn)) *(unverified — [#837](https://github.com/ErikEvenson/aurora-manual/issues/837) -- requires live testing)*
...
- **Boat Bay (250t capacity):** The general-purpose choice for most carrier designs. Houses the full range of common Light Naval designs (missile boats, beam fighters, patrol craft) without excessive overhead. A 10,000-ton carrier with four boat bays can support a mixed air wing of four 250-ton fighters or fewer larger designs.
...
| Generation chance | 40% (same as Survey; 2x Tactical's 20%) *(unverified — [#837](https://github.com/ErikEvenson/aurora-manual/issues/837) -- v2.8.0 addition not in AuroraDB v2.7.1; Fighter Combat (BonusID=26) \hyperlink{ref-9.6-4}{[4]} is the predecessor; requires live testing with v2.8.0)* |
...
- Base flow rate of 15,000 litres/hour per the in-game component (the underlying technology is named "5,000 LPH" but the component built from it yields 15,000 LPH) \hyperlink{ref-9.6-3}{[3]}; can only refuel ships of 1,000 tons or less
...
| Beam Interceptor | 400-600t | 1-2 lasers, [BFC](../appendices/B-glossary.md#bfc), engine | Fleet defense, anti-fighter |
...
- **[CIWS](../appendices/B-glossary.md#ciws) (Close-In Weapons Systems):** Gauss cannons provide automated point defense against incoming fighters and missiles
...
\hypertarget{ref-9.6-1}{[1]} AuroraDB.db, FCT\_ShipDesignComponents table: Small Boat Bay (Size=1.05 HS/52.5t, ComponentValue=1.0/50t capacity, Cost=5, Crew=1), Boat Bay (Size=5.25 HS/262.5t, ComponentValue=5.0/250t capacity, Cost=25, Crew=3), Hangar Deck (Size=21.0 HS/1050t, ComponentValue=20.0/1000t capacity, Cost=100, Crew=12), Commercial Hangar Deck (Size=32.0 HS/1600t, ComponentValue=20.0/1000t capacity, Cost=100, Crew=15, MilitarySystem=0).

\hypertarget{ref-9.6-2}{[2]} AuroraDB.db, FCT\_ShipDesignComponents table: Engineering Spaces - Fighter (Size=0.1 HS/5 tons, Cost=1.0, Crew=1). Also Tiny=12.5t and Small=25t confirmed.

\hypertarget{ref-9.6-3}{[3]} AuroraDB.db, FCT\_TechSystem table: Small Craft Refuelling System base tech is named "5,000 LPH" (TechSystemID 97493, AdditionalInfo=10000). FCT\_ShipDesignComponents table: the actual in-game component shows 15,000 LPH (ComponentValue=15000, Size=1.0 HS/50t). The discrepancy between the tech name and the component value may indicate a multiplier is applied during component generation.

\hypertarget{ref-9.6-4}{[4]} AuroraDB.db, DIM\_CommanderBonusType table: Relevant naval bonus types confirmed -- Crew Training (BonusID=1), Survey (BonusID=2), Carrier Operations (BonusID=7), Tactical (BonusID=21), Fighter Combat (BonusID=26), Engineering (BonusID=28), Ground Support (BonusID=36). All are percentage-based (Percentage=1) with MaximumBonus=1.5. Note: "Light Tactical" does not appear in v2.7.1; it is a v2.8.0 addition replacing Fighter Combat.

\hypertarget{ref-9.6-5}{[5]} AuroraDB.db, FCT\_Race table: ShipBuilding=400.0 confirms base build rate of 400 BP/year per slipway for all shipyard types including Light Naval Shipyards.

\hypertarget{ref-9.6-6}{[6]} AuroraDB.db, FCT\_ShipDesignComponents table: Primary Flight Control (Size=4.0 HS/200t, Crew=10). This component provides crew berths for parasite craft personnel aboard carriers.
