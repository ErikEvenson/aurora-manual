...
| Mechanic | Light Naval (1,000t or less) | Standard Naval (over 1,000t) |
|----------|------------------------------|-------------------------------|
| Commander bonuses | Full bonus applied | Half bonus for: Crew Training, Survey, Engineering, Tactical, Carrier Ops, Ground Support |
| Tactical bonus type | Light Tactical (exclusive) | Tactical (standard) |
| Surface interaction | Can interact with planetary surfaces | Cannot interact with surfaces |
| Cargo shuttle bays | Not required for cargo loading | Required for planet-side loading |
| Bridge requirement | Not required | Required at 1,000t+ (auto-added at 1,100t) |
| Construction options | Light Naval Factories or Light Naval Shipyards | Naval Shipyards only |
| Retooling | Not required (Light Naval Shipyards) | Required per class |
| Maintenance in hangars | Suspended (no malfunction rolls) | Suspended (no malfunction rolls) |
...
| Generation chance | 40% (same as Survey; double that of Tactical's 20%) |
| Replaces | Fighter Combat bonus (removed in v2.8.0) |
| Commander assignment | Light Naval unit commanders are assigned based on Light Tactical rating |
| Experience weighting | Weighted toward Light Tactical (same as Crew Training weighting for larger warships) |
