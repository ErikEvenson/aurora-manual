...
The 1,000-ton threshold is the single dividing line between Light Naval and standard naval vessels. Ships at or below this tonnage receive a distinct set of mechanical treatments that affect construction, command, and tactical operations.
...
*Half-bonus skills: Crew Training, Survey, Engineering, Tactical, Carrier Ops, Ground Support.
...
- Load and unload cargo and colonists directly without cargo shuttle bays (see [Section 8.6.5 Fuel Tanks and Cargo](../8-ship-design/8.6-other-components.md))
...
- [Section 8.2.1 Hull Size](../8-ship-design/8.2-hull-and-armor.md) -- Light Naval Classification definition and hull mechanics
- [Section 8.6.9 Bridges](../8-ship-design/8.6-other-components.md) -- Bridge requirement threshold at 1,000 tons
...
| Build rate | Same as Naval (400 BP/year per slipway base) |
...
- [Section 9.1 Shipyards](9.1-shipyards.md) -- Full shipyard mechanics, capacity expansion, and retooling
- [Section 6.3 Construction](../6-economy-and-industry/6.3-construction.md) -- Ground-based factory production
...
- Automated MSP resupply (10 MSP/hour conventional, 20 MSP/hour TN)
...
- [Section 9.3 Task Groups](9.3-task-groups.md) -- Task group organization and movement
- [Section 9.4 Fleet Organization](9.4-fleet-organization.md) -- Fleet hierarchy and sub-fleets
- [Section 8.6.3 Hangars](../8-ship-design/8.6-other-components.md) -- Hangar mechanics and parasite craft
...
| Type | Size (tons) | Capacity (tons) | Cost (BP) | Crew |
|------|-------------|-----------------|-----------|------|
| Small Boat Bay | 52.5 | 50 | 5 | 1 |
| Boat Bay | 262.5 | 250 | 25 | 3 |
| Hangar Deck | 1,050 | 1,000 | 100 | 12 |
| Military Hangar Bay | 1,600 | ~1,500 | 100 | 15 |

Each component type is slightly larger than its stated capacity (5% overhead for boat bays/hangar decks) to account for structural support mechanisms. The ship designer automatically adds 20 flight crew berths per hangar bay for parasite crew accommodation.
...
- **Military Hangar Bay (1,500t capacity):** Provides capacity beyond the Light Naval ceiling, useful for carriers that also support small standard naval vessels (tenders, repair ships). The higher crew requirement (15 vs. 12 for hangar decks) and 1,600-ton footprint make these appropriate only for large capital carriers or tenders.
...
- [Section 8.6.3 Hangars and Parasite Craft](../8-ship-design/8.6-other-components.md) -- Detailed hangar component specifications
- [Section 16.2.1 Skills](../16-commanders/16.2-skills-and-bonuses.md) -- Carrier Operations skill description
- [Section 12.3 Missiles](../12-combat/12.3-missiles.md) -- Fighter combat mechanics
...
| Generation chance | 40% (same as Survey; 2x Tactical's 20%) |
...
- [Section 16.2.1 Skills](../16-commanders/16.2-skills-and-bonuses.md) -- Complete skill category descriptions
- [Section 16.2.2 Bonus Generation](../16-commanders/16.2-skills-and-bonuses.md) -- Generation chances for all bonus types
- [Section 16.2.5 Promotion and Experience](../16-commanders/16.2-skills-and-bonuses.md) -- Experience gain and skill improvement
...
**Fighter-sized engineering spaces** (5 tons) are available for Light Naval vessels:
...
- Small Craft Refuelling System (v2.0) allows mutual refueling between Light Naval vessels
- Only one refuelling system per class design (v2.1 restriction)
- 10,000 litres/hour flow rate; can only refuel ships of 1,000 tons or less
...
- [Section 8.1 Design Philosophy](../8-ship-design/8.1-design-philosophy.md) -- General ship design principles
- [Section 8.3 Engines](../8-ship-design/8.3-engines.md) -- Engine sizing and fuel efficiency
- [Section 8.5 Weapons](../8-ship-design/8.5-weapons.md) -- Weapon selection and fire control
- [Section 8.6.2 Magazines](../8-ship-design/8.6-other-components.md) -- Box launcher vs. magazine trade-offs
- [Section 13.2.1 Ground Support Fighters Removed](../13-ground-forces/13.2-training-and-transport.md) -- v2.8.0 removal of fighter ground support
...
The Small Craft Refuelling System (10,000 litres/hour, one system per class) enables mutual refueling between Light Naval vessels, but the flow rate is slow compared to standard underway replenishment. For extended independent operations, dedicate one ship per squadron as a fuel-heavy "squadron tanker" carrying minimal armament but oversized fuel tanks.

> **Note:** The one-refuelling-system-per-class restriction (v2.1) means you cannot stack multiple refuelling systems on a single tanker design. A dedicated 1,000-ton squadron tanker with one refuelling system and 400+ tons of fuel is the practical ceiling for Light Naval logistics.
...
- [Section 9.3 Task Groups](9.3-task-groups.md) -- Conditional orders and movement commands
- [Section 9.4 Fleet Organization](9.4-fleet-organization.md) -- Fleet hierarchy for contact propagation
- [Section 8.3 Engines](../8-ship-design/8.3-engines.md) -- Fuel efficiency vs. speed trade-offs
- [Section 8.4 Sensors](../8-ship-design/8.4-sensors.md) -- Passive sensor design for picket roles
