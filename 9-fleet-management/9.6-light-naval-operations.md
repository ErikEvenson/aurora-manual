...
The 1,000-ton threshold is the single dividing line between Light Naval and standard naval vessels *(unverified — #762 -- v2.8.0 change not in AuroraDB v2.7.1; requires live testing with v2.8.0)*. Ships at or below this tonnage receive a distinct set of mechanical treatments that affect construction, command, and tactical operations.
...
*Half-bonus skills: Crew Training, Survey, Engineering, Tactical, Carrier Ops, Ground Support *(unverified — #762 -- v2.8.0 mechanic not in AuroraDB v2.7.1; requires live testing with v2.8.0)*.
...
- Automated MSP resupply (10 MSP/hour conventional, 20 MSP/hour TN) *(unverified — #762 -- requires live testing)*
...
| Generation chance | 40% (same as Survey; 2x Tactical's 20%) *(unverified — #762 -- v2.8.0 addition not in AuroraDB v2.7.1; Fighter Combat (BonusID=26) \hyperlink{ref-9.6-4}{[4]} is the predecessor; requires live testing with v2.8.0)* |
