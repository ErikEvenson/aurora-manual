...
**Admin Command Required Ranks (v2.0):**
...
- As of v2.1, a naming option exists that names every ship after the class without a numeric suffix (useful for unique-class flagships or named vessels where sequential numbering is undesirable)
