...
Aurora C# replaces the VB6 version's Task Forces and Task Groups with a hierarchical four-level naval organization system. This structure is managed through the **Naval Organization** window (F4), which provides full drag-and-drop functionality for reorganizing your forces.
...
- Each Naval Headquarters level costs 1200 [BP](../appendices/B-glossary.md#bp) \hyperlink{ref-9.4-1}{[1]} and can support multiple Admin Commands
...
|------|----------------------------------------------|--------|-------|
| General | 10% Survey, 5% Industrial, 10% Engineering, 10% CrewTraining, 10% FleetTraining, 10% Tactical, 10% Reaction, 5% Logistics | 1.0 | Versatile but diluted |
...
The Naval Organization window (F4) is the primary interface for managing all fleet structure. Its layout combines a tree view with tabbed detail panels.
...
- **Total fleet maintenance capacity**: The combined maintenance supply ([MSP](../appendices/B-glossary.md#msp)) storage across all ships
...
- Delete (with safeguards -- see [Section 9.4.10 Fleet Deletion Protection](#9410-fleet-deletion-protection))
- Assign Commander
- Center Map on Fleet
...
- Transfers to Non-Player Races ([NPR](../appendices/B-glossary.md#npr)s) are possible but not recommended for inexperienced players
...
- [Section 12.7 Planetary Defence Centres](../12-combat/12.7-planetary-defence-centres.md) -- [PDC](../appendices/B-glossary.md#pdc) coordination with orbital fleets in layered defense
