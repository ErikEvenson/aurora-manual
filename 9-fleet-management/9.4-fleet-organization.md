...
- Multiple tugs cannot combine their strength on a single target *(unverified — [#872](https://github.com/ErikEvenson/aurora-manual/issues/872))* — to move large stations faster, build heavier tugs rather than assigning multiple tugs
