...
**Fleet Commanders:** Assigning a senior officer (see [Section 16.1 Commander Types](../16-commanders/16.1-commander-types.md)) as fleet commander provides bonuses that cascade to all ships within the fleet:
...
- [9.3 Task Groups](9.3-task-groups.md) -- Task group formation, speed, and conditional orders
- [9.5 Orders](9.5-orders.md) -- Fleet and task group orders
- [16.1 Commander Types](../16-commanders/16.1-commander-types.md) -- Officer types for fleet and admin command assignments
- [16.3 Assignments](../16-commanders/16.3-assignments.md) -- Assigning commanders to fleets and commands
- [12.1 Combat Mechanics](../12-combat/12.1-combat-mechanics.md) -- How fleet organization affects combat performance
