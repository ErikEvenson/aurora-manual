...
![](../images/art/section-art/9.3.png)

![Figure 9.3: Naval Organization -- Ship List Tab](../images/screenshots/9-fleet-management/9.3-task-group-ship-list.png)
...
Task groups are managed through the **Naval Organization** window (F4) and the **Task Group** window, which is your primary interface for issuing orders.
...
1. Opening the Naval Organization window (F4)
...
- **Carrier Operations** -- Multiplies parasite fuel, [MSP](../appendices/B-glossary.md#msp), and ordnance transfer rates (see [Section 9.6.4 Carrier Operations](9.6-light-naval-operations.md))
...
2. Once in-system, detach the geo survey ship into its own fleet via the Naval Organization window (F4)
