...
**Commanders:** Each task group should have a commanding officer assigned (see [Section 16.1 Commander Types](../16-commanders/16.1-commander-types.md)). The commander's skills affect the task group's performance:

- **Initiative** -- Determines the task group's movement order during combat (see below)
...
### Task Group Initiative and Combat Turn Order
...
**Speed Calculation:** Each ship's maximum speed is determined by its engine power divided by its total mass (see [Section 8.3.3 Speed Calculations](../8-ship-design/8.3-engines.md)). The task group's speed equals the minimum of all member ships' speeds.
...
**Transfer Fleet to Alien Race (v2.0+):**

Players can transfer entire fleets to known alien races using a button on the Fleet Miscellaneous tab. This diplomatic/strategic action:
- Transfers all ships in the fleet to the selected recipient race
- Reveals the current system to the recipient race
- Generates necessary alien intelligence records for the transferred ships
- NPRs receiving fleets will assign appropriate Ship and Fleet AIs based on the transferred ships' capabilities

This feature enables strategic gifting of ships to allies, seeding NPRs with specific vessels for roleplay purposes, or surrendering ships to avoid destruction.
...
- [9.4 Fleet Organization](9.4-fleet-organization.md) -- Higher-level fleet hierarchy and admin commands
- [9.5 Orders](9.5-orders.md) -- Detailed order types available to task groups
- [16.1 Commander Types](../16-commanders/16.1-commander-types.md) -- Officer types and skills affecting task group performance
- [8.3 Engines](../8-ship-design/8.3-engines.md) -- Speed calculations and fleet speed implications
- [12.1 Combat Mechanics](../12-combat/12.1-combat-mechanics.md) -- How initiative and movement affect combat
- [10.1 System Map](../10-navigation/10.1-system-map.md) -- Navigating task groups through systems
