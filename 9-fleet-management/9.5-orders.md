...
| Pickup Nearest Lifepod | S | Automatically collects lifepods within the same system. Multiple fleets coordinate their pickups so that two fleets do not attempt to collect the same lifepod. |
