...
**Civilian Contract Standing Order (v2.8.0):** A new standing order type enables fleets to execute civilian shipping contracts autonomously:
...
- **Refuelling:** Fleets can be configured to refuel at designated destinations during contract execution
- **Use Case:** Useful for supplementing civilian shipping capacity or ensuring critical trade routes are serviced when civilian shipping is insufficient
