...
We take a different view. A manual with tracked errors that get corrected over time is more useful than no manual at all. Every factual claim cites the Aurora game database with exact table and column references. Claims we cannot verify are explicitly marked. When tested against "known AI hallucinations" circulating in the community, the manual's database-backed citations have provided definitive resolution. For the full explanation of these anti-hallucination measures, see [Section 1.4.8 How This Manual Prevents AI Hallucination](1-introduction/1.4-ai-assisted-play.md#148-how-this-manual-prevents-ai-hallucination).
