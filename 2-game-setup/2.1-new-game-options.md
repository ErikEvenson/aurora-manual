...
Aurora C# always starts the player in the Sol system (Earth). There is no dropdown or option to select a different starting system during game creation.

> **Note:** There is no built-in option to start in a non-Sol system (such as Alpha Centauri). If you want a custom starting location, you must use SpaceMaster mode after game creation to manually set up your empire in a different system. See [Section 2.5.3.2 Custom Start via SpaceMaster](2.5-starting-conditions.md#2532-custom-start-via-spacemaster-advanced) for details. The "Known Star Systems" checkbox affects exploration destinations, not your starting location.
