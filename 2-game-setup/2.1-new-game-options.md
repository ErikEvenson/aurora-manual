...
Aurora C# always starts the player in the Sol system (Earth). There is no option to select a different starting system.

> **Note:** Unlike the older VB6 version, C# Aurora does not provide any way to start in a non-Sol system. The "Known Star Systems" checkbox affects which real stars you encounter during exploration, not your starting location. See [Section 2.5.3 Starting System Options](2.5-starting-conditions.md#253-starting-system-options) for details.
