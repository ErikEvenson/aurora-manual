...
![](../images/art/section-art/2.1.png)

![Figure 2.1: Game Creation Workflow](../images/diagrams/2-game-setup/2.1-game-creation-workflow.svg)
...
![Figure 2.1: New Game Options Window](../images/screenshots/2-game-setup/2.1-new-game-options.png)
...
![Figure 2.1.1: NPR Difficulty Scaling](../images/charts/2-game-setup/2.1-difficulty-modifier-impact.png)
...
![Figure 2.1.2.1: NPR Generation Flowchart](../images/diagrams/2-game-setup/2.1-npr-generation.png)
...
- **Lost Colonies** *(v2.8.0)*: When enabled, creates a 40% chance of discovering lost human colonies during exploration \hyperlink{ref-2.1-13}{[13]}. A discovery check occurs when all of the following conditions are met:
  ...
  > **v2.8.0+:** Lost colonies range from pre-industrial to [Trans-Newtonian (TN)](../appendices/B-glossary.md#tn) technology levels, matching the tech distribution set by NPR generation percentages. Unlike standard NPRs, lost colonies have no military infrastructure or forces regardless of their tech level.

  Lost colonies have distinct characteristics compared to standard NPRs:
  - Technology ranges from pre-industrial to Trans-Newtonian (based on NPR generation settings)
  - Population is approximately 25% smaller than equivalent NPR populations
  - No military forces or military infrastructure at any tech level
...
- **Starting Year**: The calendar year the game begins. The default is 2050 \hyperlink{ref-2.1-1}{[1]}. This primarily affects the calendar display. Note that for Earth Death Spiral and Solar System Destruction scenarios, the starting year determines the timeline for disaster progression. Some players use far-future dates for more science-fiction oriented games, or historical dates for alternate-history scenarios.
...
### 2.1.3.1 Starting System

Aurora C# always starts the player in the Sol system (Earth) by default. There is no dropdown to select a different starting system during game creation.

> **Note:** While the default start is always Sol, experienced players can use SpaceMaster mode after game creation to set up a custom starting system. This involves creating a throwaway game, using SM tools to generate and customize a new system, then establishing your race there. See [Section 2.5.3.2 Custom Start via SpaceMaster](2.5-starting-conditions.md#2532-custom-start-via-spacemaster-advanced) for the complete process.

### 2.1.3.2 Spoiler Race Trigger Thresholds
...
### 2.1.3.3 Minimum Research Point Thresholds
...
![Figure 2.1.4a: Catastrophe Scenario Timelines](../images/diagrams/2-game-setup/2.1-catastrophe-timeline.svg)

![Figure 2.1.4b: Disaster Scenario Comparison](../images/charts/2.1-disaster-timeline.png)
...
![Figure 2.1.5: Game Settings Impact Matrix](../images/charts/2.1-settings-impact-matrix.png)
...
\hypertarget{ref-2.1-13}{[13]}. Aurora Forums, "v2.8.0 Changes List" -- Lost Colonies option: 40% discovery chance, triggering conditions, colonies range from pre-industrial to Trans-Newtonian tech levels, population approximately 25% smaller than NPRs, no military forces or infrastructure at any tech level, minimal research/construction facilities. [aurora2.pentarch.org](https://aurora2.pentarch.org/index.php?topic=13884.0)
