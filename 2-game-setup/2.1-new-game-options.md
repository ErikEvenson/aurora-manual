...
### 2.1.3.1 Starting Race Selection

The **Starting Race** dropdown determines your empire's starting configuration:

- **Sol System** (default): Standard start on Earth in the real solar system. This is the recommended option for most players and provides a familiar starting geography with preset mineral deposits and orbital parameters. See [Section 2.5.1 Conventional Start](2.5-starting-conditions.md) and [Section 2.5.2 Trans-Newtonian Start](2.5-starting-conditions.md) for details on what you begin with.

- **SpaceMaster Empire**: Advanced option for creating a custom starting system and race. Instead of beginning on Earth, you use SpaceMaster mode tools to generate a random system and create your empire from scratch. This option is significantly more complex and not recommended for new players. See [Section 2.5.3.2 SpaceMaster Empire Start](2.5-starting-conditions.md#2532-spacemaster-empire-start-random-system) for setup instructions.

> **Note:** There is no option to start in a specific non-Sol real star system (such as Alpha Centauri). Your starting location is either Sol or a randomly generated system via SpaceMaster Empire. The "Known Star Systems" checkbox affects exploration destinations, not your starting location.
