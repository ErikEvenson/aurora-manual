# 2.3 Racial Traits and Species Customization

Aurora's race creation system uses a point-buy approach to define your species' biological, economic, and military characteristics. These choices are permanent once the game begins and fundamentally shape how your civilization develops across all phases of play.

> **Note:** This section covers the trait point allocation system. For species biological attributes (gravity, temperature, atmosphere), see [Section 2.2 Race Creation](2.2-race-creation.md). For starting technology and installations, see [Section 2.4 Starting Conditions](2.4-starting-conditions.md).

## 2.3.1 Race Creation Overview
...
- Each race receives a fixed pool of creation points at creation
...
|-----------|-----------------|--------|
| Ideal Temperature | 14C (57F) | Center of your comfort range |
| Temperature Tolerance | +/- 22C | Width of the habitable band |
...
| Parameter | Default (Human) | Effect |
|-----------|-----------------|--------|
| Homeworld Gravity | 1.0G | Your species' ideal gravity |
| Minimum Gravity | 0.1G | Lowest tolerable gravity |
| Maximum Gravity | 3.0G | Highest tolerable gravity |
...
Radiation tolerance determines how much stellar and cosmic radiation your species can withstand. Worlds with high radiation levels (due to weak magnetic fields, proximity to active stars, or other factors) incur additional colony cost for species with low radiation tolerance.
...
|-------|---------|--------|-----------------|
| Worker Production Rate | 1.0 | Multiplier on factory, refinery, and shipyard output | Higher = faster ship construction, more installations built per year |
| Wealth Creation Rate | 1.0 | Multiplier on wealth generated per population unit | Higher = more available funding for civilian operations |
| Research Rate Modifier | 1.0 | Multiplier on all scientist research output | Higher = faster technology advancement across all fields |
| Population Growth Rate | 1.0 | Multiplier on natural reproduction | Higher = faster colony growth, more workers sooner |

### Worker Production Rate
...
The political system selection affects governance bonuses and how your empire operates at the administrative level:

- Determines base bonus modifiers for colony governors
- Affects wealth generation efficiency
- Influences population loyalty and unrest mechanics
- Provides flavor and narrative context for your civilization

## 2.3.4 Military Traits
...
|-------|---------|--------|
| Ground Combat Strength | 1.0 | Multiplier on ground force combat effectiveness |
| Officer Generation Rate | 1.0 | Multiplier on commander generation frequency |

### Ground Combat Strength Modifier
...
## 2.3.5 Starting Conditions

Starting conditions determine what your civilization has when the game begins. These interact with racial traits to define your initial capabilities.

### Conventional Start vs Trans-Newtonian Start

| Aspect | Conventional Start | Trans-Newtonian Start |
|--------|-------------------|----------------------|
| Technology | Current-day equivalent | Basic spacefaring tech researched |
| Industry | Conventional (less efficient) | TN-grade (full efficiency) |
| Ships | None | Basic survey vessels available |
| Time to Space | 20-50 years | Immediate |
| Gameplay Pace | Slow, narrative-driven | Faster, action-oriented |
...
With a TN start, your species begins with:

- Basic nuclear propulsion systems
- Standard armor and construction materials
- Electromagnetic and thermal sensor packages
- Gravitational survey sensors
- Basic missile and beam weapon technology
- Fuel harvesting and refining capability

All further technological advancement requires research (see [Section 7.1 Research](../7-research/7.1-research.md)).

### Starting Population and Installations

| Asset | Conventional Start | TN Start |
|-------|-------------------|----------|
| Population | ~500M-1B | ~1B |
| Factories | Conventional grade | Several hundred (TN) |
| Mines | Conventional grade | Several hundred (TN) |
| Research Labs | Available | Fully operational (TN) |
| Shipyards | None | 1-2 operational |
| Fuel Refineries | None | Operational |
| Ground Forces | Basic garrison | Basic garrison |

> **Note:** Starting installations have been adjusted across Aurora versions. As of v2.1.1, TN starts begin with one billion population (increased from the previous 500 million).

## 2.3.6 Pre-Designed Races

Aurora includes several pre-designed races that can be used as-is or as templates for custom designs. These provide ready-to-play options for players who want to start immediately without navigating the full race creation system.

**Pre-Designed Race Characteristics:**

- Balanced trait allocations suitable for general play
- Pre-configured atmospheric and environmental preferences
- Assigned commander naming themes
- Ready for immediate game start
...
> **Tip:** Pre-designed races are a good starting point for understanding trait interactions. Study their allocations to see how experienced designers balance competing priorities, then modify to suit your preferred strategy.
...
- [Section 2.4 Starting Conditions](2.4-starting-conditions.md) -- Detailed starting assets for each start type
...
- [Section 7.1 Research](../7-research/7.1-research.md) -- Research system and technology progression
