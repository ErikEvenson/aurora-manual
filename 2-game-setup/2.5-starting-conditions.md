...
- **Research Facilities**: Increase from the default to compensate. The default number of research labs varies by government type (the GovType table's Labs column sets the allocation ratio) \hyperlink{ref-2.5-2}{[2]}. For the "Player Race" government type, the default starts with approximately 40 research facilities \hyperlink{ref-2.5-3}{[3]}.
- **Conventional Industry**: Consider increasing above the default allocation. The default count varies by government type \hyperlink{ref-2.5-2}{[2]}. Additional conventional factories provide early flexibility and help prevent running out of money during the bootstrapping phase when you have no other income sources.
...
**Starting Assets (TN Start, "Player Race" Government Type):**

The following values are from a default TN start with the "Player Race" government type \hyperlink{ref-2.5-3}{[3]}. Other government types receive different allocations based on the GovType table \hyperlink{ref-2.5-2}{[2]}.
...
- **Real Stellar Neighborhood**: If using real star data, nearby systems are actual stars (Alpha Centauri, Barnard's Star, etc.) at correct relative distances \hyperlink{ref-2.5-4}{[4]}.

**Disadvantages of Sol:**

- **Fixed Mineral Distribution**: Sol's mineral deposits are pre-set and may not be optimal \hyperlink{ref-2.5-4}{[4]}. Earth's minerals are finite and will eventually deplete.
...
- [Section 2.2 Race Creation](2.2-race-creation.md) -- Race creation UI fields and government type selection
...
\hypertarget{ref-2.5-2}{[2]}. Aurora C# game database (AuroraDB.db v2.7.1) -- GovType table contains 38 government types with starting installation allocation columns: Shipyards, Labs, Construction, Refineries, Mines, Sensors, MissileBases, TotalIndustrial. Allocations vary significantly (e.g., Labs ranges from 5 to 40, Construction from 25 to 50)

\hypertarget{ref-2.5-3}{[3]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_PopulationInstallations for "Player Race" (GovTypeID=1) TN start on Earth: Construction Factory=800, Mine=800, Ordnance Factory=200, Fuel Refinery=200, Financial Centre=400, Maintenance Facility=300, Automated Mine=160, Fighter Factory=80, Research Facility=40, Ground Force Construction Complex=8, Deep Space Tracking Station=7, Military Academy=2, Infrastructure=200. FCT\_Population: Population=1000.0 (million), FuelStockpile=24000000, MaintenanceStockpile=60000

\hypertarget{ref-2.5-4}{[4]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_SystemBody table contains Sol system bodies with pre-set orbital parameters and mineral deposits. DIM\_KnownStar table contains real star data (Alpha Centauri, Barnard's Star, etc.) with correct positions for Known Stars games
