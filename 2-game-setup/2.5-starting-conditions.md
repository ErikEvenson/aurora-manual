...
- **Research Facilities**: Increase from the default 16 to 24 *(unverified -- default count may vary by government type)*. This offsets the reduced research speed without fully negating the pacing change, giving moderately faster research while preserving the intended slower progression.
- **Conventional Industry**: Increase from 1,600 to 1,800 *(unverified -- default count may vary by government type)*. The additional 200 factories provide early flexibility and help prevent running out of money during the bootstrapping phase when you have no other income sources.
...
- One billion population on the homeworld (increased from 500 million as of v2.1.1) \hyperlink{ref-2.5-1}{[1]}
