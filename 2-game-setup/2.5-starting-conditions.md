...
### 2.5.3.2 SpaceMaster Empire Start (Random System)

To start in a random procedurally-generated system instead of Sol, select **"SpaceMaster Empire"** from the Starting Race dropdown during game creation \hyperlink{ref-2.5-10}{[10]}. This advanced option bypasses the standard Sol/Earth setup entirely.

**How SpaceMaster Empire Works:**

1. Select "SpaceMaster Empire" as your Starting Race in the New Game window
2. The game starts with no pre-built empire — you must create everything using SpaceMaster tools
3. Enable SpaceMaster mode (Ctrl+S) and use "Create System" to generate a random star system
4. Find a suitable homeworld planet (regenerate the system if needed)
5. Use "Create Empire" to establish your race on the selected planet
...
- **Complex Setup**: Requires familiarity with SpaceMaster mode tools (see [Section 18.5 SpaceMaster Mode](../18-advanced-topics/18.5-spacemaster-mode.md))
...
> **Note:** SpaceMaster Empire is not recommended for new players. The setup process requires understanding multiple game systems before you can even begin playing.
...
\hypertarget{ref-2.5-10}{[10]}. Aurora4x Fandom Wiki, "New game creation" -- SpaceMaster Empire option: "Players can select 'Create SpaceMaster Empire' to design their own starting system and race." [aurora4x.fandom.com](https://aurora4x.fandom.com/wiki/New_game_creation)
