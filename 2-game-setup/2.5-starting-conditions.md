...
Once Trans-Newtonian Technology is researched, Conventional Industry can be converted to any of six dedicated TN installation types at 20 [BP](../appendices/B-glossary.md#bp) (Build Points) each (versus 120 BP to build new -- an 83% discount) \hyperlink{ref-2.5-6}{[6]}:
...
**Timeline**: Expect 20-50 in-game years from game start to having a functional space fleet *(unverified — [#1285](https://github.com/ErikEvenson/aurora-manual/issues/1285) -- community estimate)*. The exact duration depends on research allocation and luck with scientist skills.
...
- **Research Facilities**: Increase from the default to compensate. The default Trans-Newtonian start includes approximately 40 research facilities; conventional start has fewer labs based on manufacturing population (~16 for 1B population) \hyperlink{ref-2.5-2}{[2]}. You can adjust this directly on the race creation screen (see [Section 2.2.6 Starting Installations](2.2-race-creation.md)).
...
| Maintenance Stockpile ([MSP](../appendices/B-glossary.md#msp)) | 60,000 |
...
**Timeline**: You can be exploring neighboring star systems within 5-10 in-game years *(unverified — [#1285](https://github.com/ErikEvenson/aurora-manual/issues/1285) -- community estimate)*. A meaningful military fleet can be operational within 15-25 years depending on priorities *(unverified — [#1285](https://github.com/ErikEvenson/aurora-manual/issues/1285) -- community estimate)*.
