...
### 2.5.3.2 No Non-Sol Starting Option

Aurora C# does not provide any built-in option to start in a system other than Sol. Unlike the older VB6 version, C# Aurora does not include a "SpaceMaster Empire" starting option or SpaceMaster tools for creating custom starting systems.

**Your only options are:**

1. **Sol start** — The default and only supported starting location
2. **Database editing** — Directly modifying the SQLite database outside the game (unsupported, not documented here)

The "Known Star Systems" option affects which real stars you encounter during exploration, but does not change your starting location.
...
\hypertarget{ref-2.5-10}{[10]}. Aurora C# does not include a "SpaceMaster Empire" starting option or system creation tools — these were VB6-era features. C# Aurora always starts in Sol with no alternative.
