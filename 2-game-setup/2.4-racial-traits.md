...
| Officer Generation Rate | 1.0 *(unverified)* | Multiplier on commander generation frequency |
...
|-------|-------------------|----------|
| Population | ~500M-1B *(unverified)* | ~1B \hyperlink{ref-2.4-5}{[5]} |
...
> **Note:** Starting installations have been adjusted across Aurora versions. As of v2.1.1, TN starts begin with one billion population (increased from the previous 500 million) \hyperlink{ref-2.4-5}{[5]}.
