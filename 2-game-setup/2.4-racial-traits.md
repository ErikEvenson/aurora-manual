...
> **Tip:** New players should consider lowering the Population Growth Rate modifier to 0.5. This slows NPR population growth proportionally, giving you more time to develop before alien civilizations become overwhelming. It also produces more realistic colony growth rates -- at the default 1.0, small colonies can grow unrealistically fast (e.g., a million colonists becoming three million within two years).
...
All further technological advancement requires research (see [Section 7.1 Research](../7-research/7.1-technology-tree.md)).
