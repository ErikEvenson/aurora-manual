...
![2.3 System Generation](../images/art/section-art/2.3.png)
...
![Figure 2.3.1: Binary and Trinary System Configurations](../images/diagrams/2-game-setup/2.3-binary-trinary-systems.png)
...
- **Stellar Mass**: Affects the number and distribution of orbital bodies *(unverified — [#837](https://github.com/ErikEvenson/aurora-manual/issues/837) -- requires live testing to confirm correlation)*.
...
- **Stellar Age**: Systems are assigned ages during generation \hyperlink{ref-2.3-10}{[10]}. The DIM\_SystemAge table contains modifiers by spectral class that may influence generation *(unverified — [#837](https://github.com/ErikEvenson/aurora-manual/issues/837) -- specific effects on mineral distribution require live testing)*.
...
![Figure 2.3.3: Mineral Production Chain](../images/diagrams/2-game-setup/2.3-mineral-production-chain.png)
...
![Figure 2.3.3: Mineral Accessibility Degradation Over Mining](../images/charts/2.3-accessibility-degradation.png)
