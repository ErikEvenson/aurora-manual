...
**Multiple Star Systems**: Systems can contain multiple stars in binary, trinary, or quaternary configurations[1].
...
1. AuroraWiki C-Systems page; Steve Walmsley forum post "Using Real Stars/Systems" (aurora2.pentarch.org/index.php?topic=1654.0)
