...
- **Stellar Mass**: Affects the number and distribution of orbital bodies. More massive stars tend to have more planets and moons. *(unverified)*
- **Binary/Trinary Systems**: Multiple stars create complex orbital arrangements. Planets may orbit individual stars or the system barycenter, affecting habitable zones and jump point connections. *(unverified)*
- **Stellar Age**: Older systems may have different mineral distributions and planetary development. *(unverified)*
- **Luminosity Class**: Giant and supergiant stars have much larger habitable zones but are rarer. Dwarf stars (class V) are most common. *(unverified)*
...
In SpaceMaster mode, the System View window includes a "Regen Min" button that allows players to regenerate all mineral deposits in the currently selected system.
