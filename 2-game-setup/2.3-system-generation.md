...
- **Stellar Mass**: Affects the number and distribution of orbital bodies *(unverified — #761 -- requires live testing to confirm correlation)*.
...
- **Stellar Age**: Systems are assigned ages during generation \hyperlink{ref-2.3-10}{[10]}. The DIM\_SystemAge table contains modifiers by spectral class that may influence generation *(unverified — #761 -- specific effects on mineral distribution require live testing)*.
