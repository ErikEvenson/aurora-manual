...
**Mineral Types**: Aurora uses eleven minerals \hyperlink{ref-2.3-2}{[2]}, each required for different purposes:

| Mineral | Primary Uses \hyperlink{ref-2.3-6}{[6]} |
|---------|-------------|
...
NPR homeworlds must be positioned within approximately 12 billion kilometers of their star system's primary \hyperlink{ref-2.3-7}{[7]}. Acceptable configurations include:
