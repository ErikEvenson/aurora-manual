...
**Key Dynamic**: A high-diplomacy race with low xenophobia can quickly build alliances, while a high-xenophobia, low-diplomacy race will have lasting hostility regardless of peaceful actions. Population resistance to occupation is calculated as (Determination + Militancy + Xenophobia) / 300 *(unverified — #758)*.
