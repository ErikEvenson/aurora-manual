...
- **Non-Player Race**: Designates whether the race is controlled by the AI or the player \hyperlink{ref-2.2-9}{[9]}. When enabled, the race becomes an NPR (Non-Player Race) with autonomous AI behavior. When disabled, you control the race directly.

- **Industrial (Low Tech)**: Sets the race to start with pre-industrial or basic conventional technology levels with minimal infrastructure \hyperlink{ref-2.2-9}{[9]}. When disabled (recommended for most players), the race starts with Trans-Newtonian (TN) technology already researched.
...
- **Neutral Race**: Establishes a guaranteed neutral relationship with other races sharing the same starting system \hyperlink{ref-2.2-9}{[9]}. Useful for multi-faction starts without immediate conflict.

- **Auto-Assign Tech Points**: Automatically researches starting technologies rather than requiring manual selection \hyperlink{ref-2.2-9}{[9]}. Recommended for new players.

- **Auto-Design Ground Forces**: Automatically generates starting ground unit designs and templates \hyperlink{ref-2.2-9}{[9]}. When disabled, you must manually design all ground force units.

- **Auto-Design Ship Classes**: Automatically generates starting ship class designs \hyperlink{ref-2.2-9}{[9]}. When disabled, you must manually design all ship classes from scratch.

- **Home System Geo Surveyed**: When enabled, your home system starts with geological surveys complete, revealing all mineral deposits \hyperlink{ref-2.2-9}{[9]}. When disabled, you must survey your own home system.

- **Home System Grav Surveyed**: When enabled, your home system starts with gravitational surveys complete, revealing all jump points \hyperlink{ref-2.2-9}{[9]}. When disabled, you must discover jump points in your own system.
...
The race creation window includes a government type selector that determines starting installation allocations and behavioral modifiers. Aurora includes 38 government types \hyperlink{ref-2.2-8}{[8]}, ranging from democracies and theocracies to dictatorships and hive minds.

**Gameplay Effects:**

Government type affects several areas:

- **Starting installation ratios**: Different governments receive different proportions of construction factories, research labs, refineries, mines, and other installations \hyperlink{ref-2.2-8}{[8]}
- **Training level**: Military governments (Military Dictatorship, Military Theocracy) start with higher training levels \hyperlink{ref-2.2-8}{[8]}
- **Behavioral modifiers**: Each government type applies modifiers to diplomacy, militancy, xenophobia, expansionism, determination, and trade \hyperlink{ref-2.2-8}{[8]}
- **Growth and construction modifiers**: Some governments have modified growth rates or construction efficiency

**Common Government Types:**

| Government | Key Characteristics |
|-----------|-------------------|
| Player Race | Balanced defaults, no behavioral modifiers |
| Representative Democracy | Standard allocation, diplomatic bonus |
| Military Dictatorship | More shipyards, higher training, militancy bonus |
| Autocracy | More construction factories, balanced military |
| Corporate Government | Fewer shipyards, more mines, trade bonus |
| Meritocracy | More labs, research focus |

For detailed effects on governance bonuses, see [Section 2.4.3 Economic Traits](2.4-racial-traits.md).

## 2.2.5 Species Attributes

The left side of the race creation window displays species attributes. These determine biological preferences, production modifiers, and behavioral traits \hyperlink{ref-2.2-10}{[10]}. Listed in order as they appear on screen:

- **Species Name**: The name of your species (e.g., "Human"). Appears in species-related displays and intelligence reports.

- **Ideal Gravity (G)**: The gravity your species is most comfortable at (Earth = 1.0) \hyperlink{ref-2.2-10}{[10]}.

- **Ideal Temperature (C)**: The surface temperature your species prefers (Earth = approximately 14C) \hyperlink{ref-2.2-10}{[10]}.

- **Ideal Oxygen Pressure (atm)**: The oxygen partial pressure your species requires (Earth = 0.20 atm) \hyperlink{ref-2.2-10}{[10]}.

- **Maximum Atmospheric Pressure (atm)**: The maximum total atmospheric pressure your species can tolerate (Earth default = 4.0 atm) \hyperlink{ref-2.2-10}{[10]}.

- **Maximum Gravity Deviation (G)**: How far from ideal gravity your species can tolerate (Earth default = 0.9, yielding range 0.1G to 1.9G) \hyperlink{ref-2.2-10}{[10]}. Colonies outside this range suffer productivity penalties.

- **Maximum Temperature Deviation (C)**: How far from ideal temperature your species can tolerate (Earth default = +/-24C) \hyperlink{ref-2.2-10}{[10]}. Worlds outside this range require infrastructure modifications.

- **Maximum Oxygen Deviation (atm)**: How far from ideal oxygen pressure your species can tolerate (Earth default = +/-0.1 atm) \hyperlink{ref-2.2-10}{[10]}.

- **Population Density Modifier**: Multiplier affecting max population, infrastructure, and habitat capacity (default 1.0) \hyperlink{ref-2.2-10}{[10]}.

- **Population Growth Modifier**: Multiplier on natural reproduction rate (default 1.0) \hyperlink{ref-2.2-10}{[10]}.

- **Research Rate Modifier**: Multiplier on all scientist productivity (default 1.0) \hyperlink{ref-2.2-10}{[10]}.

- **Factory Production Modifier**: Multiplier on factories, refineries, and shipbuilding (default 1.0) \hyperlink{ref-2.2-10}{[10]}.

- **Determination (1-100)**: How steadfastly the race pursues goals; affects population resistance to occupation \hyperlink{ref-2.2-10}{[10]}.

- **Diplomacy (1-100)**: Ability to negotiate; adds to political modifier annually when diplomatic teams are active \hyperlink{ref-2.2-10}{[10]}.

- **Expansion (1-100)**: Desire to expand territory; affects NPR colonization speed \hyperlink{ref-2.2-10}{[10]}.

- **Militancy (1-100)**: Likelihood of choosing military force; affects garrison requirements \hyperlink{ref-2.2-10}{[10]}.

- **Trade (1-100)**: Willingness to establish trade relationships \hyperlink{ref-2.2-10}{[10]}.

- **Translation (-25 to +25)**: Bonus/penalty to first contact communication attempts \hyperlink{ref-2.2-10}{[10]}.

- **Xenophobia (1-100)**: Fear and distrust of other races; subtracts from political modifier annually \hyperlink{ref-2.2-10}{[10]}.

- **Officer Graduation Age**: The age at which new officers enter service (default 21) \hyperlink{ref-2.2-10}{[10]}. Affects how long officers serve before retirement.
...
- **Automated Mines**: Unmanned mining operations for remote locations. Same base output as conventional mines (10 tons/year at base tech) but require no population to operate. Cost: 240 BP \hyperlink{ref-2.2-11}{[11]}.
...
- **Maintenance Facilities**: Produce Maintenance Supply Points (MSP) to prevent ship degradation. Cost: 60 BP (30 Duranium, 30 Neutronium) \hyperlink{ref-2.2-12}{[12]}.

- **Ground Force Construction Complexes**: Build ground combat units. Cost: 2,400 BP (2,400 Vendarite) \hyperlink{ref-2.2-13}{[13]}.

- **Deep Space Tracking Stations**: Planetary sensor installations that provide detection capability. Cost: 300 BP (100 Duranium, 200 Uridium) \hyperlink{ref-2.2-14}{[14]}.

- **Military Academies**: Train and generate officers. Cost: 2,400 BP (1,200 Duranium, 300 Corbomite, 300 Tritanium, 300 Uridium, 300 Corundium) \hyperlink{ref-2.2-15}{[15]}.
...
- **Random Name**: Randomizes the race name. **Warning:** This button resets most configuration on the screen, not just the name \hyperlink{ref-2.2-16}{[16]}. Do not press it after configuring your race settings or you will lose all your changes.
...
\hypertarget{ref-2.2-8}{[8]}. Aurora C# game database (AuroraDB.db v2.7.1) -- GovType table contains 38 government types with columns for starting installation ratios (Shipyards, Labs, Construction, Refineries, Mines, Sensors), behavioral modifiers (XenophobiaMod, DiplomacyMod, MilitancyMod, ExpansionismMod, DeterminationMod, TradeMod), GrowthMod, ConstMod, and TrainingLevel

\hypertarget{ref-2.2-9}{[9]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_Race table contains columns for NPR (boolean), NeutralRace (boolean), and race configuration checkboxes visible on the Create New Race window

\hypertarget{ref-2.2-10}{[10]}. Aurora C# game database (AuroraDB.db v2.7.1) -- FCT\_Species table. Human defaults: Gravity=1.0, GravDev=0.9, Temperature=287.03K (14C), TempDev=24.0, Oxygen=0.2 atm, OxyDev=0.1, PressMax=4.0, ProductionRateModifier=1.0, ResearchRateModifier=1.0, PopulationGrowthModifier=1.0, PopulationDensityModifier=1.0, GraduationAge=21, Xenophobia/Diplomacy/Translation/Militancy/Expansionism/Determination/Trade all present as integer columns

\hypertarget{ref-2.2-11}{[11]}. Aurora C# game database (AuroraDB.db v2.7.1) -- DIM\_PlanetaryInstallation "Automated Mine" (ID 12): Cost=240, Workers=0, MiningProductionValue=1.0, CargoPoints=25000. Mineral cost: 240 Corundium

\hypertarget{ref-2.2-12}{[12]}. Aurora C# game database (AuroraDB.db v2.7.1) -- DIM\_PlanetaryInstallation "Maintenance Facility" (ID 21): Cost=60, Workers=0.05, MaintenanceValue=1.0. Mineral cost: 30 Duranium, 30 Neutronium

\hypertarget{ref-2.2-13}{[13]}. Aurora C# game database (AuroraDB.db v2.7.1) -- DIM\_PlanetaryInstallation "Ground Force Construction Complex" (ID 17): Cost=2400, Workers=1.0, GroundTrainingValue=1.0. Mineral cost: 2400 Vendarite

\hypertarget{ref-2.2-14}{[14]}. Aurora C# game database (AuroraDB.db v2.7.1) -- DIM\_PlanetaryInstallation "Deep Space Tracking Station" (ID 11): Cost=300, Workers=0, SensorValue=1.0. Mineral cost: 100 Duranium, 200 Uridium

\hypertarget{ref-2.2-15}{[15]}. Aurora C# game database (AuroraDB.db v2.7.1) -- DIM\_PlanetaryInstallation "Military Academy" (ID 14): Cost=2400, Workers=0, AcademyValue=1.0. Mineral cost: 1200 Duranium, 300 Corbomite, 300 Tritanium, 300 Uridium, 300 Corundium

\hypertarget{ref-2.2-16}{[16]}. Aurora Forums -- Community reports confirm Random Name button resets species attributes and other configuration fields, not just the race name. This is a well-known UI behavior reported by multiple players
