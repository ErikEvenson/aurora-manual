...
| 4 | **Order Type Selector** | Dropdown menu for selecting the type of order to issue. Categories include: Move To, Orbit, Patrol, Follow, Intercept, Engage Target, Evade, Load Cargo, Unload Cargo, Load Ordnance, Refuel, Standard Transit, and many more (see Section 9.5 for full list). |
